...
// Type: Intermech.XmlExchange.Client.XmlImportSettingsView
...
/// <summary>Закладка "Настройка импорта из XML"</summary>
internal class XmlImportSettingsView : BaseSettingsView
{
  /// <summary>Required designer variable.</summary>
  private IContainer components;

  /// <summary>Создать экземпляр класса</summary>
  public XmlImportSettingsView()
  {
    this.InitializeComponent();
    this._imgView = this._images != null ? this._images.ImageIndex("XML.imgBriefcaseImport") : -1;
  }
