...
// Type: Intermech.Tools.MSOffice.Excel.ExcelIntegratorSettingsCodec
...
internal sealed class ExcelIntegratorSettingsCodec(string integratorName) : SingleFileSettingsCodec(integratorName)
{
  ...
  {
    return (ISettingsObject) new ExcelIntegratorSettings();
  }
    ...
    SettingsXmlBuilder settingsBuilder)
  {
    ...
    this.EncodeOptions((ExcelIntegratorSettings) settingsObject, settingsBuilder);
  }

  private void EncodeOptions(ExcelIntegratorSettings settings, SettingsXmlBuilder settingsBuilder)
  {
    ...
    ISettingsObject settingsObject)
  {
    ...
    ExcelIntegratorSettings settings = (ExcelIntegratorSettings) settingsObject;
    this.DecodeOptions(settingsBuilder, settings);
  }

  private void DecodeOptions(SettingsXmlBuilder settingsBuilder, ExcelIntegratorSettings settings)
  {
