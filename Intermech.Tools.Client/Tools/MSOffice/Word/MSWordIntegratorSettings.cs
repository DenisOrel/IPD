...
// Type: Intermech.Tools.MSOffice.Word.MSWordIntegratorSettings
...
internal sealed class MSWordIntegratorSettings : SingleFileSettings
{
  private bool runAutoOpenMacro;

  public MSWordIntegratorSettings() => this.runAutoOpenMacro = false;

  protected override SingleFileSettings CreateClone()
  {
    return (SingleFileSettings) new MSWordIntegratorSettings();
  }

  protected override void FillClone(SingleFileSettings clonedObj)
  {
    base.FillClone(clonedObj);
    MSWordIntegratorSettings integratorSettings = (MSWordIntegratorSettings) clonedObj;
