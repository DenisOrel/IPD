...
// Type: Intermech.Tools.EnterpriseArchive.UI.FileListExplainationWindow
...
internal sealed class FileListExplainationWindow : MvpWindow, IFileListExplainationView, IView
{
  ...
  public FileListExplainationWindow() => this.InitializeComponent();

  FileListExplanationViewModel IFileListExplainationView.ViewModel
  {
    get => this.viewModel;
    set
    {
  ...
  private void FillView()
  {
    ...
    {
      this.lvFileList.Items.Clear();
      foreach (string file in (IEnumerable<string>) this.viewModel.FileList)
        this.lvFileList.Items.Add(file);
  ...
  private void InitializeComponent()
  {
    ...
    this.lvFileList.Columns.AddRange(new ColumnHeader[1]
    {
      this.chFilePath
    });
    ...
    this.Name = nameof (FileListExplainationWindow);
