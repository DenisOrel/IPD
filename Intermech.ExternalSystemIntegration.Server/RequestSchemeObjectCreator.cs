...
// Type: Intermech.ExternalSystemIntegration.Server.RequestSchemeObjectCreator
...
public class RequestSchemeObjectCreator : DBObjectCreator
{
  public override IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new RequestSchemeObject(uSession as UserSession, objectParams);
  }
}
