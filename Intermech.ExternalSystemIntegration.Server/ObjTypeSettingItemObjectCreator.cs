...
// Type: Intermech.ExternalSystemIntegration.Server.ObjTypeSettingItemObjectCreator
...
internal class ObjTypeSettingItemObjectCreator : DBObjectCreator
{
  public override IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new ObjTypeSettingItemObject(uSession as UserSession, objectParams);
  }
}
