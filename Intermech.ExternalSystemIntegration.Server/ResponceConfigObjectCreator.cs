...
// Type: Intermech.ExternalSystemIntegration.Server.ResponceConfigObjectCreator
...
internal class ResponceConfigObjectCreator : DBObjectCreator
{
  public override IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new ResponceConfigObject(uSession as UserSession, objectParams);
  }
}
