...
// Type: Intermech.ExternalSystemIntegration.Server.RequestConfigObjectCreator
...
internal class RequestConfigObjectCreator : DBObjectCreator
{
  public override IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new RequestConfigObject(uSession as UserSession, objectParams);
  }
}
