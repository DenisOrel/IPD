...
// Type: Intermech.ExternalSystemIntegration.Server.RequestObjectCreator
...
internal class RequestObjectCreator : DBObjectCreator
{
  public override IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new RequestObject(uSession as UserSession, objectParams);
  }
}
