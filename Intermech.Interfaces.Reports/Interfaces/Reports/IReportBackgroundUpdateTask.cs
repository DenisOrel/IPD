...
// Type: Intermech.Interfaces.Reports.IReportBackgroundUpdateTask
...
/// <summary>Интерфейс фоновой задачи обновления комплектов</summary>
public interface IReportBackgroundUpdateTask : IReportBackgroundTask, IBackgroundTask
{
}
