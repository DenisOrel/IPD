...
// Type: Intermech.Interfaces.Reports.IReportBackgroundGenerateTask
...
/// <summary>Интерфейс фоновой задачи генерации комплектов</summary>
public interface IReportBackgroundGenerateTask : IReportBackgroundTask, IBackgroundTask
{
}
