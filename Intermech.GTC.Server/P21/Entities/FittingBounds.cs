...
// Type: Intermech.GTC.Server.P21.Entities.FittingBounds
...
public class FittingBounds(string keyStr, string paramsStr) : BaseObject(keyStr, paramsStr), IFittingBounds, IBaseObject
{
  public static string EntityName = "FITTING_BOUNDS";
  private string _lowerBound;
  private string _specificantDigits;
  ...
  public override void SetParams(IEntityObjects entityObjects)
  {
    ...
    this.SpecificantDigits = this.ParamsArr[1];
  ...
  public string SpecificantDigits
  {
    get
    {
      this.Used = true;
      return this._specificantDigits;
    }
    private set => this._specificantDigits = value;
  }
