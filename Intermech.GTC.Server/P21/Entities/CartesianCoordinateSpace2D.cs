...
// Type: Intermech.GTC.Server.P21.Entities.CartesianCoordinateSpace2D
...
public class CartesianCoordinateSpace2D(string keyStr, string paramsStr) : 
  BaseObject(keyStr, paramsStr),
  ICartesianCoordinateSpace2D,
  IBaseObject
{
  public static string EntityName = "CARTESIAN_COORDINATE_SPACE_2D";
