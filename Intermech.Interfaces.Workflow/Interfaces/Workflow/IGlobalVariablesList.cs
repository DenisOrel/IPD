...
// Type: Intermech.Interfaces.Workflow.IGlobalVariablesList
...
public interface IGlobalVariablesList : IEnumerable<IGlobalVariable>, IEnumerable
{
  int Count { get; }

  IGlobalVariable this[int index] { get; }
  ...
  IGlobalVariable Find(string name);
  ...
  /// </summary>
  IGlobalVariable this[string name] { get; }
}
