...
// Type: Intermech.Expert.Server.IExpertServerSynchronizer
...
public interface IExpertServerSynchronizer
{
  void AddEvent(ExpServerCache cacheType, long Id1, long Id2, IDbManager db);
}
