...
// Type: Intermech.Expert.Server.DBDocComplectScenarioCreator
...
internal class DBDocComplectScenarioCreator : IDBObjectCreator
{
  public IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new DBDocComplectScenario((UserSession) uSession, objectParams);
  }
}
