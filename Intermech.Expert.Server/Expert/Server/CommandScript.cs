...
// Type: Intermech.Expert.Server.CommandScript
...
public class CommandScript : ExpertScriptable
{
  public CommandScript(UserSession uSession, DataTable objectsTable)
    : base(uSession, objectsTable)
  {
    this.objType = ExpertScriptType.CommandScript;
  }
}
