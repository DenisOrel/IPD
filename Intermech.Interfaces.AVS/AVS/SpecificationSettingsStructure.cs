...
// Type: Intermech.Interfaces.AVS.SpecificationSettingsStructure
...
public class SpecificationSettingsStructure : SettingsStructure
{
  ...
  {
    this._commonTemplateLevel = new SettingsLevel((SettingsStructure) this, InheritanceSettingsLevel.CommonTemplate, "Общие настройки спецификаций", AVSDocumentType.Specification);
    this._templateLevel = new SettingsLevel(this._commonTemplateLevel, InheritanceSettingsLevel.Template, "Настройки шаблона спецификации", AVSDocumentType.Specification);
    this._documentLevel = new SettingsLevel(this._templateLevel, InheritanceSettingsLevel.Document, "Настройки спецификации", AVSDocumentType.Specification);
