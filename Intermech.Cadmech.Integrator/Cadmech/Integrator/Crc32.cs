...
// Type: Intermech.Cadmech.Integrator.Crc32
...
internal sealed class Crc32
{
  ...
  public static readonly uint[] CrcTable = new uint[256 /*0x0100*/]
  {
    0U,
    1996959894U,
    3993919788U,
  ...
  public void Update(byte[] buf, int off, int len)
  {
    ...
    this.crc ^= Crc32.CrcSeed;
    while (--len >= 0)
      this.crc = Crc32.CrcTable[((int) this.crc ^ (int) buf[off++]) & (int) byte.MaxValue] ^ this.crc >> 8;
    this.crc ^= Crc32.CrcSeed;
  }
}
