...
// Type: Intermech.Kernel.Briefcase.ImportClasses.RelationLinksByIDImporter
...
internal class RelationLinksByIDImporter(
  UserSession session,
  List<IDСorresponds> importingObjects,
  List<long> recordKindStated,
  Action<string> addIntoLogFunc) : RelationLinksImporter(session, importingObjects, recordKindStated, addIntoLogFunc)
{
