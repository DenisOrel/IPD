...
// Type: Intermech.Kernel.Services.Compositions.Sorting.Method.CompositionAutomaticSortingInsertLastMethod
...
internal class CompositionAutomaticSortingInsertLastMethod(
  [NotNull] CompositionObjectInfoCache objectCompositionCache) : CompositionAutomaticSortingMethod(objectCompositionCache)
{
    ...
    KeyValuePair<CompositionObjectSortingNode, IList<CompositionSortingProjInfo>> compNodeItem)
  {
    ...
    {
      CompositionSortingInfoItem closedObjectRec1 = compositionObjectInfo.CompositionInfoCache.FindClosedObjectRec(key.ProjTypeID, key.RelTypeID, key.PartObjType, CompositionSortingLookupMode.Less);
    ...
    foreach (CompositionSortingProjInfo compositionSortingProjInfo in (IEnumerable<CompositionSortingProjInfo>) compositionSortingProjInfoList)
    {
      ...
      AttributeValues attributeValues = new AttributeValues(MetaDataHelper.GetAttributeTypeID("cad00202-306c-11d8-b4e9-00304f19f545"), (object) initValue);
