...
// Type: Intermech.Tools.Integrators.Electrical.TableAttributesUIEditor
...
/// </summary>
[Serializable]
internal sealed class TableAttributesUIEditor : CollectionEditor
{
  public TableAttributesUIEditor()
    : base(typeof (List<AttributeTableItemSurrogate>))
  {
  }

  public override UITypeEditorEditStyle GetEditStyle(ITypeDescriptorContext context)
  {
    return (!(context.PropertyDescriptor.PropertyType == typeof (ChangeTrackingListAdapter<AttributeTableItemSurrogate>)) ? 0 : (!context.PropertyDescriptor.IsReadOnly ? 1 : 0)) == 0 ? UITypeEditorEditStyle.None : base.GetEditStyle(context);
  }
  ...
  public override object EditValue(
    ...
    object value)
  {
    ChangeTrackingListAdapter<AttributeTableItemSurrogate> objA = (ChangeTrackingListAdapter<AttributeTableItemSurrogate>) value;
    ChangeTrackingListAdapter<AttributeTableItemSurrogate> objB = objA.Clone();
  ...
  protected override object CreateInstance(System.Type itemType)
  {
    ...
    {
      AttributeTableItemSurrogate tableItemSurrogate = (AttributeTableItemSurrogate) instance;
      tableItemSurrogate.DBAttributeName = "";
      tableItemSurrogate.CADAttributeName = "";
      tableItemSurrogate.Obligatory = false;
    }
    return instance;
  }
  ...
  {
    AttributeTableItemSurrogate tableItemSurrogate = (AttributeTableItemSurrogate) value;
    return $"{tableItemSurrogate.DBAttributeName}={tableItemSurrogate.CADAttributeName}";
  }
}
