...
// Type: Intermech.Tools.Integrators.Electrical.ListParamValuesSettingsUIEditor`1
...
/// </summary>
[Serializable]
public class ListParamValuesSettingsUIEditor<TSurrogate> : CollectionEditor where TSurrogate : ICloneable, IListParamValuesSettings
{
  public ListParamValuesSettingsUIEditor()
    : base(typeof (List<TSurrogate>))
  {
  }

  public override UITypeEditorEditStyle GetEditStyle(ITypeDescriptorContext context)
  {
    return (!(context.PropertyDescriptor.PropertyType == typeof (ChangeTrackingListAdapter<TSurrogate>)) ? 0 : (!context.PropertyDescriptor.IsReadOnly ? 1 : 0)) == 0 ? UITypeEditorEditStyle.None : base.GetEditStyle(context);
  }
  ...
  protected override CollectionEditor.CollectionForm CreateCollectionForm()
  {
    ...
    collectionForm.Controls[0].Controls[2].Text = "";
  ...
  public override object EditValue(
    ...
    object value)
  {
    ChangeTrackingListAdapter<TSurrogate> objA = (ChangeTrackingListAdapter<TSurrogate>) value;
    ChangeTrackingListAdapter<TSurrogate> objB = objA.Clone();
  ...
  protected override object CreateInstance(System.Type itemType)
  {
    ...
    if (instance.GetType() == typeof (TSurrogate))
    {
      TSurrogate surrogate = (TSurrogate) instance;
      surrogate.ParameterName = "";
      surrogate.ParameterValue = "";
    }
    return instance;
  }
  ...
  {
    TSurrogate surrogate = (TSurrogate) value;
    return $"{surrogate.ParameterName}={surrogate.ParameterValue}";
  }
}
