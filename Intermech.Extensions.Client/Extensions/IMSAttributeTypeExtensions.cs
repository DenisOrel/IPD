...
public static class IMSAttributeTypeExtensions
{
  ...
  public static IAttributePropertyDescriber GetDescriber(
    [NotNull] this IMSAttributeType attributeType,
  ...
  [ContractAnnotation("=> true, result: notnull; => false, result: null")]
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static bool TryGetEditorFor([NotNull] this IMSAttributeType attributeType, out UITypeEditor result)
  {
