...
// Type: Intermech.Controls.OleContainer.LangStrings
...
internal sealed class LangStrings
{
  ...
  internal const string ImOleContainerAccessDenied = "ImOleContainerAccessDenied";
  internal const string ImOleContainerActivated = "ImOleContainerActivated";
  internal const string ImOleContainerActivationGesture = "ImOleContainerActivationGesture";
  internal const string ImOleContainerActiveDocumentType = "ImOleContainerActiveDocumentType";
  internal const string ImOleContainerBadProgId = "ImOleContainerBadProgId";
  internal const string ImOleContainerBorderStyle = "ImOleContainerBorderStyle";
  internal const string ImOleContainerCantCreate = "ImOleContainerCantCreate";
  internal const string ImOleContainerDeactivated = "ImOleContainerDeactivated";
  internal const string ImOleContainerDocumentModified = "ImOleContainerDocumentModified";
  internal const string ImOleContainerFileInUse = "ImOleContainerFileInUse";
  internal const string ImOleContainerGuid = "ImOleContainerGuid";
  internal const string ImOleContainerInvalidGuid = "ImOleContainerInvalidGuid";
  internal const string ImOleContainerInvalidProgId = "ImOleContainerInvalidProgId";
  internal const string ImOleContainerLoaded = "ImOleContainerLoaded";
  internal const string ImOleContainerNeedObjectToSave = "ImOleContainerNeedObjectToSave";
  internal const string ImOleContainerProgId = "ImOleContainerProgId";
  internal const string ImOleContainerSaved = "ImOleContainerSaved";
  internal const string ImOleContainerShowMenus = "ImOleContainerShowMenus";
  internal const string ImOleContainerShowToolbars = "ImOleContainerShowToolbars";
  internal const string ImOleContainerSizeMode = "ImOleContainerSizeMode";
  internal const string ImOleContainerSourceDocument = "ImOleContainerSourceDocument";
  internal const string ImOleContainerStatusTextChanged = "ImOleContainerStatusTextChanged";
  internal const string ImOleContainerToolTarget = "ImOleContainerToolTarget";
  internal const string ImOleContainerUnexpectedFileError = "ImOleContainerUnexpectedFileError";
  internal const string AddDifferentThreads = "AddDifferentThreads";
  internal const string AddMoreColumns = "AddMoreColumns";
  ...
  internal const string AXRemoveInvalidEvent = "AXRemoveInvalidEvent";
  ...
  internal const string CannotChangeTableWhilePrinting = "CannotChangeTableWhilePrinting";
  ...
  internal const string CannotRetrieveDataFromDataSource = "CannotRetrieveDataFromDataSource";
  internal const string CannotSetPrinterSettingsNow = "CannotSetPrinterSettingsNow";
  ...
  internal const string ColumnPrintLayoutNamesMustBeUnique = "ColumnPrintLayoutNamesMustBeUnique";
  internal const string ColumnPrintLayoutNoPrintDocument = "ColumnPrintLayoutNoPrintDocument";
  internal const string ColumnPrintLayoutNoValue = "ColumnPrintLayoutNoValue";
  internal const string ColumnPrintLayoutObjectInCollection = "ColumnPrintLayoutObjectInCollection";
  internal const string ColumnPrintLayoutSupportedDataNullValues = "ColumnPrintLayoutSupportedDataNullValues";
  internal const string ColumnPrintLayoutWidthMustBePositive = "ColumnPrintLayoutWidthMustBePositive";
  ...
  internal const string DataConnectorAddingNewEventHandlerDescr = "DataConnectorAddingNewEventHandlerDescr";
  internal const string DataConnectorAllowEditDescr = "DataConnectorAllowEditDescr";
  internal const string DataConnectorAllowNewDescr = "DataConnectorAllowNewDescr";
  internal const string DataConnectorAllowRemoveDescr = "DataConnectorAllowRemoveDescr";
  internal const string DataConnectorBadSortString = "DataConnectorBadSortString";
  internal const string DataConnectorBindingCompleteEventHandlerDescr = "DataConnectorBindingCompleteEventHandlerDescr";
  internal const string DataConnectorBindingListWrapperAddToReadOnlyList = "DataConnectorBindingListWrapperAddToReadOnlyList";
  internal const string DataConnectorBindingListWrapperNeedAParameterlessConstructor = "DataConnectorBindingListWrapperNeedAParameterlessConstructor";
  internal const string DataConnectorCurrentChangedEventHandlerDescr = "DataConnectorCurrentChangedEventHandlerDescr";
  internal const string DataConnectorCurrentDescr = "DataConnectorCurrentDescr";
  internal const string DataConnectorCurrentItemChangedEventHandlerDescr = "DataConnectorCurrentItemChangedEventHandlerDescr";
  internal const string DataConnectorDataMemberChangedEventHandlerDescr = "DataConnectorDataMemberChangedEventHandlerDescr";
  internal const string DataConnectorDataMemberDescr = "DataConnectorDataMemberDescr";
  internal const string DataConnectorDataSourceChangedEventHandlerDescr = "DataConnectorDataSourceChangedEventHandlerDescr";
  internal const string DataConnectorDataSourceDescr = "DataConnectorDataSourceDescr";
  internal const string DataConnectorFilterDescr = "DataConnectorFilterDescr";
  internal const string DataConnectorInstanceError = "DataConnectorInstanceError";
  internal const string DataConnectorItemChangedEventModeDescr = "DataConnectorItemChangedEventModeDescr";
  internal const string DataConnectorItemTypeMismatchOnAdd = "DataConnectorItemTypeMismatchOnAdd";
  internal const string DataConnectorListChangedEventHandlerDescr = "DataConnectorListChangedEventHandlerDescr";
  internal const string DataConnectorPositionChangedEventHandlerDescr = "DataConnectorPositionChangedEventHandlerDescr";
  internal const string DataConnectorRemoveCurrentNoCurrentItem = "DataConnectorRemoveCurrentNoCurrentItem";
  internal const string DataConnectorRemoveCurrentNotAllowed = "DataConnectorRemoveCurrentNotAllowed";
  internal const string DataConnectorSortDescr = "DataConnectorSortDescr";
  internal const string DataConnectorSortStringPropertyNotInIBindingList = "DataConnectorSortStringPropertyNotInIBindingList";
  ...
  internal const string DataGridView_AccName = "DataGridView_AccName";
  ...
  internal const string DataGridView_AutoSizeRowsModeCannotUseInvisibleHeaders = "DataGridView_AutoSizeRowsModeCannotUseInvisibleHeaders";
  internal const string DataGridView_BorderStyleDescr = "DataGridView_BorderStyleDescr";
  internal const string DataGridView_ButtonColumnDisplayTextAsFormattedValueDescr = "DataGridView_ButtonColumnDisplayTextAsFormattedValueDescr";
  ...
  internal const string DataGridView_CannotAutoSizeInvisibleRowHeader = "DataGridView_CannotAutoSizeInvisibleRowHeader";
  ...
  internal const string DataGridView_ColumnsResizableDescr = "DataGridView_ColumnsResizableDescr";
  ...
  internal const string DataGridView_DataGridViewElementStateCannotBeNone = "DataGridView_DataGridViewElementStateCannotBeNone";
  ...
  internal const string DataGridView_FormattedValueWrongType = "DataGridView_FormattedValueWrongType";
  ...
  internal const string DataGridView_InvalidFlatStyleForDataGridViewButtonCell = "DataGridView_InvalidFlatStyleForDataGridViewButtonCell";
  ...
  internal const string DataGridView_LinkColumnDisplayLinkAsFormattedValueDescr = "DataGridView_LinkColumnDisplayLinkAsFormattedValueDescr";
  ...
  internal const string DataGridView_PropertyTooLarge = "DataGridView_PropertyTooLarge";
  internal const string DataGridView_PropertyTooSmall = "DataGridView_PropertyTooSmall";
  ...
  internal const string DataGridView_RowFrozenDescr = "DataGridView_RowFrozenDescr";
  ...
  internal const string DataGridView_RowsDeletedDescr = "DataGridView_RowsDeletedDescr";
  internal const string DataGridView_RowsResizableDescr = "DataGridView_RowsResizableDescr";
  ...
  internal const string DataGridView_RowVisibleDescr = "DataGridView_RowVisibleDescr";
  ...
  internal const string DataGridViewAutoSizeColumnHeadersEnabledDescr = "DataGridViewAutoSizeColumnHeadersEnabledDescr";
  internal const string DataGridViewAutoSizeRowHeadersModeDescr = "DataGridViewAutoSizeRowHeadersModeDescr";
  ...
  internal const string DataGridViewBand_HeightSmallerThanMinimum = "DataGridViewBand_HeightSmallerThanMinimum";
  ...
  internal const string DataGridViewBand_WidthSmallerThanMinimum = "DataGridViewBand_WidthSmallerThanMinimum";
  ...
  internal const string DataGridViewCheckBoxCell_InvalidFlatStyle = "DataGridViewCheckBoxCell_InvalidFlatStyle";
  ...
  internal const string DataGridViewColumn_DisplayIndexOutOfRange = "DataGridViewColumn_DisplayIndexOutOfRange";
  internal const string DataGridViewColumn_SortModeAndSelectionModeClash = "DataGridViewColumn_SortModeAndSelectionModeClash";
  internal const string DataGridViewColumnAutoSizeCriteriaDescr = "DataGridViewColumnAutoSizeCriteriaDescr";
  internal const string DataGridViewColumnCollection_ColumnDoesNotBelongToDataGridView = "DataGridViewColumnCollection_ColumnDoesNotBelongToDataGridView";
  internal const string DataGridViewColumnCollection_ColumnNotFound = "DataGridViewColumnCollection_ColumnNotFound";
  internal const string DataGridViewColumnHeadersHeightResizableDescr = "DataGridViewColumnHeadersHeightResizableDescr";
  ...
  internal const string DataGridViewRowCollection_RowDoesNotBelongToDataGridView = "DataGridViewRowCollection_RowDoesNotBelongToDataGridView";
  ...
  internal const string DataGridViewRowHeadersWidthResizableDescr = "DataGridViewRowHeadersWidthResizableDescr";
  ...
  internal const string DataNavigatorAddNewItemPropDescr = "DataNavigatorAddNewItemPropDescr";
  internal const string DataNavigatorAddNewItemText = "DataNavigatorAddNewItemText";
  internal const string DataNavigatorCountItemFormat = "DataNavigatorCountItemFormat";
  internal const string DataNavigatorCountItemFormatPropDescr = "DataNavigatorCountItemFormatPropDescr";
  internal const string DataNavigatorCountItemPropDescr = "DataNavigatorCountItemPropDescr";
  internal const string DataNavigatorCountItemTip = "DataNavigatorCountItemTip";
  internal const string DataNavigatorDataConnectorPropDescr = "DataNavigatorDataConnectorPropDescr";
  internal const string DataNavigatorDeleteItemPropDescr = "DataNavigatorDeleteItemPropDescr";
  internal const string DataNavigatorDeleteItemText = "DataNavigatorDeleteItemText";
  internal const string DataNavigatorMoveFirstItemPropDescr = "DataNavigatorMoveFirstItemPropDescr";
  internal const string DataNavigatorMoveFirstItemText = "DataNavigatorMoveFirstItemText";
  internal const string DataNavigatorMoveLastItemPropDescr = "DataNavigatorMoveLastItemPropDescr";
  internal const string DataNavigatorMoveLastItemText = "DataNavigatorMoveLastItemText";
  internal const string DataNavigatorMoveNextItemPropDescr = "DataNavigatorMoveNextItemPropDescr";
  internal const string DataNavigatorMoveNextItemText = "DataNavigatorMoveNextItemText";
  internal const string DataNavigatorMovePreviousItemPropDescr = "DataNavigatorMovePreviousItemPropDescr";
  internal const string DataNavigatorMovePreviousItemText = "DataNavigatorMovePreviousItemText";
  internal const string DataNavigatorPositionItemPropDescr = "DataNavigatorPositionItemPropDescr";
  internal const string DataNavigatorPositionItemTip = "DataNavigatorPositionItemTip";
  internal const string DataNavigatorRefreshItemsEventDescr = "DataNavigatorRefreshItemsEventDescr";
  internal const string DataNavigatorToolStripName = "DataNavigatorToolStripName";
  internal const string DataObjectDibNotSupported = "DataObjectDibNotSupported";
  internal const string DataPropertyNameOnColumnNotFound = "DataPropertyNameOnColumnNotFound";
  internal const string DataPropertyNameOnColumnNotSet = "DataPropertyNameOnColumnNotSet";
  ...
  internal const string DataSourceOnTableNotSet = "DataSourceOnTableNotSet";
  ...
  internal const string FormatObject_CannotConvertNullValue = "FormatObject_CannotConvertNullValue";
  internal const string FormatObject_CannotConvertToString = "FormatObject_CannotConvertToString";
  internal const string FormatObject_CannotConvertToType = "FormatObject_CannotConvertToType";
  ...
  internal const string HeadingTooTallToFit = "HeadingTooTallToFit";
  ...
  internal const string ImageListRightToLeftDescr = "ImageListRightToLeftDescr";
  ...
  internal const string InvalidDataSource = "InvalidDataSource";
  ...
  internal const string LinkLabelLinksDescr = "LinkLabelLinksDescr";
  ...
  internal const string ListBoxUseCustomTabOffsetsDescr = "ListBoxUseCustomTabOffsetsDescr";
  ...
  internal const string ListViewClickableHeaderStyleInVirtualList = "ListViewClickableHeaderStyleInVirtualList";
  internal const string ListViewColumnClickDescr = "ListViewColumnClickDescr";
  internal const string ListViewColumnHeaderRearrangedDscr = "ListViewColumnHeaderRearrangedDscr";
  ...
  internal const string ListViewFindNextItemWorksOnlyInIconView = "ListViewFindNextItemWorksOnlyInIconView";
  ...
  internal const string ListViewIsBackgroundImageTiledDescr = "ListViewIsBackgroundImageTiledDescr";
  ...
  internal const string ListViewItemNumIndentsCantBeNegative = "ListViewItemNumIndentsCantBeNegative";
  ...
  internal const string ListViewNeedTwoImagesForCheckBox = "ListViewNeedTwoImagesForCheckBox";
  ...
  private static LangStrings loader = (LangStrings) null;
  ...
  internal const string MaskedTextBoxEnableCutCopyLiteralsDescr = "MaskedTextBoxEnableCutCopyLiteralsDescr";
  internal const string MaskedTextBoxHidePromptOnLeaveDescr = "MaskedTextBoxHidePromptOnLeaveDescr";
  internal const string MaskedTextBoxImeEnableError = "MaskedTextBoxImeEnableError";
  internal const string MaskedTextBoxIncludeLiteralsDescr = "MaskedTextBoxIncludeLiteralsDescr";
  internal const string MaskedTextBoxIncludePromptDescr = "MaskedTextBoxIncludePromptDescr";
  internal const string MaskedTextBoxIncompleteMsg = "MaskedTextBoxIncompleteMsg";
  internal const string MaskedTextBoxInputTextChangedDescr = "MaskedTextBoxInputTextChangedDescr";
  internal const string MaskedTextBoxInputTextDescr = "MaskedTextBoxInputTextDescr";
  internal const string MaskedTextBoxInsertModeDescr = "MaskedTextBoxInsertModeDescr";
  ...
  internal const string MaskedTextBoxOutputTextChangedDescr = "MaskedTextBoxOutputTextChangedDescr";
  ...
  internal const string NestedTablesNotSupported = "NestedTablesNotSupported";
  internal const string NoMoreColumns = "NoMoreColumns";
  internal const string NonTopLevelCantHaveOwner = "NonTopLevelCantHaveOwner";
  internal const string NonTrueTypeFontNotSupported = "NonTrueTypeFontNotSupported";
  ...
  internal const string ParseObject_CannotParseObject = "ParseObject_CannotParseObject";
  ...
  internal const string PictureBoxAlreadyLoading = "PictureBoxAlreadyLoading";
  ...
  internal const string RestartNotSupportedForControlsInBrowser = "RestartNotSupportedForControlsInBrowser";
  ...
  internal const string RichTextBoxShortcutsEnabledDescr = "RichTextBoxShortcutsEnabledDescr";
  ...
  internal const string SecurityToolTipText = "SecurityToolTipText";
  ...
  internal const string SoundAPILoadCompletedDescr = "SoundAPILoadCompletedDescr";
  internal const string SoundAPILoadTimedOut = "SoundAPILoadTimedOut";
  internal const string SoundAPILoadTimeoutDescr = "SoundAPILoadTimeoutDescr";
  internal const string SoundAPIReadError = "SoundAPIReadError";
  internal const string SoundAPISoundLocationChangedDescr = "SoundAPISoundLocationChangedDescr";
  internal const string SoundAPISoundLocationDescr = "SoundAPISoundLocationDescr";
  internal const string SoundAPIStreamChangedDescr = "SoundAPIStreamChangedDescr";
  internal const string SoundAPIStreamDescr = "SoundAPIStreamDescr";
  ...
  internal const string TabBaseRaiseEnterLeaveEventsForTabsDescr = "TabBaseRaiseEnterLeaveEventsForTabsDescr";
  ...
  internal const string TabItemEnableVisualStyleBackgroundDescr = "TabItemEnableVisualStyleBackgroundDescr";
  ...
  internal const string ToolStripItemOnBeginRaft = "ToolStripItemOnBeginRaft";
  ...
  internal const string ToolStripItemOnEndRaft = "ToolStripItemOnEndRaft";
  ...
  internal const string ToolStripRaftDescr = "ToolStripRaftDescr";
  ...
  internal const string TrustManagerBasicInstalDetailsDialog_Description1 = "TrustManagerBasicInstalDetailsDialog_Description1";
  internal const string TrustManagerBasicInstallDialog_Confirm = "TrustManagerBasicInstallDialog_Confirm";
  internal const string TrustManagerBasicInstallDialog_ConfirmQuestion = "TrustManagerBasicInstallDialog_ConfirmQuestion";
  internal const string TrustManagerBasicInstallDialog_Title = "TrustManagerBasicInstallDialog_Title";
  internal const string TrustManagerCommonDialog_Application = "TrustManagerCommonDialog_Application";
  internal const string TrustManagerCommonDialog_Cancel = "TrustManagerCommonDialog_Cancel";
  internal const string TrustManagerCommonDialog_Details = "TrustManagerCommonDialog_Details";
  internal const string TrustManagerCommonDialog_From = "TrustManagerCommonDialog_From";
  internal const string TrustManagerCommonDialog_Install = "TrustManagerCommonDialog_Install";
  internal const string TrustManagerCommonDialog_OK = "TrustManagerCommonDialog_OK";
  internal const string TrustManagerCommonDialog_Publisher = "TrustManagerCommonDialog_Publisher";
  internal const string TrustManagerCommonDialog_Run = "TrustManagerCommonDialog_Run";
  internal const string TrustManagerCommonDialog_Unknown = "TrustManagerCommonDialog_Unknown";
  internal const string TrustManagerCommonDialog_Version = "TrustManagerCommonDialog_Version";
  internal const string TrustManagerCommonDialog_Warning = "TrustManagerCommonDialog_Warning";
  internal const string TrustManagerCommonInstalDetailsDialog_Description = "TrustManagerCommonInstalDetailsDialog_Description";
  internal const string TrustManagerDetailsDialog_ApplicationDesc = "TrustManagerDetailsDialog_ApplicationDesc";
  internal const string TrustManagerDetailsDialog_Close = "TrustManagerDetailsDialog_Close";
  internal const string TrustManagerDetailsDialog_FromDesc = "TrustManagerDetailsDialog_FromDesc";
  internal const string TrustManagerDetailsDialog_PublisherDesc = "TrustManagerDetailsDialog_PublisherDesc";
  internal const string TrustManagerDetailsDialog_Title = "TrustManagerDetailsDialog_Title";
  internal const string TrustManagerDetailsDialog_VersionDesc = "TrustManagerDetailsDialog_VersionDesc";
  internal const string TrustManagerErrorDialog_AuthDesc1 = "TrustManagerErrorDialog_AuthDesc1";
  internal const string TrustManagerErrorDialog_Desc1 = "TrustManagerErrorDialog_Desc1";
  internal const string TrustManagerErrorDialog_Desc2 = "TrustManagerErrorDialog_Desc2";
  internal const string TrustManagerErrorInstallDialog_Title = "TrustManagerErrorInstallDialog_Title";
  internal const string TrustManagerErrorRunDialog_Title = "TrustManagerErrorRunDialog_Title";
  internal const string TrustManagerHighRiskInstalDetailsDialog_Description1 = "TrustManagerHighRiskInstalDetailsDialog_Description1";
  internal const string TrustManagerHighRiskInstalDetailsDialog_Description2 = "TrustManagerHighRiskInstalDetailsDialog_Description2";
  internal const string TrustManagerHighRiskInstallDialog_Confirm = "TrustManagerHighRiskInstallDialog_Confirm";
  internal const string TrustManagerHighRiskInstallDialog_ConfirmQuestion = "TrustManagerHighRiskInstallDialog_ConfirmQuestion";
  internal const string TrustManagerHighRiskInstallDialog_Title = "TrustManagerHighRiskInstallDialog_Title";
  internal const string TrustManagerHighRiskInstallDialog_Warning = "TrustManagerHighRiskInstallDialog_Warning";
  internal const string TrustManagerHighRiskRunDetailsDialog_Description1 = "TrustManagerHighRiskRunDetailsDialog_Description1";
  internal const string TrustManagerHighRiskRunDetailsDialog_Description2 = "TrustManagerHighRiskRunDetailsDialog_Description2";
  internal const string TrustManagerHighRiskRunDialog_Confirm = "TrustManagerHighRiskRunDialog_Confirm";
  internal const string TrustManagerHighRiskRunDialog_ConfirmQuestion = "TrustManagerHighRiskRunDialog_ConfirmQuestion";
  internal const string TrustManagerHighRiskRunDialog_Title = "TrustManagerHighRiskRunDialog_Title";
  internal const string TrustManagerHighRiskRunDialog_Warning = "TrustManagerHighRiskRunDialog_Warning";
  ...
  internal const string TrustManagerPromptUI_AddsShortcutWarning = "TrustManagerPromptUI_AddsShortcutWarning";
  internal const string TrustManagerPromptUI_BlockedApp = "TrustManagerPromptUI_BlockedApp";
  internal const string TrustManagerPromptUI_InstalledFromWarning = "TrustManagerPromptUI_InstalledFromWarning";
  ...
  internal const string TrustManagerPromptUI_InternetSource = "TrustManagerPromptUI_InternetSource";
  internal const string TrustManagerPromptUI_LocalComputerSource = "TrustManagerPromptUI_LocalComputerSource";
  internal const string TrustManagerPromptUI_LocalNetworkSource = "TrustManagerPromptUI_LocalNetworkSource";
  internal const string TrustManagerPromptUI_NeedsPermissionWarning = "TrustManagerPromptUI_NeedsPermissionWarning";
  ...
  internal const string TrustManagerPromptUI_OK = "TrustManagerPromptUI_OK";
  internal const string TrustManagerPromptUI_Run = "TrustManagerPromptUI_Run";
  internal const string TrustManagerPromptUI_RunFromWarning = "TrustManagerPromptUI_RunFromWarning";
  ...
  internal const string TrustManagerPromptUI_UnknownPublisherWarning = "TrustManagerPromptUI_UnknownPublisherWarning";
  ...
  {
    this.resources = new ResourceManager("System.Windows.Forms", this.GetType().Assembly);
  }

  private static LangStrings GetLoader()
  {
    if (LangStrings.loader == null)
    {
      lock (LangStrings.InternalSyncObject)
      {
        if (LangStrings.loader == null)
          LangStrings.loader = new LangStrings();
      }
    }
    return LangStrings.loader;
  }

  public static object GetObject(string name)
  {
    return LangStrings.GetLoader()?.resources.GetObject(name, LangStrings.Culture);
  }
  ...
  private static object InternalSyncObject
  {
    get
    {
      if (LangStrings.s_InternalSyncObject == null)
      {
        object obj = new object();
        Interlocked.CompareExchange(ref LangStrings.s_InternalSyncObject, obj, (object) null);
      }
      return LangStrings.s_InternalSyncObject;
    }
  }

  public static ResourceManager Resources => LangStrings.GetLoader().resources;
}
