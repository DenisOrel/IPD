...
// Type: Intermech.Controls.BarManagerConfigurationAdapter
...
/// </summary>
public sealed class BarManagerConfigurationAdapter : BarManagerConfigurationStorage
{
  private const string LayoutPropertyName = "Data";
  private readonly IConfigurationManager configManager;
  private readonly string fileName;

  public BarManagerConfigurationAdapter(IConfigurationManager configManager, string fileName)
  {
  ...
  public BarManagerConfigurationAdapter(IConfigurationManager configManager)
    : this(configManager, "BarManagerLayout")
  {
  }
