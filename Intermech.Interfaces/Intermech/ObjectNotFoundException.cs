...
// Type: Intermech.ObjectNotFoundException
...
{
    [Serializable]
    public class ObjectNotFoundException : KernelException
    {
      private long _ObjectID;

      public ObjectNotFoundException(long aObjectID)
      {
      ...
      public override string Message
      {
        get
        {
          return string.Format(LocalizationHolder.rm.GetString("Interfaces_211"), (object) this._ObjectID);
        }
      }
