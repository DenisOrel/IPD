...
// Type: Intermech.Search.GroupAttributesChanging.GroupAttributesChangingConstants
...
{
    public static class GroupAttributesChangingConstants
    {
      ...
      public static int[] RootClassifierObjectTypeIds
      {
        get
        {
          return new int[2]
          {
            GroupAttributesChangingConstants.CommonClassifierObjectTypeID,
            GroupAttributesChangingConstants.PersonalClassifierObjectTypeID
          };
        }
      }
      ...
      public static int[] AllDocumentsObjectTypeIds
      {
        get
        {
          return MetaDataHelper.GetObjectTypeChildrenIDRecursive(GroupAttributesChangingConstants.DocumentObjectTypeID).ToArray();
        }
      }
