...
// Type: Intermech.Expressions.Exceptions.LnZeroException
...
namespace Intermech.Expressions.Exceptions
{
    ...
    {
      public LnZeroException()
        : base(LocalizationHolder.rm.GetString("Interfaces_46"))
      {
      }
      ...
      protected LnZeroException(SerializationInfo info, StreamingContext context)
        : base(info, context)
      {
      }
    }
