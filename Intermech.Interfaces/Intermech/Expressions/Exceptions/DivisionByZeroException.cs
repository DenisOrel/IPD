...
// Type: Intermech.Expressions.Exceptions.DivisionByZeroException
...
namespace Intermech.Expressions.Exceptions
{
    ...
    public class DivisionByZeroException : EvaluateException
    {
      public DivisionByZeroException()
        : base(LocalizationHolder.rm.GetString("Interfaces_22"))
      {
      }
      ...
      protected DivisionByZeroException(SerializationInfo info, StreamingContext context)
        : base(info, context)
      {
      }
    }
