...
// Type: Intermech.Expressions.Exceptions.InvalidExpressionException
...
namespace Intermech.Expressions.Exceptions
{
    ...
    {
      public InvalidExpressionException(int pos, string token)
        : base(LocalizationHolder.rm.GetString("Interfaces_38"), pos, token)
      {
      }
