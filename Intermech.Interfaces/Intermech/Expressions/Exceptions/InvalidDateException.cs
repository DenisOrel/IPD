...
// Type: Intermech.Expressions.Exceptions.InvalidDateException
...
{
    /// <summary>Invalid date expression.</summary>
    [Serializable]
    public class InvalidDateException : ParseException
    {
      public InvalidDateException(int pos, string token)
        : base(LocalizationHolder.rm.GetString("Interfaces_37"), pos, token)
      {
      }
