...
// Type: Intermech.Expressions.Functions._ArcTanFunction
...
{
    public class _ArcTanFunction : Function
    {
      public override object Evaluate(object[] values)
      {
        return (object) Math.Atan(Convert.ToDouble(values[0]));
      }

      public override string Name => "_ATAN";
