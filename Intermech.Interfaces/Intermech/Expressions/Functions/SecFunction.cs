...
// Type: Intermech.Expressions.Functions.SecFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class SecFunction : Function
    {
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_681");
    }
}
