...
// Type: Intermech.Expressions.Functions.SumFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class SumFunction : Function
    {
      public override object Evaluate(object[] values)
      {
        ...
        return !flag ? (object) num : (object) DBNull.Value;
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_687");
    }
}
