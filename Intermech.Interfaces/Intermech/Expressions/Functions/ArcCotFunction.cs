...
// Type: Intermech.Expressions.Functions.ArcCotFunction
...
{
    /// <summary>ArcCot function.</summary>
    public class ArcCotFunction : Function
    {
      public override object Evaluate(object[] values)
      {
        double num = Convert.ToDouble(values[0]);
        return !num.Equals(0.0) ? (object) Math.Atan(1.0 / num) : throw new ACotOfZeroException();
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_628");
    }
}
