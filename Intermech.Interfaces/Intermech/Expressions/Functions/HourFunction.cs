...
// Type: Intermech.Expressions.Functions.HourFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    {
      public override object Evaluate(object[] values) => (object) Convert.ToDateTime(values[0]).Hour;
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_652");
    }
}
