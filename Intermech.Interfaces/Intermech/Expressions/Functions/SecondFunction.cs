...
// Type: Intermech.Expressions.Functions.SecondFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    {
      public override object Evaluate(object[] values) => (object) Convert.ToDateTime(values[0]).Second;
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_682");
    }
}
