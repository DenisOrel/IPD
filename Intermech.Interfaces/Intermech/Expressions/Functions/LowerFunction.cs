...
// Type: Intermech.Expressions.Functions.LowerFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class LowerFunction : Function
    {
      ...
      {
        return (object) Convert.ToString(values[0]).ToLower();
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_668");
    }
}
