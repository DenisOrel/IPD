...
// Type: Intermech.Expressions.Functions.ExpFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class ExpFunction : Function
    {
      ...
      {
        return (object) Math.Exp(Convert.ToDouble(values[0]));
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_645");
    }
}
