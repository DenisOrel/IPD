...
// Type: Intermech.Expressions.Functions.AbsFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class AbsFunction : Function
    {
      ...
      {
        return (object) Math.Abs(Convert.ToDouble(values[0]));
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_625");
    }
}
