...
// Type: Intermech.Expressions.Functions.TrimFunction
...
{
    /// <summary>Trim function.</summary>
    public class TrimFunction : Function
    {
      public override object Evaluate(object[] values) => (object) Convert.ToString(values[0]).Trim();
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_690");
    }
}
