...
// Type: Intermech.Expressions.Functions.WeekDayFunction
...
namespace Intermech.Expressions.Functions
{
    ...
    public class WeekDayFunction : Function
    {
      ...
      {
        return (object) Convert.ToDateTime(values[0]).DayOfWeek;
      }
      ...
      public override string Description => LocalizationHolder.rm.GetString("Interfaces_693");
    }
}
