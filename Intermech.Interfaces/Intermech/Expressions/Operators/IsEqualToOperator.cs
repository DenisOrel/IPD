...
// Type: Intermech.Expressions.Operators.IsEqualToOperator
...
{
    /// <summary>IsEqualTo operator.</summary>
    internal class IsEqualToOperator : Operator
    {
      ...
      internal override OperatorType GetOperatorType() => OperatorType.isEqualToOperator;
