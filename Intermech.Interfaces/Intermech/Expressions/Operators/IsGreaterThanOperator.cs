...
// Type: Intermech.Expressions.Operators.IsGreaterThanOperator
...
{
    /// <summary>IsGreaterThan operator.</summary>
    internal class IsGreaterThanOperator : Operator
    {
      ...
      internal override OperatorType GetOperatorType() => OperatorType.isGreaterThanOperator;
