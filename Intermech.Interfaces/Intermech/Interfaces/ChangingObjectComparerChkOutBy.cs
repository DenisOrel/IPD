...
// Type: Intermech.Interfaces.ChangingObjectComparerChkOutBy
...
{
    /// <summary>
    /// Сравнить два описания изменяемых объектов по пользователям, взявшим объекты на редактирование
    /// </summary>
    public class ChangingObjectComparerChkOutBy : ChangingObjectComparer
    {
      /// <summary>
      ...
      /// [(Int64)Идентификатор пользователя] = [(object)Имя пользователя (string)]
      /// </param>
      public ChangingObjectComparerChkOutBy(bool ascending, Dictionary<long, object> users)
        : base(ascending)
      {
        this.users = users;
      }
