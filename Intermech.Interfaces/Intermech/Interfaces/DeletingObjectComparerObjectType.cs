...
// Type: Intermech.Interfaces.DeletingObjectComparerObjectType
...
{
    /// <summary>
    /// Сравнить два описания удаляемых объектов по типам их объектов
    /// </summary>
    public class DeletingObjectComparerObjectType : DeletingObjectComparer
    {
      /// <summary>
      ...
      /// </param>
      /// <param name="types">
      /// Кэш названий типов объектов. [(Int32)Идентификатор типа объекта] =&gt; [(object)Имя типа объекта (string)]
      /// </param>
      public DeletingObjectComparerObjectType(
        bool ascending,
