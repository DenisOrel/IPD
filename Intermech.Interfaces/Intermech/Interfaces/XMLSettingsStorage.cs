...
// Type: Intermech.Interfaces.XMLSettingsStorage
...
namespace Intermech.Interfaces
{
    ...
    public class XMLSettingsStorage : IXMLSettingsStorage
    {
      ...
      /// <summary>
      /// Дополнительные сервисы, которые можно разместить в хранилище
      /// </summary>
      [NonSerialized]
      ...
      {
        this._document.LoadXml("<?xml version=\"1.0\" encoding=\"utf-8\"?><IPS.UserSettings />");
      }
        ...
        if (stream != null && stream.Length != 0L)
        {
          if (stream.Position != stream.Length - 1L)
          {
            try
            {
              ...
              xmlDocument.LoadXml("<?xml version=\"1.0\" encoding=\"utf-8\"?><IPS.UserSettings />");
