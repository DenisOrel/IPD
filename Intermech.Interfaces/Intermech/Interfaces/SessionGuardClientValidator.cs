...
// Type: Intermech.Interfaces.SessionGuardClientValidator
...
{
    /// <summary>
    /// Базовый класс для клиентских объектов, реализующий защиту объектов сервера приложений от использования вне SessionKeeper.
    /// </summary>
    public class SessionGuardClientValidator
    {
      /// <summary>
