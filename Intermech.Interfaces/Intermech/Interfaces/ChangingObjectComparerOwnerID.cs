...
// Type: Intermech.Interfaces.ChangingObjectComparerOwnerID
...
{
    /// <summary>
    /// Сравнить два описания изменяемых объектов по их владельцам
    /// </summary>
    public class ChangingObjectComparerOwnerID : ChangingObjectComparer
    {
      /// <summary>
      ...
      /// [(Int64)Идентификатор пользователя] = [(object)Имя пользователя (string)]
      /// </param>
      public ChangingObjectComparerOwnerID(bool ascending, Dictionary<long, object> users)
        : base(ascending)
      {
        this.users = users;
      }
