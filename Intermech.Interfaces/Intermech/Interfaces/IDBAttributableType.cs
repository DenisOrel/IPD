...
// Type: Intermech.Interfaces.IDBAttributableType
...
namespace Intermech.Interfaces
{
    ...
    /// </summary>
    public interface IDBAttributableType
    {
      /// <summary>
      /// Список допустимых атрибутов для данного типа объектов или связей
      /// </summary>
      IDBAttribute4TypeCollection Attributes { get; }
      ...
      /// </summary>
      IDBAttribute4TypeCollection VisibleAttributes { get; }
      ...
      /// Если тип не может принимать такие атрибуты, то функция возвращает null.
      /// </summary>
      IDBAttributeType GetAttributeType(string attributeName);
    }
}
