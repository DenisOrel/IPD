...
// Type: Intermech.Interfaces.Data.Metadata.RelationTypeResolver
...
{
    public class RelationTypeResolver(Guid guid, IStateMonitor changeMonitor, ISyncRoot syncRoot) : 
      MetadataResolverBase<int>(guid, changeMonitor, syncRoot)
    {
      protected override GlobalId<int> CreateGID(Guid guid)
      {
        ...
        return new GlobalId<int>(guid, relationType.RelationTypeID, relationType.Description);
      }
    }
}
