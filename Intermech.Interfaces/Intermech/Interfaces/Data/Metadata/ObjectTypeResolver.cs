...
// Type: Intermech.Interfaces.Data.Metadata.ObjectTypeResolver
...
{
    public class ObjectTypeResolver(Guid guid, IStateMonitor changeMonitor, ISyncRoot syncRoot) : 
      MetadataResolverBase<int>(guid, changeMonitor, syncRoot)
    {
      protected override GlobalId<int> CreateGID(Guid guid)
      {
        ...
        return new GlobalId<int>(guid, objectType.ObjectTypeID, objectType.ObjectTypeName);
      }
    }
}
