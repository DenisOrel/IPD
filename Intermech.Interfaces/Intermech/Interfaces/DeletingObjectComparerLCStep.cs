...
// Type: Intermech.Interfaces.DeletingObjectComparerLCStep
...
{
    /// <summary>Сравнить два описания удаляемых объектов по шагам ЖЦ</summary>
    public class DeletingObjectComparerLCStep : DeletingObjectComparer
    {
      /// <summary>
      ...
      /// </param>
      /// <param name="lcsteps">
      /// Кэш названий шагов ЖЦ. [(Int32)Идентификатор шага ЖЦ] =&gt; [(object)Название шага ЖЦ (string)]
      /// </param>
      public DeletingObjectComparerLCStep(
        bool ascending,
