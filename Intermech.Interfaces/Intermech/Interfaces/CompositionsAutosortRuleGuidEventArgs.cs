...
// Type: Intermech.Interfaces.CompositionsAutosortRuleGuidEventArgs
...
namespace Intermech.Interfaces
{
    ...
    /// </summary>
    [Serializable]
    public class CompositionsAutosortRuleGuidEventArgs : EventArgs, IAssignable, ICloneable
    {
      /// <summary>Тип родительского объекта</summary>
      public Guid ObjectType = Guid.Empty;
      /// <summary>
      ...
      public List<Guid> VisibleRelTypes;
      ...
      public CompositionsAutosortRuleGuidEventArgs(
        Guid objectType,
        bool returnDefault,
        List<Guid> visibleRelTypes)
      {
        this.ObjectType = objectType;
        this.ReturnDefault = returnDefault;
        this.VisibleRelTypes = visibleRelTypes ?? new List<Guid>();
      }
      ...
      public CompositionsAutosortRuleGuidEventArgs(object source) => this.Assign(source);
      ...
      public void Clear()
      {
        ...
        this.VisibleRelTypes = new List<Guid>();
      }
      ...
      public void Assign(object source)
      {
        if (this == source)
          return;
        this.Clear();
        if (!(source is CompositionsAutosortRuleGuidEventArgs ruleGuidEventArgs))
          return;
        this.ObjectType = ruleGuidEventArgs.ObjectType;
        this.ReturnDefault = ruleGuidEventArgs.ReturnDefault;
        this.VisibleRelTypes = ruleGuidEventArgs.VisibleRelTypes != null ? new List<Guid>((IEnumerable<Guid>) ruleGuidEventArgs.VisibleRelTypes) : this.VisibleRelTypes;
      }
