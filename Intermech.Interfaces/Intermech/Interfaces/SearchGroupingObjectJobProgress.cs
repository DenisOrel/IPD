...
// Type: Intermech.Interfaces.SearchGroupingObjectJobProgress
...
{
    /// <summary>
    /// Индикатор выполнения задания по поиску группирующих объектов
    /// </summary>
    [Serializable]
    public enum SearchGroupingObjectJobProgress
    {
