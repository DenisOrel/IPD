...
// Type: Intermech.Interfaces.IDBLifecycleStepInfo
...
{
    /// <summary>Информация о щаге ЖЦ</summary>
    public interface IDBLifecycleStepInfo
    {
      ...
      DBLifecycleStepProperties Properties { get; }
