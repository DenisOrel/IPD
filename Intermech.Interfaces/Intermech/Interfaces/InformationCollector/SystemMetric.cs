...
// Type: Intermech.Interfaces.InformationCollector.SystemMetric
...
namespace Intermech.Interfaces.InformationCollector
{
    ...
    internal enum SystemMetric
    {
      ...
      /// </summary>
      SM_CYSCREEN = 1,
      /// <summary>Width of a horizontal scroll bar, in pixels.</summary>
      SM_CYVSCROLL = 2,
      ...
      /// </summary>
      SM_CXDLGFRAME = 7,
      /// <summary>Identical Values Changed After Windows NT 4.0</summary>
      SM_CXFIXEDFRAME = 7,
      /// <summary>
      /// Thickness of the frame around the perimeter of a window that has
      /// a caption but is not sizable, in pixels. SM_CXFIXEDFRAME is the
      ...
      SM_RESERVED1 = 24, // 0x00000018
      /// <summary>Reserved for future use</summary>
      SM_RESERVED2 = 25, // 0x00000019
      /// <summary>Reserved for future use</summary>
      SM_RESERVED3 = 26, // 0x0000001A
      /// <summary>Reserved for future use</summary>
      SM_RESERVED4 = 27, // 0x0000001B
      /// <summary>Minimum width of a window, in pixels.</summary>
      SM_CXMIN = 28, // 0x0000001C
      /// <summary>Minimum height of a window, in pixels.</summary>
      ...
      /// <summary>Nonzero if security is present; zero otherwise.</summary>
      ...
      /// <summary>Height of a small caption, in pixels</summary>
      SM_CYSMCAPTION = 51, // 0x00000033
      /// <summary>Width of small caption buttons, in pixels.</summary>
      SM_CXSMSIZE = 52, // 0x00000034
      /// <summary>Height of small caption buttons, in pixels.</summary>
      ...
      /// <summary>Width of a minimized window, in pixels.</summary>
      SM_CXMINIMIZED = 57, // 0x00000039
      /// <summary>Height of a minimized window, in pixels.</summary>
      ...
      /// <summary>Metrics Other</summary>
      SM_CMETRICS_OTHER = 76, // 0x0000004C
      /// <summary>
      ...
      /// <summary>Windows 2000 (v5.0+) Width of the virtual screen.</summary>
      SM_CXVIRTUALSCREEN = 78, // 0x0000004E
      /// <summary>Windows 2000 (v5.0+) Height of the virtual screen.</summary>
      ...
      /// <summary>Metrics Windows 2000</summary>
      SM_CMETRICS_2000 = 83, // 0x00000053
      /// <summary>
      ...
      /// <summary>Metrics Windows NT</summary>
      SM_CMETRICS_NT = 88, // 0x00000058
      /// <summary>
