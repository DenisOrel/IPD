...
// Type: Intermech.Navigator.Interfaces.IGuidMapper
...
/// памяти.
/// </summary>
public interface IGuidMapper
{
  int Register(Guid guid);

  int Register(Guid guid, int cookie);

  void Unregister(int Cookie);

  Guid this[int Cookie] { get; }
