...
// Type: Intermech.TechCard.Document.Client.Configs.Visual.ViewControllers.FieldContentsConfigViewController
...
[DocumentConfigElementEditor(DocumentConfigElementType.TemplateFieldContents)]
[DocumentConfigElementEditor(DocumentConfigElementType.AttributeFieldContents)]
[DocumentConfigElementEditor(DocumentConfigElementType.FormulaFieldContents)]
internal class FieldContentsConfigViewController : SetupViewController
{
  protected override IConfigView View { get; }

  public FieldContentsConfigViewController(IServiceProvider services)
    : base(services)
  {
    this.View = (IConfigView) new FieldContentsConfigView((IConfigViewController) this, services);
  }
}
