...
// Type: Intermech.TechCard.Document.Client.Configs.Visual.ViewControllers.TextTemplateConfigViewController
...
[DocumentConfigElementEditor(DocumentConfigElementType.TextField)]
internal class TextTemplateConfigViewController : SetupViewController
{
  protected override IConfigView View { get; }

  public TextTemplateConfigViewController(IServiceProvider services)
    : base(services)
  {
    this.View = (IConfigView) new TextTemplateConfigView((IConfigViewController) this, services);
  }
}
