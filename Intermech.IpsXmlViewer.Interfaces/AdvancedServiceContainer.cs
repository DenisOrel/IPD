...
// Type: Intermech.IpsXmlViewer.Interfaces.AdvancedServiceContainer
  ...
  IServiceProvider
{
  ...
  public IServiceProvider AdvancedProvider
  {
    ...
    set
    {
      this._advancedProvider = !this.Equals((object) value) ? value : throw new Exception("Нельзя задавать в качестве родительского контейнера сервисов ссылку на самого себя");
    }
  }
