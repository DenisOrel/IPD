...
// Type: Intermech.Document.Client.UI.ImDocumentComparisonForm
...
public class ImDocumentComparisonForm : FilesComparisonForm
{
  ...
  public ImDocumentComparisonForm()
  {
    this.Text = "Сравнение файлов документов";
  ...
  private void InitDifferenecesPanel()
  {
    ...
    this.panelDifferences.Size = new Size(694, 240 /*0xF0*/);
  ...
  {
    e.RowData.Icon = ImDocumentComparisonForm.TreeIcons.Where<KeyValuePair<string, Icon>>((Func<KeyValuePair<string, Icon>, bool>) (i =>
    {
  ...
  private void SyncCurrentPageIndex(DocumentControl origin, DocumentControl target)
  {
    ...
    if (target.Document.Nodes.Count >= index + 1)
      ...
      target.SetActivePage(target.Document.Nodes[target.Document.Nodes.Count - 1] as Page);
  }
  ...
  public List<string> ComparisonReport
  {
    get
    {
      return ((IEnumerable<string>) this.txtDifferences.Text.Split(new string[1]
      {
        "\r\n"
    ...
    set
    {
      this.txtDifferences.Text = value == null ? "" : string.Join("\r\n", (IEnumerable<string>) value);
    }
  }
  ...
  private static Dictionary<string, Icon> TreeIcons
  {
    get
    {
      if (ImDocumentComparisonForm._treeIcons == null)
        ImDocumentComparisonForm._treeIcons = new Dictionary<string, object>()
        {
          {
      ...
      return ImDocumentComparisonForm._treeIcons;
    }
  }
}
