...
// Type: Interop.Cadmech.IIMFaceAttrTT
...
[Guid("5F67A5F1-68AB-4D15-962C-12B17A965EAF")]
[ComImport]
public interface IIMFaceAttrTT : IIMFaceAttr
{
  [DispId(1)]
  ...
  [DispId(9)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  int GetItemIndex([MarshalAs(UnmanagedType.BStr), In] string p);

  [DispId(10)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string GetItemText([MarshalAs(UnmanagedType.BStr), In] string p);
}
