...
// Type: Interop.Cadmech.IIMAttrManagerEvents_OnAttributeAddedEventHandler
...
public delegate void IIMAttrManagerEvents_OnAttributeAddedEventHandler([MarshalAs(UnmanagedType.Interface), In] IMFaceAttr_COM pAttr);
