...
// Type: Intermech.ExternalSystemIntegration.Interfaces.IResponceConfigObject
...
public interface IResponceConfigObject : 
  IConfigObject,
  IDBObject,
  IDBAttributable,
  IDBSessionable,
  IPluginsData
{
  /// <summary>Идентификатор поискового атрибута</summary>
  int FinderID { get; set; }
}
