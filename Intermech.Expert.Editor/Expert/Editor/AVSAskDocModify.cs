...
// Type: Intermech.Expert.Editor.AVSAskDocModify
...
public class AVSAskDocModify : Form
{
  public int selRes;
  ...
  public AVSAskDocModify() => this.InitializeComponent();
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AVSAskDocModify));
    ...
    componentResourceManager.ApplyResources((object) this.rbView, "rbView");
    this.rbView.Name = "rbView";
    this.rbView.TabStop = true;
    this.rbView.Tag = (object) "3";
    ...
    this.Controls.Add((Control) this.rbView);
    this.Controls.Add((Control) this.rbOverwrite);
    this.Controls.Add((Control) this.panel2);
    this.Controls.Add((Control) this.panel1);
    this.MaximizeBox = false;
    this.MinimizeBox = false;
    this.Name = nameof (AVSAskDocModify);
