...
// Type: Intermech.TechCard.Client.Commands.CheckInCommand
...
/// <summary>Обработчик TechCard для CheckIn команд</summary>
internal class CheckInCommand : CheckinItemsCommand
{
  /// <summary>
  /// 
  /// </summary>
