...
// Type: Intermech.TechCard.Client.ObjectTypeSupport.TechCardObject.Wizard.SelectProductionCopyFromProductionReportWizardControl
...
/// <summary>Wizard выбора элемента из состава ПВ</summary>
public class SelectProductionCopyFromProductionReportWizardControl : DockWizardView
{
  /// <summary>
  /// 
  /// </summary>
  private SelectObjectTreeViewPageControl _selectObjectPage;
  /// <summary>Guid категория для закладки</summary>
  private static readonly Guid _rootCategoryNodeGuid = new Guid("CD821BB2-B097-4A52-B089-B5F879428EDC");
  ...
  private void InitializeCustomComponent()
  {
    ...
    this._selectObjectPage = new SelectObjectTreeViewPageControl()
    {
      ObjectTypeId = MRP2Consts.objtypeIdProductionObjects
    };
    this._selectObjectPage.Caption = this._selectObjectPage.Description = "Выберите объект из состава производственной ведомости";
    this._selectObjectPage.LoadPageControlData += new LoadPageControlEventHandler(this.SelectObjectFromProductionReportComposition_LoadPageControlData);
  ...
  public SelectProductionCopyFromProductionReportWizardControl()
  {
  ...
  public static int RootCategoryNodeId
  {
    get
    {
      if (SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeId != 0)
        return SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeId;
      SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeId = ServiceUtils.GetService<IGuidMapper>((object) ApplicationServices.Container, true).Register(SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeGuid);
      ...
      if (service1 != null)
      {
        ...
        if (icon != null)
          service1.AddIcon(icon, SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeId);
      }
      IFactory service2 = ServiceUtils.GetService<IFactory>((object) ApplicationServices.Container, false);
      if (service2 != null)
        SelectProductionCopyFromProductionReportWizardControlProvider.RegisterViewProvider(service2);
      return SelectProductionCopyFromProductionReportWizardControl._rootCategoryNodeId;
    }
  }
