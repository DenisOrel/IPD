...
// Type: Intermech.TechCard.Client.ObjectTypeSupport.ProcessRoutingEntry.Creator.ProcRouteEntryObjectCreatorControl
...
/// 
/// </summary>
public class ProcRouteEntryObjectCreatorControl : TechObjectCreatorBaseControl
{
  ...
  protected override void DoLoadObjectData(IDBObject dbObject)
  {
    ...
    this.procRouteEntryControl.StartLoadData(dbObject.Session);
  }
  ...
  /// 
  /// </summary>
  public ProcRouteEntryObjectCreatorControl() => this.InitializeComponent();
  ...
  public ProcRouteEntryObjectCreatorControl(
  ...
  private void InitializeComponent()
  {
    ...
    this.SuspendLayout();
    this.procRouteEntryControl.Dock = DockStyle.Fill;
    this.procRouteEntryControl.Location = new Point(0, 0);
    this.procRouteEntryControl.Name = "procRouteEntryControl";
    this.procRouteEntryControl.Size = new Size(449, 246);
    this.procRouteEntryControl.TabIndex = 0;
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.Controls.Add((Control) this.procRouteEntryControl);
    this.Name = nameof (ProcRouteEntryObjectCreatorControl);
