...
// Type: Intermech.TechCard.Client.TcObjectsTypes.CehZahod.CehZahodContextCommandProvider
...
#nullable disable
namespace Intermech.TechCard.Client.TcObjectsTypes.CehZahod;

/// <summary>
/// Summary description for CehZahodContextCommandProvider.
/// </summary>
public class CehZahodContextCommandProvider : ICommandsProvider
{
  ...
  public CehZahodContextCommandProvider()
  {
  ...
  public CommandsInfo GetMergedCommands(ISelectedItems items, IServiceProvider viewServices)
  {
    ...
    if ((viewState & 2L) == 0L)
      mergedCommands.Add("Add", new CommandInfo(0, new ClickEventHandler(CehZahodContextCommandProvider.AddCommandTpNode)));
  ...
  public CommandsInfo GetGroupCommands(ISelectedItems items, IServiceProvider viewServices)
  {
    ...
    if (items.Count == 1)
    {
      ...
      if (!flag && objectType != null && MetaDataHelper.GetObjectTypeApplicabilities(objectType.ObjectTypeID).Count != 0)
        groupCommands.Add("Add", new CommandInfo(0, new ClickEventHandler(CehZahodContextCommandProvider.AddCommandTpNode)));
    }
