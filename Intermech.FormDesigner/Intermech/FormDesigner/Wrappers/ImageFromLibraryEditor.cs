...
// Type: Intermech.FormDesigner.Wrappers.ImageFromLibraryEditor
...
/// 
/// </summary>
public class ImageFromLibraryEditor : UITypeEditor
{
  /// <summary>
  /// 
  /// </summary>
    ...
    if (service != null && rootDescriptor != null)
    {
      ...
      if (numArray != null && numArray.Length != 0)
      {
        using (SessionKeeper sessionKeeper = new SessionKeeper())
        {
          ...
          return dbObject == null ? (object) Guid.Empty : (object) dbObject.ObjectGUID;
        }
      }
    }
    return value;
