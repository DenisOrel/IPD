...
// Type: Intermech.FormDesigner.Wrappers.AttrCheckBoxWrapper
...
/// 
/// </summary>
internal class AttrCheckBoxWrapper : IImageFromLibrary, IWrapper
{
  private AttrCheckBox _attrChb = new AttrCheckBox();
  ...
  {
    get => this._attrChb.BackgroundImage;
  ...
  {
    get => this._attrChb.BackgroundImageLayout;
  ...
  [CustomDisplayName("Attribute.FormDesigner_43")]
  [CustomCategory("Attribute.FormDesigner_8")]
  [CustomDescription("Attribute.FormDesigner.CheckAlign.Description")]
  [TypeConverter(typeof (ContentAlignmentConverter))]
  public ContentAlignment CheckAlign
  {
    get => this._attrChb.CheckAlign;
    set => this.SetValue(this._pdc[nameof (CheckAlign)], (object) value);
  }

  /// <summary>Выставление значения по умолчанию переключателю.</summary>
  [DefaultValue(false)]
  [CustomDisplayName("Attribute.FormDesigner.Checked")]
  [CustomCategory("Attribute.FormDesigner_8")]
  [CustomDescription("Attribute.FormDesigner.Checked.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool Checked
  {
    get => this._attrChb.Checked;
    set => this.SetValue(this._pdc[nameof (Checked)], (object) value);
  }
  ...
  {
    get => this._attrChb.ImageFromLibrary;
    set => this.SetValue(this._pdc[nameof (ImageFromLibrary)], (object) value);
  }

  /// <summary>ID объекта "библиотечное изображение".</summary>
  [Browsable(false)]
  public long ImageFromLibraryID => this._attrChb.ImageFromLibraryID;

  /// <summary>Наименование изображения.</summary>
  [Browsable(false)]
  public string ImageFromLibraryName => this._attrChb.ImageFromLibraryName;
  ...
  {
    get => this._attrChb.DisabledInDesign;
  ...
  [FieldTypes(new FieldTypes[] {FieldTypes.ftBoolean})]
  [MultiValueModes(new MultiValueModes[] {MultiValueModes.SingleValue})]
  [RefreshProperties(RefreshProperties.All)]
  public AttributeInfo AttributeInfo
  {
    get => this._attrChb.AttributeInfo;
  ...
  {
    get => this._attrChb.CanAddAttribute;
  ...
  public string Tag
  {
    get => Convert.ToString(this._attrChb.Tag);
    set
    {
  ...
  {
    get => this._attrChb.UseInExpertSystem;
  ...
  public string Name
  {
    get => this._attrChb.Name;
    set
    {
      this._attrChb.Name = value;
      if (this._attrChb.Site == null)
        return;
      this._attrChb.Site.Name = value;
    }
  }
  ...
  public Size Size
  {
    get => this._attrChb.Size;
    set => this.SetValue(this._pdc[nameof (Size)], (object) value);
  }

  /// <summary>Конструктор.</summary>
  /// <param name="parent">Контрол</param>
  public AttrCheckBoxWrapper(AttrCheckBox parent)
  {
    this._attrChb = parent;
    this._pdc = TypeDescriptor.GetProperties((object) this._attrChb, true);
  }
  ...
  {
    if (prop == null)
      throw new Exception(LocalizationHolder.rm.GetString(sc_7194.ssp_imclient_7195()));
    prop.SetValue((object) this._attrChb, value);
  }
  ...
  /// </summary>
  [Browsable(false)]
  public object BaseClass => (object) this._attrChb;
}
