...
// Type: Intermech.FormDesigner.Wrappers.DockPaddingEdgesConverter
...
/// <summary>DockPaddingEdgesConverter для русификации</summary>
public class DockPaddingEdgesConverter : TypeConverter
{
    ...
    Attribute[] attributes)
  {
    ...
    propertyDescriptor1.AddAttribute((Attribute) new CustomDescription("Attribute.FormDesigner_84"));
    ...
    propertyDescriptor2.AddAttribute((Attribute) new CustomDescription("Attribute.FormDesigner_85"));
    ...
    propertyDescriptor3.AddAttribute((Attribute) new CustomDescription("Attribute.FormDesigner_86"));
    ...
    propertyDescriptor4.AddAttribute((Attribute) new CustomDescription("Attribute.FormDesigner_88"));
    ...
    propertyDescriptor5.AddAttribute((Attribute) new CustomDescription("Attribute.FormDesigner_90"));
