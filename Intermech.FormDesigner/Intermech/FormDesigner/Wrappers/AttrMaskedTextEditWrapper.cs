...
// Type: Intermech.FormDesigner.Wrappers.AttrMaskedTextEditWrapper
...
/// 
/// </summary>
internal class AttrMaskedTextEditWrapper : IWrapper
{
  private AttrMaskedTextEdit _attrMaskedTxtEdit = new AttrMaskedTextEdit();
  ...
  {
    get => this._attrMaskedTxtEdit.BackColor;
  ...
  {
    get => this._attrMaskedTxtEdit.BorderStyle;
  ...
  public Font Font
  {
    get => this._attrMaskedTxtEdit.Font;
  ...
  {
    get => this._attrMaskedTxtEdit.ForeColor;
  ...
  public string Hint
  {
    get => this._attrMaskedTxtEdit.Hint;
    set => this.SetValue(this._pdc[nameof (Hint)], (object) value);
  }

  /// <summary>Знак, предлагающий пользователю ввести данные.</summary>
  [DefaultValue('_')]
  [CustomDisplayName("Attribute.FormDesigner.PromptChar")]
  [CustomCategory("Attribute.FormDesigner_8")]
  [CustomDescription("Attribute.FormDesigner.PromptChar.Description")]
  public char PromptChar
  {
    get => this._attrMaskedTxtEdit.PromptChar;
    set => this.SetValue(this._pdc[nameof (PromptChar)], (object) value);
  }
  ...
  public string Text
  {
    get => this._attrMaskedTxtEdit.Text;
  ...
  {
    get => this._attrMaskedTxtEdit.TextAlign;
  ...
  /// </summary>
  [DefaultValue(true)]
  [CustomDisplayName("Attribute.FormDesigner.AllowPromptAsInput")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.AllowPromptAsInput.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool AllowPromptAsInput
  {
    get => this._attrMaskedTxtEdit.AllowPromptAsInput;
    set => this.SetValue(this._pdc[nameof (AllowPromptAsInput)], (object) value);
  }
  ...
  /// </summary>
  [DefaultValue(false)]
  [CustomDisplayName("Attribute.FormDesigner.BeepOnError")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.BeepOnError.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool BeepOnError
  {
    get => this._attrMaskedTxtEdit.BeepOnError;
    set => this.SetValue(this._pdc[nameof (BeepOnError)], (object) value);
  }
  ...
  [CustomDisplayName("Attribute.FormDesigner.CutCopyMaskFormat")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.CutCopyMaskFormat.Description")]
  [TypeConverter(typeof (MaskFormatConverter))]
  [Editor(typeof (MaskFormatEditor), typeof (UITypeEditor))]
  public MaskFormat CutCopyMaskFormat
  {
    get => this._attrMaskedTxtEdit.CutCopyMaskFormat;
    set => this.SetValue(this._pdc[nameof (CutCopyMaskFormat)], (object) value);
  }
  ...
  {
    get => this._attrMaskedTxtEdit.DisabledInDesign;
  ...
  /// </summary>
  [DefaultValue(false)]
  [CustomDisplayName("Attribute.FormDesigner.HidePromptOnLeave")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.HidePromptOnLeave.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool HidePromptOnLeave
  {
    get => this._attrMaskedTxtEdit.HidePromptOnLeave;
    set => this.SetValue(this._pdc[nameof (HidePromptOnLeave)], (object) value);
  }
  ...
  /// </summary>
  [DefaultValue(true)]
  [CustomDisplayName("Attribute.FormDesigner.ResetOnPrompt")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.ResetOnPrompt.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool ResetOnPrompt
  {
    get => this._attrMaskedTxtEdit.ResetOnPrompt;
    set => this.SetValue(this._pdc[nameof (ResetOnPrompt)], (object) value);
  }
  ...
  /// </summary>
  [DefaultValue(true)]
  [CustomDisplayName("Attribute.FormDesigner.ResetOnSpace")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.ResetOnSpace.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool ResetOnSpace
  {
    get => this._attrMaskedTxtEdit.ResetOnSpace;
    set => this.SetValue(this._pdc[nameof (ResetOnSpace)], (object) value);
  }
  ...
  /// </summary>
  [DefaultValue(true)]
  [CustomDisplayName("Attribute.FormDesigner.SkipLiterals")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.SkipLiterals.Description")]
  [TypeConverter(typeof (BooleanConverter))]
  [Editor(typeof (BooleanEditor), typeof (UITypeEditor))]
  public bool SkipLiterals
  {
    get => this._attrMaskedTxtEdit.SkipLiterals;
    set => this.SetValue(this._pdc[nameof (SkipLiterals)], (object) value);
  }
  ...
  public int TabIndex
  {
    get => this._attrMaskedTxtEdit.TabIndex;
  ...
  public bool TabStop
  {
    get => this._attrMaskedTxtEdit.TabStop;
  ...
  /// </summary>
  [DefaultValue(typeof (MaskFormat), "IncludeLiterals")]
  [CustomDisplayName("Attribute.FormDesigner.TextMaskFormat")]
  [CustomCategory("Attribute.FormDesigner_5")]
  [CustomDescription("Attribute.FormDesigner.TextMaskFormat.Description")]
  [TypeConverter(typeof (MaskFormatConverter))]
  [Editor(typeof (MaskFormatEditor), typeof (UITypeEditor))]
  public MaskFormat TextMaskFormat
  {
    get => this._attrMaskedTxtEdit.TextMaskFormat;
    set => this.SetValue(this._pdc[nameof (TextMaskFormat)], (object) value);
  }
  ...
  [FieldTypes(new FieldTypes[] {FieldTypes.ftString})]
  [MultiValueModes(new MultiValueModes[] {MultiValueModes.SingleValue})]
  [RefreshProperties(RefreshProperties.All)]
  public AttributeInfo AttributeInfo
  {
    get => this._attrMaskedTxtEdit.AttributeInfo;
  ...
  {
    get => this._attrMaskedTxtEdit.CanAddAttribute;
  ...
  {
    get => this._attrMaskedTxtEdit.ParentPoint;
  ...
  public string Tag
  {
    get => Convert.ToString(this._attrMaskedTxtEdit.Tag);
    set
    {
  ...
  {
    get => this._attrMaskedTxtEdit.UseInExpertSystem;
  ...
  public string Name
  {
    get => this._attrMaskedTxtEdit.Name;
    set
    {
      this._attrMaskedTxtEdit.Name = value;
      if (this._attrMaskedTxtEdit.Site == null)
        return;
      this._attrMaskedTxtEdit.Site.Name = value;
    }
  }
  ...
  {
    get => this._attrMaskedTxtEdit.Anchor;
  ...
  {
    get => this._attrMaskedTxtEdit.Dock;
  ...
  {
    get => this._attrMaskedTxtEdit.Location;
  ...
  {
    get => this._attrMaskedTxtEdit.Margin;
  ...
  {
    get => this._attrMaskedTxtEdit.MaximumSize;
  ...
  {
    get => this._attrMaskedTxtEdit.MinimumSize;
  ...
  public Size Size
  {
    get => this._attrMaskedTxtEdit.Size;
    set => this.SetValue(this._pdc[nameof (Size)], (object) value);
  }

  /// <summary>Конструктор.</summary>
  /// <param name="parent"></param>
  public AttrMaskedTextEditWrapper(AttrMaskedTextEdit parent)
  {
    this._attrMaskedTxtEdit = parent;
    this._pdc = TypeDescriptor.GetProperties((object) this._attrMaskedTxtEdit, true);
  }
  ...
  {
    if (prop == null)
      throw new Exception(LocalizationHolder.rm.GetString(sc_7199.ssp_imclient_7200()));
    prop.SetValue((object) this._attrMaskedTxtEdit, value);
  }
  ...
  /// </summary>
  [Browsable(false)]
  public object BaseClass => (object) this._attrMaskedTxtEdit;
}
