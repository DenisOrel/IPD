...
// Type: Intermech.FormDesigner.Wrappers.AttrTextEditWrapper
...
/// 
/// </summary>
internal class AttrTextEditWrapper : IWrapper
{
  private AttrTextEdit _attrTxtEdit = new AttrTextEdit();
  ...
  {
    get => this._attrTxtEdit.BackColor;
  ...
  {
    get => this._attrTxtEdit.BorderStyle;
  ...
  {
    get => this._attrTxtEdit.ForeColor;
  ...
  {
    get => this._attrTxtEdit.TextAlign;
  ...
  {
    get => this._attrTxtEdit.DisabledInDesign;
  ...
  public int TabIndex
  {
    get => this._attrTxtEdit.TabIndex;
  ...
  [FieldTypes(new FieldTypes[] {FieldTypes.ftString, FieldTypes.ftInteger, FieldTypes.ftDouble, FieldTypes.ftGuid, FieldTypes.ftSystem})]
  [MultiValueModes(new MultiValueModes[] {MultiValueModes.SingleValue})]
  [RefreshProperties(RefreshProperties.All)]
  public AttributeInfo AttributeInfo
  {
    get => this._attrTxtEdit.AttributeInfo;
  ...
  {
    get => this._attrTxtEdit.CanAddAttribute;
  ...
  {
    get => this._attrTxtEdit.ParentPoint;
  ...
  public string Tag
  {
    get => Convert.ToString(this._attrTxtEdit.Tag);
    set
    {
  ...
  {
    get => this._attrTxtEdit.UseInExpertSystem;
  ...
  public string Name
  {
    get => this._attrTxtEdit.Name;
    set
    {
      this._attrTxtEdit.Name = value;
      if (this._attrTxtEdit.Site == null)
        return;
      this._attrTxtEdit.Site.Name = value;
    }
  }
  ...
  {
    get => this._attrTxtEdit.Location;
  ...
  {
    get => this._attrTxtEdit.MaximumSize;
  ...
  {
    get => this._attrTxtEdit.MinimumSize;
  ...
  public Size Size
  {
    get => this._attrTxtEdit.Size;
    set => this.SetValue(this._pdc[nameof (Size)], (object) value);
  }

  /// <summary>Конструктор.</summary>
  /// <param name="parent"></param>
  public AttrTextEditWrapper(AttrTextEdit parent)
  {
    this._attrTxtEdit = parent;
    this._pdc = TypeDescriptor.GetProperties((object) this._attrTxtEdit, true);
  }
  ...
  {
    if (prop == null)
      throw new Exception(LocalizationHolder.rm.GetString(sc_7205.ssp_imclient_7206()));
    prop.SetValue((object) this._attrTxtEdit, value);
  }
  ...
  /// </summary>
  [Browsable(false)]
  public object BaseClass => (object) this._attrTxtEdit;
}
