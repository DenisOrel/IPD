...
// Type: Intermech.FormDesigner.Descriptors.AttrComboBoxDescriptor
...
internal class AttrComboBoxDescriptor(Control ctrl) : FormDesignerControlDescriptor(ctrl)
{
  /// <summary>
  /// 
  /// </summary>
  ...
  protected override void FillPropertyAttributes(string propertyName, List<Attribute> attributes)
  {
    ...
    switch (propertyName)
    {
      ...
      case "MaxDropDownItems":
        attributes.Add((Attribute) new DefaultValueAttribute(8));
        break;
      case "AttributeInfo":
