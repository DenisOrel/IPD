...
// Type: Intermech.FormDesigner.Descriptors.AttrMeasuredListBoxDescriptor
...
internal class AttrMeasuredListBoxDescriptor(Control ctrl) : FormDesignerControlDescriptor(ctrl)
{
  /// <summary>
  /// 
  /// </summary>
