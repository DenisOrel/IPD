...
// Type: Intermech.Compass3D.Integrator.IInMemoryConfigurationFeatureDetector
...
internal interface IInMemoryConfigurationFeatureDetector
{
  bool IsInMemory { get; }

  string DocumentVirtualPath { get; }
}
