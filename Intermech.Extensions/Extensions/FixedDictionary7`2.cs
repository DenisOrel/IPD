...
// Type: Intermech.Extensions.FixedDictionary7`2
...
public class FixedDictionary7<TKey, TValue> : 
  ...
  IReadOnlyDictionary<TKey, TValue>
{
  ...
  private static bool KeyIsReference
  {
    ...
    {
      return FixedDictionary7<TKey, TValue>._keyIsReference ?? (FixedDictionary7<TKey, TValue>._keyIsReference = new bool?(typeof (TKey).IsByRef)).Value;
    }
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public FixedDictionary7(
  ...
  {
    return (IEnumerator<(TKey, TValue)>) new FixedDictionary7<TKey, TValue>.TupleEnumerator(this);
  }

  IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator()
  {
    return (IEnumerator<KeyValuePair<TKey, TValue>>) new FixedDictionary7<TKey, TValue>.KeyValuePairEnumerator(this);
  }
  ...
  {
    int num = FixedDictionary7<TKey, TValue>.KeyIsReference ? 1 : 0;
    return this._keyComparer.Equals(this._key0, key) || this._keyComparer.Equals(this._key1, key) || this._keyComparer.Equals(this._key2, key) || this._keyComparer.Equals(this._key3, key) || this._keyComparer.Equals(this._key4, key) || this._keyComparer.Equals(this._key5, key) || this._keyComparer.Equals(this._key6, key);
  }
  ...
  public IEnumerable<TKey> Keys
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TKey>) (this._keys = new TKey[7]
      {
        this._key0,
        this._key1,
        this._key2,
  ...
  public IEnumerable<TValue> Values
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TValue>) (this._values = new TValue[7]
      {
        this._value0,
        this._value1,
        this._value2,
  ...
  {
    [NotNull]
    private readonly FixedDictionary7<TKey, TValue> _owner;
    private int _fieldNum = -1;

    public KeyValuePairEnumerator([NotNull] FixedDictionary7<TKey, TValue> owner)
    {
      this._owner = owner;
    }
  ...
  private class TupleEnumerator : IEnumerator<(TKey Key, TValue Value)>, IDisposable, IEnumerator
  {
    ...
    public TupleEnumerator([NotNull] FixedDictionary7<TKey, TValue> owner) => this._owner = owner;
