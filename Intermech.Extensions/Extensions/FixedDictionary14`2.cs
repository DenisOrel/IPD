...
// Type: Intermech.Extensions.FixedDictionary14`2
...
public class FixedDictionary14<TKey, TValue> : 
  ...
  IReadOnlyDictionary<TKey, TValue>
{
  ...
  private const int ItemsCount = 14;
  [NotNull]
  ...
  private static bool KeyIsReference
  {
    ...
    {
      return FixedDictionary14<TKey, TValue>._keyIsReference ?? (FixedDictionary14<TKey, TValue>._keyIsReference = new bool?(typeof (TKey).IsByRef)).Value;
    }
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public FixedDictionary14(
  ...
  {
    return (IEnumerator<(TKey, TValue)>) new FixedDictionary14<TKey, TValue>.TupleEnumerator(this);
  }

  IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator()
  {
    return (IEnumerator<KeyValuePair<TKey, TValue>>) new FixedDictionary14<TKey, TValue>.KeyValuePairEnumerator(this);
  }
  ...
  {
    int num = FixedDictionary14<TKey, TValue>.KeyIsReference ? 1 : 0;
    return this._keyComparer.Equals(this._key0, key) || this._keyComparer.Equals(this._key1, key) || this._keyComparer.Equals(this._key2, key) || this._keyComparer.Equals(this._key3, key) || this._keyComparer.Equals(this._key4, key) || this._keyComparer.Equals(this._key5, key) || this._keyComparer.Equals(this._key6, key) || this._keyComparer.Equals(this._key7, key) || this._keyComparer.Equals(this._key8, key) || this._keyComparer.Equals(this._key9, key) || this._keyComparer.Equals(this._key10, key) || this._keyComparer.Equals(this._key11, key) || this._keyComparer.Equals(this._key12, key) || this._keyComparer.Equals(this._key13, key);
  }
  ...
  public IEnumerable<TKey> Keys
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TKey>) (this._keys = new TKey[14]
      {
        this._key0,
        this._key1,
        this._key2,
  ...
  public IEnumerable<TValue> Values
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TValue>) (this._values = new TValue[14]
      {
        this._value0,
        this._value1,
        this._value2,
  ...
  {
    [NotNull]
    private readonly FixedDictionary14<TKey, TValue> _owner;
    private int _fieldNum = -1;

    public KeyValuePairEnumerator([NotNull] FixedDictionary14<TKey, TValue> owner)
    {
      this._owner = owner;
    }
    ...
    {
      if (this._fieldNum < 14)
        ++this._fieldNum;
      return this._fieldNum < 14;
    }
  ...
  private class TupleEnumerator : IEnumerator<(TKey Key, TValue Value)>, IDisposable, IEnumerator
  {
    ...
    public TupleEnumerator([NotNull] FixedDictionary14<TKey, TValue> owner) => this._owner = owner;
