...
// Type: Intermech.Extensions.FixedDictionary15`2
...
public class FixedDictionary15<TKey, TValue> : 
...
{
  private const int ItemsCount = 15;
  ...
  [NotNull]
  private readonly TKey _key11;
  [CanBeNull]
  private readonly TValue _value11;
  [NotNull]
  private readonly TKey _key12;
  [CanBeNull]
  private readonly TValue _value12;
  [NotNull]
  private readonly TKey _key13;
  [CanBeNull]
  private readonly TValue _value13;
  [NotNull]
  private readonly TKey _key14;
  [CanBeNull]
  private readonly TValue _value14;
  [CanBeNull]
  [ItemNotNull]
  private TKey[] _keys;
  [CanBeNull]
  ...
  private static bool KeyIsReference
  {
    ...
    {
      return FixedDictionary15<TKey, TValue>._keyIsReference ?? (FixedDictionary15<TKey, TValue>._keyIsReference = new bool?(typeof (TKey).IsByRef)).Value;
    }
  }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public FixedDictionary15(
    ...
    [NotNull] IEnumerable<(TKey Key, TValue Value)> keyValues)
  {
    ...
    using (IEnumerator<(TKey Key, TValue Value)> enumerator = keyValues.GetEnumerator())
    {
      ...
      (this._key11, this._value11) = enumerator.MoveNext() ? enumerator.Current : throw new Exception("Wrong items count!");
      (this._key12, this._value12) = enumerator.MoveNext() ? enumerator.Current : throw new Exception("Wrong items count!");
      (this._key13, this._value13) = enumerator.MoveNext() ? enumerator.Current : throw new Exception("Wrong items count!");
      (this._key14, this._value14) = enumerator.MoveNext() ? enumerator.Current : throw new Exception("Wrong items count!");
    }
  }
  ...
  {
    return (IEnumerator<(TKey, TValue)>) new FixedDictionary15<TKey, TValue>.TupleEnumerator(this);
  }

  IEnumerator<KeyValuePair<TKey, TValue>> IEnumerable<KeyValuePair<TKey, TValue>>.GetEnumerator()
  {
    return (IEnumerator<KeyValuePair<TKey, TValue>>) new FixedDictionary15<TKey, TValue>.KeyValuePairEnumerator(this);
  }
  ...
  public (TKey Key, TValue Value) this[int index]
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      switch (index)
      {
        ...
        case 11:
          return (this._key11, this._value11);
        case 12:
          return (this._key12, this._value12);
        case 13:
          return (this._key13, this._value13);
        case 14:
          return (this._key14, this._value14);
        default:
  ...
  KeyValuePair<TKey, TValue> IReadOnlyList<KeyValuePair<TKey, TValue>>.this[int index]
  {
    get
    {
      switch (index)
      {
        ...
        case 11:
          return new KeyValuePair<TKey, TValue>(this._key11, this._value11);
        case 12:
          return new KeyValuePair<TKey, TValue>(this._key12, this._value12);
        case 13:
          return new KeyValuePair<TKey, TValue>(this._key13, this._value13);
        case 14:
          return new KeyValuePair<TKey, TValue>(this._key14, this._value14);
        default:
          throw new InvalidOperationException("Invalid index");
      }
    }
  ...
  {
    int num = FixedDictionary15<TKey, TValue>.KeyIsReference ? 1 : 0;
    return this._keyComparer.Equals(this._key0, key) || this._keyComparer.Equals(this._key1, key) || this._keyComparer.Equals(this._key2, key) || this._keyComparer.Equals(this._key3, key) || this._keyComparer.Equals(this._key4, key) || this._keyComparer.Equals(this._key5, key) || this._keyComparer.Equals(this._key6, key) || this._keyComparer.Equals(this._key7, key) || this._keyComparer.Equals(this._key8, key) || this._keyComparer.Equals(this._key9, key) || this._keyComparer.Equals(this._key10, key) || this._keyComparer.Equals(this._key11, key) || this._keyComparer.Equals(this._key12, key) || this._keyComparer.Equals(this._key13, key) || this._keyComparer.Equals(this._key14, key);
  }
  ...
  public bool TryGetValue([NotNull] TKey key, [CanBeNull] out TValue value)
  {
    ...
    if (this._keyComparer.Equals(this._key11, key))
    {
      value = this._value11;
      return true;
    }
    if (this._keyComparer.Equals(this._key12, key))
    {
      value = this._value12;
      return true;
    }
    if (this._keyComparer.Equals(this._key13, key))
    {
      value = this._value13;
      return true;
    }
    if (this._keyComparer.Equals(this._key14, key))
    {
      value = this._value14;
      return true;
    }
  ...
  public IEnumerable<TKey> Keys
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TKey>) (this._keys = new TKey[15]
      {
        this._key0,
        this._key1,
        this._key2,
  ...
  public IEnumerable<TValue> Values
  {
    [MethodImpl(MethodImplOptions.AggressiveInlining)] get
    {
      ...
      return (IEnumerable<TValue>) (this._values = new TValue[15]
      {
        this._value0,
        this._value1,
        this._value2,
  ...
  {
    [NotNull]
    private readonly FixedDictionary15<TKey, TValue> _owner;
    private int _fieldNum = -1;

    public KeyValuePairEnumerator([NotNull] FixedDictionary15<TKey, TValue> owner)
    {
      this._owner = owner;
    }
    ...
    {
      if (this._fieldNum < 15)
        ++this._fieldNum;
      return this._fieldNum < 15;
    }
    ...
    public KeyValuePair<TKey, TValue> Current
    {
      get
      {
        switch (this._fieldNum)
        {
          ...
          case 11:
            return new KeyValuePair<TKey, TValue>(this._owner._key11, this._owner._value11);
          case 12:
            return new KeyValuePair<TKey, TValue>(this._owner._key12, this._owner._value12);
          case 13:
            return new KeyValuePair<TKey, TValue>(this._owner._key13, this._owner._value13);
          case 14:
            return new KeyValuePair<TKey, TValue>(this._owner._key14, this._owner._value14);
          default:
  ...
  private class TupleEnumerator : IEnumerator<(TKey Key, TValue Value)>, IDisposable, IEnumerator
  {
    ...
    public TupleEnumerator([NotNull] FixedDictionary15<TKey, TValue> owner) => this._owner = owner;
    ...
    public (TKey Key, TValue Value) Current
    {
      get
      {
        switch (this._fieldNum)
        {
          ...
          case 11:
            return (this._owner._key11, this._owner._value11);
          case 12:
            return (this._owner._key12, this._owner._value12);
          case 13:
            return (this._owner._key13, this._owner._value13);
          case 14:
            return (this._owner._key14, this._owner._value14);
          default:
            throw new InvalidOperationException("Call to the Reset and MoveNext method first");
        }
      }
