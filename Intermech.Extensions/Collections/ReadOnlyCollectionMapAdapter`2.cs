...
// Type: Intermech.Collections.ReadOnlyCollectionMapAdapter`2
...
internal sealed class ReadOnlyCollectionMapAdapter<T, TMapped> : 
  ...
  ICapacity
{
  ...
  public ReadOnlyCollectionMapAdapter([NotNull] IReadOnlyCollection<T> collection, [NotNull] Func<T, TMapped> selector)
    : base(collection)
  {
