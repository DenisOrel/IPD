...
// Type: Intermech.Collections.DictionaryWithMapping`3
...
public class DictionaryWithMapping<TKey, TValue, TMappedValue> : 
  ...
  IEnumerable
{
  ...
  [CanBeNull]
  private DictionaryMapValuesAdapter<TKey, TValue, TMappedValue> _dictionaryMapValuesAdapter;
  ...
  public IReadOnlyDictionary<TKey, TMappedValue> Mapped
  {
    ...
    {
      return (IReadOnlyDictionary<TKey, TMappedValue>) this._dictionaryMapValuesAdapter ?? (IReadOnlyDictionary<TKey, TMappedValue>) (this._dictionaryMapValuesAdapter = new DictionaryMapValuesAdapter<TKey, TValue, TMappedValue>((IDictionary<TKey, TValue>) this, this._selector));
    }
  }

  public DictionaryWithMapping(
