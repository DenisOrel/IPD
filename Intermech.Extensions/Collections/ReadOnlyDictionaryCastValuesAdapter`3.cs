...
// Type: Intermech.Collections.ReadOnlyDictionaryCastValuesAdapter`3
...
[Serializable]
internal sealed class ReadOnlyDictionaryCastValuesAdapter<TKey, TValue, TMappedValue> : 
  ReadOnlyDictionaryAdapterBase<TKey, TValue>,
...
{
  public ReadOnlyDictionaryCastValuesAdapter([NotNull] IReadOnlyDictionary<TKey, TValue> dictionary)
    : base(dictionary)
  {
  }

  private ReadOnlyDictionaryCastValuesAdapter([NotNull] SerializationInfo info, StreamingContext context)
    : base(info, context)
  {
  }
  ...
  {
    [DebuggerStepThrough, MethodImpl(MethodImplOptions.AggressiveInlining)] get => this.Keys;
  }
