...
// Type: Intermech.Collections.ListCastAdapter`2
...
[Serializable]
internal sealed class ListCastAdapter<T, TMapped> : 
  ListAdapterBase<T>,
  ...
  where T : TMapped
{
  public ListCastAdapter([NotNull] IList<T> list)
    : base(list)
  {
  }

  private ListCastAdapter([NotNull] SerializationInfo info, StreamingContext context)
    : base(info, context)
  {
  }
