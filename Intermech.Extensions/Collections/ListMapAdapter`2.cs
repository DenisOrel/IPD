...
// Type: Intermech.Collections.ListMapAdapter`2
...
internal sealed class ListMapAdapter<T, TMapped> : 
  ListAdapterBase<T>,
  ...
  IEquatable<IList<T>>
{
  ...
  public ListMapAdapter([NotNull] IList<T> list, [NotNull] Func<T, TMapped> selector)
    : base(list)
  {
