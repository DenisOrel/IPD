...
// Type: Intermech.Archives.BarCodes.CustomBooleanConverter
...
public class CustomBooleanConverter : BooleanConverter
{
  ...
  public string TrueString = "Да";
  /// <summary>Расшифровка значения false</summary>
  public string FalseString = "Нет";
    ...
    object value)
  {
    ...
    if (str == this.TrueString)
      return (object) true;
    if (str == this.FalseString)
      return (object) false;
