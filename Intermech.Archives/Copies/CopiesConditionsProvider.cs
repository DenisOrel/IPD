...
// Type: Intermech.Archives.Copies.CopiesConditionsProvider
...
/// <summary>
/// Провайдер условий запроса к базе данных для поиска копий документа
/// </summary>
public class CopiesConditionsProvider : IConditionsProvider
{
  ...
  /// вызова <see cref="M:Intermech.Archives.Copies.CopiesConditionsProvider.GetConditions" />. До первого вызова указанного метода
