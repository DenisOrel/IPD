...
// Type: Intermech.Archives.ColumnsAutoSettingsProvider
...
/// <summary>
/// Провайдер для регистрации закладки "Настройка колонок"
/// </summary>
internal class ColumnsAutoSettingsProvider : IViewsProvider
{
  /// <summary>
  ...
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    if (ServicesManager.GetService(typeof (ICurrentUserAndRole)) is ICurrentUserAndRole service && service.IsAdmin)
    {
      ...
      {
        views.Add("ColumnsAutoSettingsView", new ViewInfo(0, typeof (ColumnsAutoSettingsView)));
        return views;
      }
    }
