...
// Type: Intermech.Interfaces.TechCard.TechParams.TechCardParamsZagot
...
/// <summary>
/// Класс для хранения параметров TechCard для "Заготовки"
/// </summary>
[Serializable]
public class TechCardParamsZagot : AppSettingsBase
{
  /// <summary>
  /// 
  /// </summary>
