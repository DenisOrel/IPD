...
// Type: Intermech.Interfaces.TechCard.TechParams.TechCardParamsCehRoute
...
/// <summary>Класс для хранения параметров TechCard для "РМ"</summary>
[Serializable]
public class TechCardParamsCehRoute : AppSettingsBase
{
  /// <summary>
  /// 
  /// </summary>
