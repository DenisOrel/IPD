...
// Type: Intermech.AltiumDesigner.Interfaces.IVariation
...
public interface IVariation : 
  ...
  IDisposable
{
  /// <summary>Способ представления компонента в варианте</summary>
  int VariationKind { get; }

  string AlternatePart { get; }
