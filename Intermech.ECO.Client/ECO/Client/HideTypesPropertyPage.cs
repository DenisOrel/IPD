...
// Type: Intermech.ECO.Client.HideTypesPropertyPage
...
public class HideTypesPropertyPage : UserControl, IPropertyPage, IPropertyPageSearchOptionEvents
{
  ...
  public HideTypesPropertyPage() => this.InitializeComponent();
  ...
  public string PageName => LocalizationHolder.rm.GetString("ECO.Client_436");
  ...
  public void Apply()
  {
    ...
    foreach (ListViewItem listViewItem in this.View.Items)
      HideTypes.All.Add((int) listViewItem.Tag);
    using (SessionKeeper sessionKeeper = new SessionKeeper())
      HideTypes.All.Save(sessionKeeper.Session);
    this.Modified = false;
  }
  ...
  private void FillView()
  {
    ...
    foreach (int objTypeId in (HashSet<int>) HideTypes.All)
      this.AddItem(objTypeId);
  ...
  private ListViewItem AddItem(int objTypeId)
  {
    ListViewItem li = new ListViewItem();
    this.FillItem(li, objTypeId);
    this.View.Items.Add(li);
    li.Selected = true;
    return li;
  }

  private void FillItem(ListViewItem li, int objTypeId)
  {
    li.Text = MetaDataHelper.GetObjectTypeFullName(objTypeId);
    li.Tag = (object) objTypeId;
    li.ImageIndex = ECOPlugin.plugin.IconService.IndexOf(4, objTypeId);
  }
  ...
  private void ToolBar_ButtonClick(object sender, ToolBarButtonClickEventArgs e)
  {
    ...
    {
      SelectorForm selectorForm = new SelectorForm(typeof (ObjectTypesFolder), LocalizationHolder.rm.GetString("ECO.Client_438"), typeof (ObjectTypeFolder), true);
      ...
      {
        if (!this.View.Items.ContainsKey(MetaDataHelper.GetObjectTypeFullName(id)))
        {
          this.AddItem(id);
          flag = true;
        }
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (HideTypesPropertyPage));
    this.cmdsIL = new ImageList();
    ...
    this.panel5.Location = new Point(10, 36);
    this.panel5.Name = "panel5";
    this.panel5.Size = new Size(571, 322);
    ...
    this.View.Name = "View";
    this.View.Size = new Size(543, 318);
    ...
    this.ToolBar.Location = new Point(543, 0);
    this.ToolBar.Name = "ToolBar";
    this.ToolBar.ShowToolTips = true;
    this.ToolBar.Size = new Size(22, 318);
    ...
    this.label9.Location = new Point(565, 0);
    this.label9.Name = "label9";
    this.label9.Size = new Size(2, 318);
    this.label9.TabIndex = 7;
    this.label9.Text = "label9";
    this.CapLabel.Dock = DockStyle.Top;
    this.CapLabel.Location = new Point(10, 10);
    this.CapLabel.Name = "CapLabel";
    this.CapLabel.Padding = new Padding(0, 0, 0, 10);
    this.CapLabel.Size = new Size(571, 26);
    this.CapLabel.TabIndex = 5;
    this.CapLabel.Text = "При включении в извещение объекты следующих типов будут скрытыми:";
    ...
    this.Name = nameof (HideTypesPropertyPage);
    this.Padding = new Padding(10);
    this.Size = new Size(591, 368);
