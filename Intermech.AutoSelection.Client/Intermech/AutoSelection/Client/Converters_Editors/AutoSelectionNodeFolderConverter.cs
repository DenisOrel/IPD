...
// Type: Intermech.AutoSelection.Client.Converters_Editors.AutoSelectionNodeFolderConverter
...
internal class AutoSelectionNodeFolderConverter : TypeConverter
{
    ...
    Attribute[] attributes)
  {
    ...
    PropertyDescriptor objB = properties.Find("ExpTables", true);
    if (objB != null && value is AutoSelectionNodeFolder selectionNodeFolder)
    {
      ...
      for (int index = 0; index < properties.Count; ++index)
      {
        ...
        if (!object.Equals((object) objA, (object) objB) || selectionNodeFolder.FolderType == AutoSelectionFolderType.SelectFolder)
