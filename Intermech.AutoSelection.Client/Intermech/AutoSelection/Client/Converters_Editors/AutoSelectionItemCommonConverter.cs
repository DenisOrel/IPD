...
// Type: Intermech.AutoSelection.Client.Converters_Editors.AutoSelectionItemCommonConverter
...
internal class AutoSelectionItemCommonConverter : TypeConverter
{
    ...
    Attribute[] attributes)
  {
    ...
    PropertyDescriptor objB = properties.Find("RelTypeGuid", true);
    if (objB != null)
    {
      AutoSelectionNodeItemCommon selectionNodeItemCommon = (AutoSelectionNodeItemCommon) value;
      ...
      for (int index = 0; index < properties.Count; ++index)
      {
        ...
        if (!object.Equals((object) objA, (object) objB) || selectionNodeItemCommon.ObjTypeGuid.Value != Guid.Empty)
