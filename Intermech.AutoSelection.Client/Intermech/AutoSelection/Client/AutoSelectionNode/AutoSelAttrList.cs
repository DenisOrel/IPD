...
// Type: Intermech.AutoSelection.Client.AutoSelectionNode.AutoSelAttrList
...
public class AutoSelAttrList : List<AutoSelAttr>, IAutoSelAttrType, IImsGlobalsSupport
{
  public AutoSelAttrList(
  ...
  public virtual XmlNode Save(string nodeName, XmlDocument doc)
  {
    ...
    foreach (AutoSelAttr autoSelAttr in (List<AutoSelAttr>) this)
    {
  ...
  public virtual void Load(string nodeName, XmlNode node)
  {
    ...
    {
      AutoSelAttr autoSelAttr = AutoSelAttr.Load(childNode, (IAutoSelAttrType) this);
      if (autoSelAttr != null)
        this.Add(autoSelAttr);
    }
  }
  ...
  {
    return this.CollectAttrTypeGuids(type, collector);
  }
}
