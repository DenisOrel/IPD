...
// Type: Intermech.Interfaces.Document.MMConverter
...
public class MMConverter : FloatConverter
{
    ...
    Type destinationType)
  {
    ...
    return destinationType == typeof (string) && value is float num ? (object) (num.ToString() + LocalizationHolder.rm.GetString("Interfaces.Document_43")) : base.ConvertTo(context, culture, value, destinationType);
  }
    ...
    object value)
  {
    ...
    switch (str)
    {
      ...
      case "см":
        ...
        break;
      default:
        throw new ArgumentException(LocalizationHolder.rm.GetString("Interfaces.Document_41") + value);
    }
