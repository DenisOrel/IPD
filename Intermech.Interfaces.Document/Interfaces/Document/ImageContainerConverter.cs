...
// Type: Intermech.Interfaces.Document.ImageContainerConverter
...
public class ImageContainerConverter : LocalizedExpandableObjectConverter
{
    ...
    Type destinationType)
  {
    ...
    imageFormatConverter.ConvertTo((object) image.RawFormat, destinationType);
    object obj = imageFormatConverter.ConvertTo((object) image.RawFormat, destinationType);
    if (obj is string)
      str = (string) obj;
    return (object) str;
  }
