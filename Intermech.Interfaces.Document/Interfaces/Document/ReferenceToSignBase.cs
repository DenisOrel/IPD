...
// Type: Intermech.Interfaces.Document.ReferenceToSignBase
...
[Serializable]
public class ReferenceToSignBase : 
  ...
  ITextSource
{
  ...
  public new static string XmlTypeName = "RefToSign";
  protected string signField;
  ...
  public new static object EmptyConstructor() => (object) new ReferenceToSignBase();

  /// <summary>Создать пустой экземпляр класса с инициализацией только самых неоходимых полей.
  /// Используется в словаре конструкторов.</summary>
  public new static object EmptyConstructorActiveLink()
  {
    ReferenceToSignBase referenceToSignBase = new ReferenceToSignBase();
    referenceToSignBase.passiveLink = false;
    return (object) referenceToSignBase;
  }

  /// <summary>Коструктор</summary>
  public ReferenceToSignBase()
  {
  }
  ...
  public ReferenceToSignBase(DocumentTreeNode ownerNode, bool passiveLink)
  ...
  public ReferenceToSignBase(
    ...
    string attrName)
    : this(ownerNode, refType, dbObjectInfo, attrName, true)
  {
  }
  ...
  {
    this.AssignAttributeInfo(attrName);
  }
  ...
  public void AssignAttributeInfo(string attrName)
  {
    if (this.OwnerNode != null && this.attributeName != attrName)
  ...
  public override void CopyData(ReferenceBase src, bool copyText = true)
  {
    ...
    if (!(src is ReferenceToSignBase referenceToSignBase))
      return;
    this.attributeName = referenceToSignBase.attributeName;
    this.signField = referenceToSignBase.signField;
    if (!copyText)
      return;
    this.attributeValue = referenceToSignBase.attributeValue;
  }
  ...
  [Browsable(false)]
  public virtual bool IsReferenceToSign
  {
    [DebuggerStepThrough] get
    {
      return this.refType == RefToDBObjectType.rtUseSignFromDocument || this.refType == RefToDBObjectType.rtUseSignFromObject;
    }
  }
  ...
  public virtual string AttributeName
  {
    ...
    set
    {
      if (!(this.attributeName != value))
        return;
      if (this.OwnerNode != null && this.attributeName == null)
        this.OwnerNode.overrideFlags2 |= OverrideFlags2.Reference;
  ...
  [Browsable(false)]
  public override bool PassiveLink
  {
    get => false;
    set
    {
  ...
  /// <summary>Имя атрибута</summary>
  [CustomDisplayName("Attribute.Interfaces.Document_579")]
  [CustomDescription("Attribute.Interfaces.Document_580")]
  [CustomCategory("Attribute.Interfaces.Document_387")]
  [System.ComponentModel.ReadOnly(true)]
  public virtual string SignField
  {
    [DebuggerStepThrough] get => this.signField;
    set
    {
      if (!(this.signField != value))
        return;
      if (this.OwnerNode != null && this.signField == null)
        this.OwnerNode.overrideFlags2 |= OverrideFlags2.Reference;
    ...
    Type refInterface)
  {
    ...
    {
      case 0:
        this.refType = RefToDBObjectType.rtUseSignFromDocument;
        this.GetParentDBObjectInfo();
        break;
      case 1:
        this.refType = RefToDBObjectType.rtUseSignFromObject;
        ...
        break;
      case 2:
        this.refType = RefToDBObjectType.rtUseLinkFromDocumentObjectSign;
  ...
  public virtual List<string> GetSignFieldsList() => new List<string>();
  ...
  public override string[] GetReferenceSubTypes(DocumentTreeNode owner, Type refInterface)
  {
    ...
    return new string[3]
    {
      LocalizationHolder.rm.GetString("Interfaces.Document_191"),
      LocalizationHolder.rm.GetString("Interfaces.Document_192"),
      LocalizationHolder.rm.GetString("Interfaces.Document_195")
    };
  }
  ...
  public string Text
  {
    get => !this.CanShowReference() ? "" : this.attributeValue;
  ...
  public override bool ReadFieldFromXml(XmlReadArgs readArgs)
  {
    switch (readArgs.Reader.LocalName)
    {
      ...
      case "refType":
        ...
        return true;
      case "signField":
        this.signField = readArgs.Reader.Value;
        return true;
      default:
  ...
  public override void ReadFromXml(XmlReadArgs readArgs)
  {
    ...
    if (flag)
      return;
    LogManager.AddLine("ReferenceToSignBase.ReadFromXml End Element not found.");
  }
  ...
  protected override void WriteXmlAttributes(XmlWriter xw, ObjectIDGenerator objectRefId)
  {
    ...
    if (this.signField == null || !(this.signField != ""))
      return;
    xw.WriteAttributeString("signField", this.signField);
  }
  ...
  protected override string BaseTypeNameForXml => ReferenceToSignBase.XmlTypeName;

  /// <summary>Имя типа сохраняемое в XML</summary>
  public override string TypeNameForXml => ReferenceToSignBase.XmlTypeName;
}
