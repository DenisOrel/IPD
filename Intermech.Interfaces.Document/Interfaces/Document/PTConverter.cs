...
// Type: Intermech.Interfaces.Document.PTConverter
...
public class PTConverter : FloatConverter
{
    ...
    Type destinationType)
  {
    ...
    return destinationType == typeof (string) && value is float num ? (object) (num.ToString() + LocalizationHolder.rm.GetString("Interfaces.Document_52")) : base.ConvertTo(context, culture, value, destinationType);
  }
    ...
    object value)
  {
    ...
    switch (str)
    {
      ...
      case "см":
        ...
        break;
      default:
        throw new ArgumentException(LocalizationHolder.rm.GetString("Interfaces.Document_57") + value);
    }
    return (object) (float) (0.25 * (double) (int) Math.Round(number * num / 0.25));
  }
}
