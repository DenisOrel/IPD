...
// Type: Intermech.Hashes.Checksum.CRC32
...
internal class CRC32 : Hash, IChecksum, IBlockHash, IHash, IHash32, ITransformBlock
{
  ...
  public CRC32(
    ...
    : base(4, 1)
  {
    this.CRCAlgorithm = (ICRC) new CRC(32 /*0x20*/, _poly, _Init, _refIn, _refOut, _XorOut, _check, _Names);
  }
