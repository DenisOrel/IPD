...
// Type: Intermech.Hashes.Hash32.Bernstein
...
internal sealed class Bernstein : Hash, IHash32, IHash, ITransformBlock
{
  private uint hash;
  ...
  public override IHash Clone()
  {
    ...
    bernstein.hash = this.hash;
    bernstein.BufferSize = this.BufferSize;
    return (IHash) bernstein;
  }
