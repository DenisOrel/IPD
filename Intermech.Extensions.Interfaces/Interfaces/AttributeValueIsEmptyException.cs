...
// Type: Intermech.Interfaces.AttributeValueIsEmptyException
...
[Serializable]
public class AttributeValueIsEmptyException : ValueEmptyException, ISerializable
{
  ...
  public AttributeValueIsEmptyException(
  ...
  public AttributeValueIsEmptyException([NotEmpty] int attributeID, [NotEmpty] long entityID, [CanBeNull] string message = null)
  ...
  protected AttributeValueIsEmptyException([NotNull] SerializationInfo info, StreamingContext context)
    : base(info, context)
  {
  ...
  public override string Message
  {
    get
    {
      ...
      return !string.IsNullOrWhiteSpace(this.ValueName) ? $"Атрибут {this.ValueName} с ID={this.AttributeID} пуст." : $"Атрибут с ID={this.AttributeID} пуст.";
    }
  }
}
