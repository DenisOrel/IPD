...
// Type: Intermech.AVS.SetupKeyWordsView
...
[ViewDescriptionProvider(typeof (SetupKeyWordsView.CustomViewDescriptionProvider))]
internal class SetupKeyWordsView : UserControl, IView
{
  private FormSetupKeyWords _form;
  ...
  private string _viewName = "Ключевые слова";

  public SetupKeyWordsView()
  {
  ...
  public void Activate(IView previousView)
  {
    ...
    this._form = new FormSetupKeyWords((SettingsStructure) null, this._selectedID, this._documentTemplateId);
  ...
  {
    this.SuspendLayout();
    this.Name = nameof (SetupKeyWordsView);
