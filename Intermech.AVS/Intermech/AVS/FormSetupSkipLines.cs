...
// Type: Intermech.AVS.FormSetupSkipLines
...
/// <summary> Описание класса FormSetupSkipLines </summary>
public class FormSetupSkipLines : ExtForm
{
  private IContainer components;
  private Button _BtnOK;
  private Button _BtnCancel;
  private ToolTipController _EditModeToolTip;
  private UserControlSetupSkipLines _userControlSetupSkipLines;
  ...
  public FormSetupSkipLines()
  {
    this.InitializeComponent();
    HelpProvidersClass.SetHelpOptionForControl((Control) this, 1523);
  }

  public FormSetupSkipLines(SettingsStructure settingsStructure, long settingsHolderObjID)
  {
    this.InitializeComponent();
    HelpProvidersClass.SetHelpOptionForControl((Control) this, 1523);
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (FormSetupSkipLines));
    ...
    this._userControlSetupSkipLines = new UserControlSetupSkipLines();
    ...
    this._BtnOK.Location = new Point(393, 456);
    ...
    this._BtnCancel.Location = new Point(520, 456);
    ...
    this._userControlSetupSkipLines.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
    this._userControlSetupSkipLines.Location = new Point(-1, 83);
    this._userControlSetupSkipLines.MinimumSize = new Size(615, 365);
    this._userControlSetupSkipLines.Name = "_userControlSetupSkipLines";
    this._userControlSetupSkipLines.RootSkipLinesSchema = (SkipLinesSchema) null;
    this._userControlSetupSkipLines.Size = new Size(639, 400);
    this._userControlSetupSkipLines.SkipLinesSchema = (SkipLinesSchema) null;
    this._userControlSetupSkipLines.TabIndex = 0;
    this._userControlSetupSkipLines.OnChangedEvent += new EventHandler(this._userControlSetupSkipLines_OnChangedEvent);
    ...
    this.treeList1.Size = new Size(625, 62);
    ...
    this.ClientSize = new Size(650, 495);
    this.Controls.Add((Control) this.treeList1);
    this.Controls.Add((Control) this._BtnCancel);
    this.Controls.Add((Control) this._BtnOK);
    this.Controls.Add((Control) this._userControlSetupSkipLines);
    this.FormBorderStyle = FormBorderStyle.FixedDialog;
    this.HelpButton = true;
    this.MaximizeBox = false;
    this.MinimizeBox = false;
    this.MinimumSize = new Size(642, 445);
    this.Name = nameof (FormSetupSkipLines);
    this.ShowInTaskbar = false;
    this.SizeGripStyle = SizeGripStyle.Hide;
    this.Text = "Настройка пропуска строк";
    this.Closed += new EventHandler(this.FormSetupSkipLines_Closed);
    this.FormClosing += new FormClosingEventHandler(this.FormSetupSkipLines_FormClosing);
    this.Load += new EventHandler(this.FormSetupSkipLines_Load);
  ...
  protected override bool GetIsReadOnly() => this._userControlSetupSkipLines.GetIsReadOnly();
  ...
  protected override bool BeforeObjectEditBegin(ref bool wasUpdated)
  {
    ...
    if (focusedNode == null || focusedNode.Tag == null)
      return false;
    SettingsLevel level = this._userControlSetupSkipLines.SkipLinesSchema.Level;
    FormSetupSkipLines.SettingsLevelNodeConnector levelNodeConnector = (FormSetupSkipLines.SettingsLevelNodeConnector) focusedNode.GetValue((object) 0);
    if (levelNodeConnector == null)
      return false;
    using (SessionKeeper sessionKeeper = new SessionKeeper())
    {
      IDBObject dbObject1 = sessionKeeper.Session.GetObject(this._userControlSetupSkipLines.SkipLinesSchema.OwnerObjectID);
      if (dbObject1 == null || (dbObject1.GetAttributeByID(AvsIDCache.Attr_SkipLines) ?? dbObject1.Attributes.AddAttribute(AvsIDCache.Attr_SkipLines, true)) == null)
        return false;
      ...
      switch (dbObject1.ObjectModifyMode)
      {
        ...
        case ObjectModifyModes.Checkout:
          ...
          if (dbObject2 == null || dbObject2.CheckoutBy != sessionKeeper.Session.UserID)
            return false;
          this._userControlSetupSkipLines.SkipLinesSchema.OwnerObjectID = dbObject2.ObjectID;
          wasUpdated = true;
          this.InitSelectedLevel();
  ...
  /// <param name="e"></param>
  private void FormSetupSkipLines_Load(object sender, EventArgs e)
  {
    ...
    try
    {
      ...
      foreach (SettingsLevel allLevel in this.settingsStructure.AllLevels)
      {
        ...
        {
          SkipLinesSchema schemaByLevel = this._skipLinesSchema != null ? this._skipLinesSchema.GetSchemaByLevel(allLevel) : (SkipLinesSchema) null;
          if (schemaByLevel != null)
          {
            ...
            FormSetupSkipLines.SettingsLevelNodeConnector levelNodeConnector = new FormSetupSkipLines.SettingsLevelNodeConnector(allLevel, node2, this._settingsHolderObjType);
    ...
    if (num1 >= 2)
    {
      ...
      if (num2 != this.treeList1.Height)
      {
        ...
        UserControlSetupSkipLines controlSetupSkipLines = this._userControlSetupSkipLines;
        Point location = this._userControlSetupSkipLines.Location;
        int x = location.X;
        location = this._userControlSetupSkipLines.Location;
        int y = location.Y - num3;
        Point point = new Point(x, y);
        controlSetupSkipLines.Location = point;
        this._userControlSetupSkipLines.Height += num3;
      }
    ...
    else if (this.treeList1.Visible)
    {
      ...
      this._userControlSetupSkipLines.Location = new Point(this._userControlSetupSkipLines.Location.X, this._userControlSetupSkipLines.Location.Y - num4);
      this._userControlSetupSkipLines.Height += num4;
      Size size = this.Size;
  ...
  /// <param name="sender"></param>
  /// <param name="e"></param>
  private void FormSetupSkipLines_Closed(object sender, EventArgs e)
  {
  }
  ...
  public void InitSkipLinesSchema()
  {
    this.LockControls();
    try
    {
      this._skipLinesSchema = this.LoadSkipLinesSchema();
      this._userControlSetupSkipLines.RootSkipLinesSchema = this._skipLinesSchema;
      this._userControlSetupSkipLines.SkipLinesSchema = this._skipLinesSchema;
      this.Changed = false;
  ...
  public SkipLinesSchema LoadSkipLinesSchema()
  {
    ...
    using (SessionKeeper sessionKeeper = new SessionKeeper())
      return (SkipLinesSchema) this.settingsStructure.CreateSettingsLevelFromObject(sessionKeeper.Session, this._settingsHolderObjID, this._settingsHolderObjType, this._templateObjectID, AvsIDCache.Attr_SkipLines, typeof (SkipLinesSchema));
  }
  ...
  public void InitSelectedLevel()
  {
    ...
    try
    {
      this._userControlSetupSkipLines.SkipLinesSchema.LoadParams();
      this._userControlSetupSkipLines.Changed = false;
      this._userControlSetupSkipLines.RefreshReadOnly();
      this._userControlSetupSkipLines.UpdateControls(true);
      TreeListNode focusedNode = this.treeList1.FocusedNode;
      if (focusedNode == null || !this._userControlSetupSkipLines.ReadOnly)
        return;
  ...
  public void AutoCheckInAll()
  {
    if (!this._needToAutoCheckIn)
      return;
    foreach (FormSetupSkipLines.SettingsLevelNodeConnector key in (IEnumerable) this._settingLevelToTreeNode.Keys)
    {
      if (key.NeedToAutoCheckIn)
      {
        SkipLinesSchema schemaByLevel = this._skipLinesSchema.GetSchemaByLevel(key.Level);
        if (schemaByLevel != null)
        {
          using (SessionKeeper sessionKeeper = new SessionKeeper())
          {
          ...
          if (schemaByLevel != null)
          {
            ...
            using (SessionKeeper sessionKeeper = new SessionKeeper())
            {
              ...
              if (AVSPlugin.NotificationService != null)
                AVSPlugin.NotificationService.FireEvent((object) this, (NotificationEventArgs) new DBObjectsExtendedEventArgs(dbObject.ObjectID, dbObject.ObjectType, new AttributeValues(AvsIDCache.Attr_SkipLines, (object) null), new AttributeValues(AvsIDCache.Attr_SkipLines, (object) null)));
            }
          }
        }
      }
  ...
  {
    if (e.Node == null || !this._loaded || this._skipLinesSchema == null)
      return;
    object obj = e.Node.GetValue((object) 0);
    if (obj == null || !(obj is FormSetupSkipLines.SettingsLevelNodeConnector))
      return;
    SkipLinesSchema schemaByLevel = this._skipLinesSchema.GetSchemaByLevel(((FormSetupSkipLines.SettingsLevelNodeConnector) obj).Level);
    if (schemaByLevel == null)
      return;
    this.LockControls();
    try
    {
      this._userControlSetupSkipLines.SkipLinesSchema = schemaByLevel;
      this.UpdateControls(true);
    }
    finally
    {
  ...
  private void _userControlSetupSkipLines_OnChangedEvent(object sender, EventArgs e)
  {
    if (this._skipLinesSchema == null)
      return;
    TreeListNode focusedNode = this.treeList1.FocusedNode;
  ...
  private void FormSetupSkipLines_FormClosing(object sender, FormClosingEventArgs e)
  {
    ...
    e.Cancel = true;
    this.InitSkipLinesSchema();
    this.FormSetupSkipLines_Load((object) null, EventArgs.Empty);
  }
  ...
  public override int CancelButtonRightEdge
  {
    get
    {
      return this._userControlSetupSkipLines.CancelButtonRightEdge > 0 ? this._userControlSetupSkipLines.CancelButtonRightEdge + 1 : this.Size.Width - (this._BtnCancel.Location.X + this._BtnCancel.Size.Width);
    }
  }
