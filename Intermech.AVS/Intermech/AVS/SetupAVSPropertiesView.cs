...
// Type: Intermech.AVS.SetupAVSPropertiesView
...
[ViewDescriptionProvider(typeof (SetupAVSPropertiesView.CustomViewDescriptionProvider))]
internal class SetupAVSPropertiesView : UserControl, IView
{
  private FormAVSCommonProperties _form;
  ...
  private int _viewIndex = 100;
  /// <summary>Название вьюшки</summary>
  private string _viewName = "Общие настройки AVS";

  public SetupAVSPropertiesView()
  {
  ...
  public void Activate(IView previousView)
  {
    ...
    this._form = new FormAVSCommonProperties((SettingsStructure) null, this._selectedID, this._selectedObjectTypeID, this._documentTemplateId);
  ...
  {
    this.SuspendLayout();
    this.Name = nameof (SetupAVSPropertiesView);
