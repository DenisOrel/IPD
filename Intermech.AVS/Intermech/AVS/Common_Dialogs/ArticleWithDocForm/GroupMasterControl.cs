...
// Type: Intermech.AVS.Common_Dialogs.ArticleWithDocForm.GroupMasterControl
...
internal class GroupMasterControl : PageUserControl
{
  /// <summary>Текущий индекс в списке связей</summary>
  private int _index;
  /// <summary>Текущие значения связей с исполнениями</summary>
  private List<GroupMasterControl.RelationCounts> _quantities;
    ...
    List<AVSRow> selectedSpecRows)
  {
    ...
    using (SessionKeeper sessionKeeper = new SessionKeeper())
    {
      ...
      {
        this._quantities = new List<GroupMasterControl.RelationCounts>(this.selectedSpecRow.avsDocument.productsInfo.Count);
        for (int index1 = 0; index1 < this.selectedSpecRow.avsDocument.productsInfo.Count; ++index1)
        {
          ...
          GroupMasterControl.RelationCounts relationCounts = new GroupMasterControl.RelationCounts();
          ...
          if (dbRelation != null)
          {
            ...
            if (attributeById != null && CompareValuesHelper.NormalizedValue(attributeById.Value) != null)
      ...
      {
        this._quantities = new List<GroupMasterControl.RelationCounts>(relations.Count);
    ...
    try
    {
      for (int index = 0; index < this._attrProcessors.Count; ++index)
      {
        if (this.selectedSpecRow == null && this._quantities[index] != null && this._quantities[index].RelationID != -1L && this._quantities[index].Count == null)
        {
          using (SessionKeeper sessionKeeper = new SessionKeeper())
          {
            IDBRelation relation = sessionKeeper.Session.GetRelation(this._quantities[index].RelationID);
            if (relation != null)
            {
              relation.Delete(0L);
              pair.RelationIDs.Remove(this._quantities[index].RelationID);
            }
          }
        }
        ...
        else if (this._quantities[index] != null && this._quantities[index].RelationID != -1L)
        {
          ...
          try
          {
            if (this.selectedSpecRow == null && this._attrProcessors[index].FindAttributeValues(FormHelper.AttributeCountID) == null)
            {
            ...
            {
              AttributeValues attributeValues = AttributeProcessor.CreateAttributeValues(AvsIDCache.Attr_Podbor, relationId, this.attributableElement);
              this._attrProcessors[index].ActualAttributeValues.Add(attributeValues);
            }
  ...
  protected override void OnReload(IUserSession session, OpenModes mode)
  {
    ...
    if (this.FormType == FormType.GroupB)
    {
      ...
      ComboBox cbFormat = this.cbFormat;
      cbFormat.Location = cbFormat.Location + new Size(0, height);
    ...
    if (this._attrProcessors != null && this._attrProcessors.Count > 0)
    {
      ...
      if (this.selectedSpecRow != null)
      {
        if (this.selectedSpecRow.avsDocument.productsInfo != null && this.selectedSpecRow.avsDocument.productsInfo.Count > 0)
        {
          ...
          this.tbPosDesignation.Text = this.selectedSpecRow.GetFieldStringValue(this.selectedSpecRow.Field_PosDesignation, relationIndexForProduct, -1, (List<RelationAttributeValuesCache>) null, true);
          this.cbFormat.Text = this.selectedSpecRow.GetFieldStringValue(this.selectedSpecRow.Field_Format, relationIndexForProduct, -1, (List<RelationAttributeValuesCache>) null, false);
      ...
      else if (attrProcessor.Id != -1L && attrProcessor.Loaded)
      {
        ...
        if (attrProcessor.FindAttributeValues(AvsIDCache.Attr_Format) != null)
          this.cbFormat.Text = Convert.ToString(attrProcessor.GetValue(AvsIDCache.Attr_Format));
  ...
  private void UpdateControlsState() => this.tbPosDesignation.ReadOnly = false;
  ...
  private void InitializeComponent()
  {
    ...
    this.bEditName.Location = new Point(752, 97);
    ...
    this.bEditDesignation.Location = new Point(752, 70);
    ...
    this.tbName.Location = new Point(142, 98);
    this.tbName.Name = "tbName";
    this.tbName.Size = new Size(610, 20);
    ...
    this.panel2.Location = new Point(3, 333);
    this.panel2.Margin = new Padding(0);
    this.panel2.Name = "panel2";
    this.panel2.Size = new Size(794, 80 /*0x50*/);
    ...
    this.treeList1.Location = new Point(347, 192 /*0xC0*/);
    this.treeList1.MenuOptions = MenuOptionsFlags.None;
    this.treeList1.Name = "treeList1";
    this.treeList1.Size = new Size(429, 137);
    ...
    this.treeListColumn1.Options = ColumnOptions.CanMoved | ColumnOptions.CanResized | ColumnOptions.CanSorted | ColumnOptions.ReadOnly | ColumnOptions.CanFocused | ColumnOptions.ShowInCustomizationForm | ColumnOptions.CanMovedToCustomizationForm;
    ...
    this.bEditCount.Location = new Point(220, 244);
    ...
    this.label3.Location = new Point(25, 249);
    ...
    this.tbCount.Location = new Point(142, 245);
    this.tbCount.Name = "tbCount";
    this.tbCount.Size = new Size(78, 20);
    ...
    this.cbFormat.Location = new Point(142, 272);
    this.cbFormat.Name = "cbFormat";
    this.cbFormat.Size = new Size(102, 21);
    ...
    this.tbSmotri.Location = new Point(142, 163);
    this.tbSmotri.Name = "tbSmotri";
    this.tbSmotri.Size = new Size(634, 20);
    ...
    this.label9.Location = new Point(25, 140);
    ...
    this.tbOKPCode.Location = new Point(142, 137);
    this.tbOKPCode.Name = "tbOKPCode";
    this.tbOKPCode.Size = new Size(634, 20);
    ...
    this.cbPodbor.Location = new Point(142, 247);
    ...
    this.Name = nameof (GroupMasterControl);
    this.Padding = new Padding(3);
    this.Size = new Size(800, 416);
