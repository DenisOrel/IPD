...
// Type: Intermech.AVS.Victor.VyborRazdela
...
public class VyborRazdela : Form
{
  ...
  public VyborRazdela() => this.InitializeComponent();

  private void VyborRazdela_Load(object sender, EventArgs e) => this.ListZagolovkov_draw();
  ...
  private void ListZagolovkov_draw()
  {
    for (int index = 0; index < this._one_Ved_Nastr._list_RazdelsVed.Count; ++index)
      this.ListZagolovkov.Items.Add((object) this._one_Ved_Nastr._list_RazdelsVed[index]._name);
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (VyborRazdela));
    ...
    this.GroupBoxListZagolovkov.TabIndex = 4;
    this.GroupBoxListZagolovkov.TabStop = false;
    this.GroupBoxListZagolovkov.Text = "Разделы";
    ...
    this.Name = nameof (VyborRazdela);
    this.StartPosition = FormStartPosition.CenterParent;
    this.Text = "Выбор раздела";
    this.Load += new EventHandler(this.VyborRazdela_Load);
