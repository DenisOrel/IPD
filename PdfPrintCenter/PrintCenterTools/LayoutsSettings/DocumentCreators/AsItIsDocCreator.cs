...
// Type: Intermech.PdfPrintCenter.PrintCenterTools.LayoutsSettings.DocumentCreators.AsItIsDocCreator
...
{
    internal class AsItIsDocCreator(LayoutAsItIs layoutAsItIs) : DocCreator((IPdfPageProducer) layoutAsItIs)
    {
