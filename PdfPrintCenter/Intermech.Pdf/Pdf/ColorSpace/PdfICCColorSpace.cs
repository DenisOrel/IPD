...
// Type: Syncfusion.Pdf.ColorSpace.PdfICCColorSpace
...
public class PdfICCColorSpace : PdfColorSpaces, IPdfWrapper
{
  ...
  private PdfArray CreateInternals()
  {
    ...
    if (internals != null)
    {
      PdfName element1 = new PdfName("ICCBased");
      internals.Add((IPdfPrimitive) element1);
      PdfReferenceHolder element2 = new PdfReferenceHolder((IPdfPrimitive) this.m_stream);
      this.m_stream.SetProperty("N", (IPdfPrimitive) new PdfNumber((int) this.m_colorcomponents));
      if (this.m_alterantecolorspaces != null)
      {
        if (this.m_alterantecolorspaces is PdfDeviceColorSpace)
        {
          string str1 = (this.m_alterantecolorspaces as PdfDeviceColorSpace).DeviceColorSpaceType.ToString();
          string str2 = "DeviceRGB";
          switch (str1)
          {
            case "RGB":
              str2 = "DeviceRGB";
          ...
          this.m_stream.SetProperty("Alternate", (IPdfPrimitive) new PdfName(str2));
        }
        else
          this.m_stream.SetProperty("Alternate", (IPdfPrimitive) new PdfReferenceHolder((IPdfWrapper) this.m_alterantecolorspaces));
      }
      else
        this.m_stream.SetProperty("Alternate", (IPdfPrimitive) new PdfName("DeviceRGB"));
      if (this.m_range != null)
        this.m_stream.SetProperty("Range", (IPdfPrimitive) new PdfArray(this.m_range));
  ...
  protected void Save()
  {
    byte[] buffer = this.m_profileData != null ? this.m_profileData : this.GetProfileData();
    this.m_stream.Clear();
  ...
  public PdfColorSpaces AlternateColorSpace
  {
  ...
  {
    get => this.m_colorcomponents;
    set
    {
      this.m_colorcomponents = value;
      this.Initialize();
    }
  }
  ...
  {
    get => this.m_profileData;
    set
    {
      this.m_profileData = value;
      this.Save();
    }
  }
