...
internal sealed class Deflate
{
  ...
  internal short[] bl_tree = new short[78];
  ...
  internal short[] dyn_dtree = new short[122];
  internal short[] dyn_ltree = new short[1146];
  ...
  internal bool _tr_tally(int dist, int lc)
  {
    ...
    if (dist == 0)
    {
      this.dyn_ltree[lc * 2] = (short) ((int) this.dyn_ltree[lc * 2] + 1);
    }
    else
    {
      ++this.matches;
      --dist;
      this.dyn_ltree[((int) Tree._length_code[lc] + 256 /*0x0100*/ + 1) * 2] = (short) ((int) this.dyn_ltree[((int) Tree._length_code[lc] + 256 /*0x0100*/ + 1) * 2] + 1);
      this.dyn_dtree[Tree.d_code(dist) * 2] = (short) ((int) this.dyn_dtree[Tree.d_code(dist) * 2] + 1);
    }
    if ((this.last_lit & 8191 /*0x1FFF*/) == 0 && this.level > 2)
    {
      ...
      for (int index = 0; index < 30; ++index)
        number += (int) ((long) this.dyn_dtree[index * 2] * (5L + (long) Tree.extra_dbits[index]));
  ...
  internal void scan_tree(short[] tree, int max_code)
  {
    ...
    for (int index = 0; index <= max_code; ++index)
    {
      ...
      if (++num3 >= num4 || num6 != num2)
      {
        ...
        {
          if (num6 != num1)
            this.bl_tree[num6 * 2] = (short) ((int) this.bl_tree[num6 * 2] + 1);
          this.bl_tree[32 /*0x20*/] = (short) ((int) this.bl_tree[32 /*0x20*/] + 1);
        }
        else if (num3 <= 10)
          this.bl_tree[34] = (short) ((int) this.bl_tree[34] + 1);
        else
          this.bl_tree[36] = (short) ((int) this.bl_tree[36] + 1);
        num3 = 0;
        num1 = num6;
        if (num2 == 0)
        {
