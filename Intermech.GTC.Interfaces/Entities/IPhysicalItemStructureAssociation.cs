...
// Type: Intermech.GTC.Interfaces.Entities.IPhysicalItemStructureAssociation
...
public interface IPhysicalItemStructureAssociation : IBaseObject
{
  IPhysicalItemDefinition Related { get; }

  IPhysicalItemDefinition Relating { get; }
}
