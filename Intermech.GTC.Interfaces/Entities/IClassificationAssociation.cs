...
// Type: Intermech.GTC.Interfaces.Entities.IClassificationAssociation
...
public interface IClassificationAssociation : IBaseObject
{
  IGeneralClassification AssociatedClassification { get; }

  string Definitional { get; }

  string Role { get; }

  IBaseObject ClassifiedElement { get; }
}
