...
// Type: Intermech.GTC.Interfaces.Entities.INumericalValue
...
public interface INumericalValue : IPropertyValue, IBaseObject
{
  string SignificantDigits { get; }

  double ValueComponent { get; }

  IUnit UnitComponent { get; }
}
