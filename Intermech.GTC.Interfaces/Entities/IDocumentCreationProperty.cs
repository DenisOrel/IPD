...
// Type: Intermech.GTC.Interfaces.Entities.IDocumentCreationProperty
...
public interface IDocumentCreationProperty : IBaseObject
{
  string CreatingInterface { get; }

  string CreatingSystem { get; }
