...
// Type: Intermech.GTC.Interfaces.Entities.IItemCharacteristicAssociation
...
public interface IItemCharacteristicAssociation : IBaseObject
{
  string RelationType { get; }

  IItemDefinition AssociatedItem { get; }

  IGrade AssociatedCharacteristic { get; }
}
