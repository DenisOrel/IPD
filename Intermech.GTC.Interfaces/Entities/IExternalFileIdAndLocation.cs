...
// Type: Intermech.GTC.Interfaces.Entities.IExternalFileIdAndLocation
...
public interface IExternalFileIdAndLocation : IBaseObject
{
  string ExternalId { get; }

  IDocumentLocationProperty Location { get; }
}
