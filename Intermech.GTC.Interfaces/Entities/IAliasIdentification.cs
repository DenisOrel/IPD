...
// Type: Intermech.GTC.Interfaces.Entities.IAliasIdentification
...
public interface IAliasIdentification : IBaseObject
{
  string AliasId { get; }

  string AliasVersionId { get; }

  IMultiLanguageString Description { get; }

  IOrganization AliasScope { get; }
