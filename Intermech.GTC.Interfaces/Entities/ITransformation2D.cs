...
// Type: Intermech.GTC.Interfaces.Entities.ITransformation2D
...
public interface ITransformation2D : IBaseObject
{
  ICartesianPoint LocalOrigin { get; }

  IDirection Axis1 { get; }
}
