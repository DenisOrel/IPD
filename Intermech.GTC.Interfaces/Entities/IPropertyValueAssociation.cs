...
// Type: Intermech.GTC.Interfaces.Entities.IPropertyValueAssociation
...
public interface IPropertyValueAssociation : IBaseObject
{
  IPropertyValueRepresentation DescribingPropertyValue { get; }

  IItemDefinition DescribedElement { get; }
}
