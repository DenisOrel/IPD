...
// Type: Intermech.GTC.Interfaces.Entities.IPhysicalItemDefinition
...
public interface IPhysicalItemDefinition : IBaseObject
{
  string Id { get; }

  string Name { get; }

  IPhysicalItemVersion AssociatedItemVersion { get; }
}
