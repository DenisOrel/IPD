...
// Type: Intermech.GTC.Interfaces.Entities.IAssemblyAssociation
...
public interface IAssemblyAssociation : IBaseObject
{
  IItemInstance Related { get; }

  IAssemblyDefinition Relating { get; }

  IGeometricModelRelationshipWithTransformation Placement { get; }
}
