...
// Type: Intermech.GTC.Interfaces.Entities.IPropertyValueRepresentation
...
public interface IPropertyValueRepresentation : IBaseObject
{
  IProperty Definition { get; }

  IPropertyValue SpecifiedValue { get; }
}
