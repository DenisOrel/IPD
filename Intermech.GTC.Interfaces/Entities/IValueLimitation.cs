...
// Type: Intermech.GTC.Interfaces.Entities.IValueLimitation
...
public interface IValueLimitation : IBaseObject
{
  string Envelope { get; }

  INumericalValue LimitedValue { get; }

  IBaseObject IsDefinedBy { get; }
}
