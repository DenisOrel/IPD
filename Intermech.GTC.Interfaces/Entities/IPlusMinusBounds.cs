...
// Type: Intermech.GTC.Interfaces.Entities.IPlusMinusBounds
...
public interface IPlusMinusBounds : IBaseObject
{
  string LowerBound { get; }

  string SignificationDigit { get; }

  string UpperBound { get; }

  string ValueDetermination { get; }
}
