...
// Type: Intermech.GTC.Interfaces.Entities.IDocumentAssignment
...
public interface IDocumentAssignment : IBaseObject
{
  string Role { get; }

  IItemDefinition IsAssignedTo { get; }

  IDocumentVersion AssignedDocument { get; }
}
