...
// Type: Intermech.GTC.Interfaces.Entities.IPropertyValueRepresentationRelationship
...
public interface IPropertyValueRepresentationRelationship : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IPropertyValueRepresentation Relating { get; }

  IPropertyValueRepresentation Related { get; }
}
