...
// Type: Intermech.GTC.Interfaces.Entities.IExternalGeometricModel
...
public interface IExternalGeometricModel : IBaseObject
{
  string Description { get; }

  string ModelId { get; }

  string ModelExtent { get; }

  IDigitalFile IsDefinedAs { get; }

  ICartesianCoordinateSpace3D IsDefinedIn { get; }
}
