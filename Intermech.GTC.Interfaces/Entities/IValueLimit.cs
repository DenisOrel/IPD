...
// Type: Intermech.GTC.Interfaces.Entities.IValueLimit
...
public interface IValueLimit : IPropertyValue, IBaseObject
{
  string SignificantDigit { get; }

  string Limit { get; }

  string LimitQualifier { get; }
