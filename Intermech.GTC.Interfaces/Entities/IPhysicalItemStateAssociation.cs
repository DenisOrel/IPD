...
// Type: Intermech.GTC.Interfaces.Entities.IPhysicalItemStateAssociation
...
public interface IPhysicalItemStateAssociation : IBaseObject
{
  string Role { get; }

  IPhysicalItemDefinition AssociatedPhysicalItem { get; }

  IState AssociatedState { get; }
}
