...
// Type: Intermech.GTC.Interfaces.Entities.IItemDefinitionRelationship
...
public interface IItemDefinitionRelationship : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IItemDefinition Relating { get; }

  IItemDefinition Related { get; }
}
