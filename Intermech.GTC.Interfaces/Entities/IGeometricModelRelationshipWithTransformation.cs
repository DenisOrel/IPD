...
// Type: Intermech.GTC.Interfaces.Entities.IGeometricModelRelationshipWithTransformation
...
public interface IGeometricModelRelationshipWithTransformation : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IBaseObject ModelPlacement { get; }

  IBaseObject Relating { get; }

  IBaseObject Related { get; }
}
