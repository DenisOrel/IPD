...
// Type: Intermech.GTC.Interfaces.Entities.ISpecificItemClassification
...
public interface ISpecificItemClassification : IBaseObject
{
  string ClassificationName { get; }

  string Description { get; }

  IBaseObject[] AssociatedItem { get; }
}
