...
// Type: Intermech.GTC.Interfaces.Entities.IMatedItemRelationship
...
public interface IMatedItemRelationship : IBaseObject
{
  IItemInstance[] MatingMaterial { get; }

  IMatingAssociation Relating { get; }

  IMatingAssociation Related { get; }
}
