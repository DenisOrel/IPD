...
// Type: Intermech.GTC.Interfaces.Entities.IEffectivityRelationship
...
public interface IEffectivityRelationship : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IEffectivity Relating { get; }

  IEffectivity Related { get; }
}
