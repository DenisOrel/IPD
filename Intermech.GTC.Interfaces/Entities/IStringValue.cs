...
// Type: Intermech.GTC.Interfaces.Entities.IStringValue
...
public interface IStringValue : IPropertyValue, IBaseObject
{
  IMultiLanguageString ValueSpecification { get; }
}
