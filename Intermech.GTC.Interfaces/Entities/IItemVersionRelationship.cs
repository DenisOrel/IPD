...
// Type: Intermech.GTC.Interfaces.Entities.IItemVersionRelationship
...
public interface IItemVersionRelationship : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IItemVersion Relating { get; }

  IItemVersion Related { get; }
}
