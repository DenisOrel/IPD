...
// Type: Intermech.GTC.Interfaces.Entities.IDigitalFile
...
public interface IDigitalFile : IBaseObject
{
  string FileId { get; }

  string VersionId { get; }

  IExternalFileIdAndLocation[] ExternalIdAndLocation { get; }

  IDocumentFormatProperty FileFormat { get; }
