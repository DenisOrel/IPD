...
// Type: Intermech.GTC.Interfaces.Entities.IPropertyRelationship
...
public interface IPropertyRelationship : IBaseObject
{
  string Description { get; }

  string RelationType { get; }

  IProperty Relating { get; }

  IProperty Related { get; }
}
