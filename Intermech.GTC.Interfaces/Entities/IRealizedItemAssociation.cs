...
// Type: Intermech.GTC.Interfaces.Entities.IRealizedItemAssociation
...
public interface IRealizedItemAssociation : IBaseObject
{
  IItemVersion RealizedItemVersion { get; }

  IPhysicalItem PhysicalItem { get; }
}
