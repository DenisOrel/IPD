...
// Type: GridViewExtensions.GridFilterFactories.FullTextSearchGridFilterFactory
...
public class FullTextSearchGridFilterFactory : IGridFilterFactory
{
  private TextBox _textBox;

  public FullTextSearchGridFilterFactory(TextBox textBox) => this._textBox = textBox;
  ...
  {
    IGridFilter gridFilter = (IGridFilter) new TextGridFilter(this._textBox);
