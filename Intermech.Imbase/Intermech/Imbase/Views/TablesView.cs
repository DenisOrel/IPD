...
// Type: Intermech.Imbase.Views.TablesView
...
public class TablesView : ObjectsViewBase
{
  public override ContentType ViewContentType => ContentType.NonFolders;

  private void InitializeComponent()
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (TablesView));
