...
// Type: Intermech.Imbase.Views.CatalogsView
...
public class CatalogsView : ObjectsViewBase
{
  ...
  public override int ImageIndex
  {
    get
    {
      if (CatalogsView._imageIndex == -1 && ChildrenView._namedImageList != null)
        CatalogsView._imageIndex = ChildrenView._namedImageList.ImageIndex(sc_7950.ssp_imbase_7951());
      return CatalogsView._imageIndex;
    }
  }

  private void InitializeComponent()
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (CatalogsView));
