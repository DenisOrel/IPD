...
// Type: Intermech.Localization.MRPCustomCategory
...
/// </summary>
internal class MRPCustomCategory(string сategory) : CategoryAttribute(сategory)
{
  /// <summary>
  ...
  {
    return MRPLocalization.rma.GetString(value) == null ? string.Empty : MRPLocalization.rma.GetString(value);
  }
}
