...
// Type: Intermech.Document.Editor.AuthorizeForm
...
public class AuthorizeForm : Form
{
  ...
  {
    this.Execute(LocalizationHolder.rm.GetString("Document.Editor_36"), (string) null);
  }
  ...
  private void btCopy_Click(object sender, EventArgs e) => Clipboard.SetText(this.tbSerial.Text);
  ...
  {
    this.tbSerial.Text = "U" + serialCode;
    if (days > 0)
    {
      this.timer1.Enabled = true;
      this.lbDaysLeft.Text = string.Format(LocalizationHolder.rm.GetString("Document.Editor_37"), (object) days);
    }
    else
    {
      this.timer1.Enabled = false;
      this.btContinue.Visible = false;
      this.lbDaysLeft.Text = LocalizationHolder.rm.GetString("Document.Editor_38");
  ...
  private void InitializeComponent()
  {
    ...
    this.btCopy.Image = (Image) Intermech.Document.Editor.Properties.Resources.CopyHS;
    ...
    this.btPaste.Image = (Image) Intermech.Document.Editor.Properties.Resources.PasteHS;
    ...
    this.pictureBox1.Image = (Image) Intermech.Document.Editor.Properties.Resources.auth;
