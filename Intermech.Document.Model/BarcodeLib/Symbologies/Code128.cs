...
// Type: BarcodeLib.Symbologies.Code128
...
internal class Code128 : BarcodeCommon, IBarcode
{
  ...
  /// <summary>Encodes data in Code128 format.</summary>
  /// <param name="input">Data to encode.</param>
  public Code128(string input) => this.Raw_Data = input;
  ...
  private void init_Code128()
  {
    ...
    this.C128_Code.Rows.Add((object) "73", (object) Convert.ToChar(9).ToString(), (object) "i", (object) "73", (object) "10000110100");
    ...
    this.C128_Code.Rows.Add((object) "80", (object) Convert.ToChar(16 /*0x10*/).ToString(), (object) "p", (object) "80", (object) "10100111100");
    ...
    this.C128_Code.Rows.Add((object) "95", (object) Convert.ToChar(31 /*0x1F*/).ToString(), (object) Convert.ToChar((int) sbyte.MaxValue).ToString(), (object) "95", (object) "10111101000");
  ...
  private List<DataRow> FindStartorCodeCharacter(string s, ref int col)
  {
    ...
    if (s.Length > 1 && (char.IsNumber(s[0]) || (int) s[0] == (int) Convert.ToChar(200)) && (char.IsNumber(s[1]) || (int) s[0] == (int) Convert.ToChar(200)))
    {
    ...
    else
    {
      ...
      foreach (char c in str2)
      {
        if (char.IsNumber(c))
        {
          ...
          {
            this._FormattedData.Add(str1 + c.ToString());
            str1 = "";
          }
        }
        else
  ...
  public string Encoded_Value => this.Encode_Code128();
