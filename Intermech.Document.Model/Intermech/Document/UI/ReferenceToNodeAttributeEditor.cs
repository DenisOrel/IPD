...
// Type: Intermech.Document.UI.ReferenceToNodeAttributeEditor
...
/// <summary>Вспомогательный класс для вызова редактора ReferenceToTextSourceEditorDlg из PropertyGrid</summary>
public class ReferenceToNodeAttributeEditor : UITypeEditor
{
