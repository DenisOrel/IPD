...
// Type: Intermech.Document.UI.ReferenceToGraphicsUIEditor
...
/// <summary>
/// Вспомогательный класс для связи свойства ссылки с диалогом редактирования
/// </summary>
public class ReferenceToGraphicsUIEditor : UITypeEditor
{
  ...
  public override object EditValue(
    ...
    object value)
  {
    return (object) ReferenceToGraphicsEditorDlg.ExecuteDialog((DocumentTreeNode) context.Instance, (ReferenceBase) value);
  }
}
