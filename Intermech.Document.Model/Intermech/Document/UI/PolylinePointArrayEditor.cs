...
// Type: Intermech.Document.UI.PolylinePointArrayEditor
...
/// <summary>Специальный класс для вызова из PropertyGrid</summary>
public class PolylinePointArrayEditor : UITypeEditor
{
  ...
  public override object EditValue(
    ...
    object value)
  {
    return (object) EditPolylinePathPointsDlg.Execute(context.Instance as Polyline);
  }
}
