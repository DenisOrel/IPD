...
// Type: Intermech.Document.UI.AdditionalAttributesEditor
...
/// <summary>Специальный класс для вызова из PropertyGrid редактора атрибутов
/// в AdditionalAttributeCollection</summary>
public class AdditionalAttributesEditor : UITypeEditor
{
  ...
  public override object EditValue(
    ...
    object value)
  {
    DocumentTreeNode instance = context.Instance as DocumentTreeNode;
    AdditionalAttributeCollection attributes = value != null ? (AdditionalAttributeCollection) value : new AdditionalAttributeCollection(instance);
    AdditionalAttributesEditorDlg.Execute(attributes);
    return value != null || attributes.Count > 0 ? (object) attributes : (object) null;
  }
}
