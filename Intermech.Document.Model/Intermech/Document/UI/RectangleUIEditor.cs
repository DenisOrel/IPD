...
// Type: Intermech.Document.UI.RectangleUIEditor
...
/// <summary>Вспомогательный класс для вызова диалога в PropertyGrid</summary>
public class RectangleUIEditor : UITypeEditor
{
  ...
  {
    return context.Instance is DocumentTreeNode instance && instance.IsVirtualNode ? UITypeEditorEditStyle.None : UITypeEditorEditStyle.Modal;
  }
  ...
  public override object EditValue(
    ...
    object value)
  {
    RectangleElement instance = (RectangleElement) context.Instance;
    int num = (int) new RectangleDlg(instance)
    {
      IsCreateRectangleDlg = false
    }.ShowDialog();
    value = context.PropertyDescriptor.GetValue((object) instance);
    return value;
  }
}
