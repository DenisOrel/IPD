...
// Type: Intermech.Document.UI.ReferenceToTextSourceUIEditor
...
/// <summary>Вспомогательный класс для связи свойства ссылки
/// ReferenceToTextSource с диалогом редактирования</summary>
public class ReferenceToTextSourceUIEditor : UITypeEditor
{
  ...
  public override object EditValue(
    ...
    object value)
  {
    DocumentTreeNode instance = (DocumentTreeNode) context.Instance;
    bool readOnlyMode = instance is TextData textData && !textData.IsTemplate && textData.ReadOnly;
    return (object) ReferenceToTextSourceEditorDlg.ExecuteDialog(instance, (ReferenceBase) value, readOnlyMode);
  }
}
