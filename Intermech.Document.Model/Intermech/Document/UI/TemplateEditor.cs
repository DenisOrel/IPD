...
// Type: Intermech.Document.UI.TemplateEditor
...
public class TemplateEditor : UITypeEditor
{
    ...
    object value)
  {
    ...
    return (object) SelectNodeDlg.Execute(instance.GetType(), instance.Template, instance.TemplateRoot, LocalizationHolder.rm.GetString("Document.Model_148"), 1);
  }
}
