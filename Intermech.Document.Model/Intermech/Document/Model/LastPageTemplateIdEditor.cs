...
// Type: Intermech.Document.Model.LastPageTemplateIdEditor
...
/// <summary>Вспомогательный класс для связи с диалогом выбора шаблона страницы</summary>
public class LastPageTemplateIdEditor : UITypeEditor
{
    ...
    object value)
  {
    ...
    Page page = (Page) SelectNodeDlg.Execute(typeof (Page), (DocumentTreeNode) instance.LastPageTemplate, rootNode, LocalizationHolder.rm.GetString("Document.Model_494"), 0);
