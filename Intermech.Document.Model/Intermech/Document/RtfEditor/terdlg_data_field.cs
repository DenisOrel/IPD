...
// Type: Intermech.Document.RtfEditor.terdlg_data_field
...
internal class terdlg_data_field : Form
{
  ...
  internal terdlg_data_field(ImRtfEditor parent)
  {
  ...
  private void InitializeComponent()
  {
    ...
    this.FieldName.Text = "";
    this.FieldData.Location = new Point(8, 80 /*0x50*/);
    this.FieldData.Name = "FieldData";
    this.FieldData.Size = new Size(224 /*0xE0*/, 20);
    this.FieldData.TabIndex = 3;
    this.FieldData.Text = "";
    ...
    this.Name = nameof (terdlg_data_field);
    this.Text = "Data Field Parameters";
    this.Load += new EventHandler(this.terdlg_data_field_Load);
    this.Activated += new EventHandler(this.terdlg_data_field_Activated);
  ...
  private void terdlg_data_field_Activated(object sender, EventArgs e) => this.FieldName.Focus();

  private void terdlg_data_field_Load(object sender, EventArgs ev)
  {
