...
// Type: Intermech.Document.RtfEditor.terdlg_listor_select
...
internal class terdlg_listor_select : Form
{
  private ListBox box;
  ...
  internal terdlg_listor_select(ImRtfEditor parent)
  {
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (terdlg_listor_select);
    this.Text = "Select a List Override";
    this.Load += new EventHandler(this.terdlg_listor_select_Load);
  ...
  private void terdlg_listor_select_Load(object sender, EventArgs ev)
  {
    this.e.misc.CenterDlgBox((Form) sender);
    this.e.par.FillListOrBox((object) this.box, true, true, -1, false);
  }
}
