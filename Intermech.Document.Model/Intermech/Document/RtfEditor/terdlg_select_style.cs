...
// Type: Intermech.Document.RtfEditor.terdlg_select_style
...
internal class terdlg_select_style : Form
{
  private ListBox box;
  ...
  internal terdlg_select_style(ImRtfEditor parent)
  {
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (terdlg_select_style);
    this.Text = "Select a Style";
    this.Load += new EventHandler(this.terdlg_select_style_Load);
    this.ResumeLayout(false);
  }

  private void OK_Click(object sender, EventArgs ev)
  {
    this.e.DlgResult = ((tc.ClsBox) this.box.SelectedItem).value;
  }

  private void terdlg_select_style_Load(object sender, EventArgs ev)
  {
    this.e.misc.CenterDlgBox((Form) sender);
    this.e.par.FillStyleBox((object) this.box, this.e.DlgInt1, true, true);
  }
}
