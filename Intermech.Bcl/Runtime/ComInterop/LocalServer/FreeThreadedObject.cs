...
// Type: Intermech.Runtime.ComInterop.LocalServer.FreeThreadedObject
...
namespace Intermech.Runtime.ComInterop.LocalServer
{
    ...
    public class FreeThreadedObject : MarshalByRefObject
    {
      /// <summary>Создает объект.</summary>
      protected FreeThreadedObject()
        : this(true)
      {
      }
      ...
      internal FreeThreadedObject(bool addToTracker)
      {
        if (!addToTracker)
          return;
