...
// Type: Intermech.Diagnostics.ItemNotFoundException`1
...
namespace Intermech.Diagnostics
{
    ...
    public class ItemNotFoundException<TKey> : ItemNotFoundException, ISerializable
    {
      ...
      public ItemNotFoundException([CanBeNull] TKey keyValue) => this.KeyValue = keyValue;

      public ItemNotFoundException([CanBeNull] TKey keyValue, [CanBeNull] string message)
        : base(message)
      {
        this.KeyValue = keyValue;
      }

      public ItemNotFoundException([CanBeNull] TKey keyValue, [CanBeNull] string message, [CanBeNull] Exception innerException)
