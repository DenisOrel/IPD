...
// Type: Intermech.PointDConverter
...
namespace Intermech
{
    ...
    public class PointDConverter : TypeConverter
    {
        ...
        object value)
      {
        ...
        return numArray.Length == 2 ? (object) new PointD(numArray[0], numArray[1]) : throw new ArgumentException("Failed to parse text. Expected text in the format: x, y", nameof (value));
      }
      ...
      {
        if (destinationType != typeof (string) || !(value is PointD pointD))
        ...
        {
          converter.ConvertToString(context, culture, (object) pointD.X),
          converter.ConvertToString(context, culture, (object) pointD.Y)
        };
