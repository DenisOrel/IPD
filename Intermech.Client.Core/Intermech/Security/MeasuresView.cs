...
// Type: Intermech.Security.MeasuresView
...
/// <summary>Summary description for MeasuresView.</summary>
public class MeasuresView : ObjectsViewBase
{
  private int _imageIndex;

  public MeasuresView() => this._imageIndex = -1;
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MeasuresView));
