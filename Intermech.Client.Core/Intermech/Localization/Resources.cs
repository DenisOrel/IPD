...
{
  [NotNull]
  private static readonly ResourceManager _resources = new ResourceManager("Intermech.Client.Core.Resources.ClientCoreResources", Assembly.GetExecutingAssembly());
  [NotNull]
  private static readonly ResourceManager _attributes = new ResourceManager("Intermech.Client.Core.Resources.CustomAttributesResources", Assembly.GetExecutingAssembly());
