...
// Type: Intermech.PropertyEditors.RTFDescriber
...
/// <summary>для редактирования RTF строк</summary>
public class RTFDescriber : IAttributePropertyDescriber
{
  public Type GetPropDescriptorType(int attributeId, FieldTypes baseType)
  {
    return typeof (RTFPropertyClass);
  }

  public object GetPropDescriptorEditor(int attributeId) => (object) new RTFEditor();
  ...
  public object GetPropDescriptorValue(
    ...
    object actualValue)
  {
    return (object) new RTFPropertyClass(actualValue as string);
  }
  ...
  {
    return propertyValue is RTFPropertyClass rtfPropertyClass ? (object) rtfPropertyClass.Text : (object) string.Empty;
  }
