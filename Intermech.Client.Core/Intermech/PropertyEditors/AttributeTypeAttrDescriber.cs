...
// Type: Intermech.PropertyEditors.AttributeTypeAttrDescriber
...
/// <summary>Summary description for AttributeTypeAttrDescriber.</summary>
public class AttributeTypeAttrDescriber : IAttributePropertyDescriber
{
  ...
  {
    return (object) ((AttributeTypeAttrProxy) propertyValue).Guid;
  }

  public object GetPropDescriptorEditor(int attributeId) => (object) new AttributeTypeAttrEditor();

  public Type GetPropDescriptorType(int attributeId, FieldTypes baseType)
  {
    return typeof (AttributeTypeAttrProxy);
  }
  ...
  public object GetPropDescriptorValue(
    ...
    object actualValue)
  {
    return (object) new AttributeTypeAttrProxy(actualValue == DBNull.Value || actualValue == null || Convert.ToString(actualValue) == string.Empty ? Guid.Empty : new Guid(Convert.ToString(actualValue)));
  }
