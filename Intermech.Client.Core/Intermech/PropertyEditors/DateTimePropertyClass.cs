...
// Type: Intermech.PropertyEditors.DateTimePropertyClass
...
[Serializable]
public class DateTimePropertyClass : PropertyClass
{
  public DateTimePropertyClass()
    : this(DateTime.MinValue)
  {
    this.value = (object) null;
  }

  public DateTimePropertyClass(DateTime aDateTime)
    : this(aDateTime, string.Empty, (DataTable) null)
  {
  }
  ...
  public override string ToString()
  {
    ...
    return ((DateTime) this.value).ToString(CultureInfo.CurrentCulture.DateTimeFormat.ShortDatePattern);
  }
}
