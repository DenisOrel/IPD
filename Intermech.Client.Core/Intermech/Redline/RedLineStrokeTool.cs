...
// Type: Intermech.Redline.RedLineStrokeTool
...
public class RedLineStrokeTool : MapTool
{
  ...
  public override void DoMouseDown()
  {
    ...
    if (this._stroke == null)
    {
      ...
      this._stroke.Pen = new Pen(this._redliner.PenColorAlpha, this._redliner.PenWidthInDrawingUnits);
  ...
  {
    if (this._stroke == null || !(this._stroke.GetLastPoint() != this.LastInput.DocPoint))
      return;
    this._stroke.SetPoint(this._stroke.PointsCount - 1, this.LastInput.DocPoint);
  }
  ...
  public override void DoMouseUp()
  {
    if (this.LastInput.Buttons != MouseButtons.Left)
      return;
    if (this._stroke != null && this._stroke.PointsCount >= 2)
    {
      this.StartTransaction();
      if (this._relative != null)
      {
        this._stroke.Relative = this._relative;
        this._stroke.RelativeId = this._relative.GetId(this._stroke.GetPoint(0));
      }
      this._redliner.AddNewObject((MapObject) this._stroke);
      this._stroke = (MapRedPencil) null;
      this.TransactionResult = "New Stroke";
