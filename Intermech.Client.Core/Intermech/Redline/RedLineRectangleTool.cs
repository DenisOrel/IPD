...
// Type: Intermech.Redline.RedLineRectangleTool
...
[Serializable]
public class RedLineRectangleTool : MapTool
{
  ...
  internal RedLineRectangleTool(Redliner redliner)
    : base(redliner.View)
  {
  ...
  public override void DoMouseUp()
  {
    ...
    if (this._rectangle != null)
    {
      ...
      this._rectangle = (MapRedRectangle) null;
      this.TransactionResult = "New RedLineRectangle";
