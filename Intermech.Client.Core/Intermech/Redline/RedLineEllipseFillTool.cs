...
// Type: Intermech.Redline.RedLineEllipseFillTool
...
[Serializable]
public class RedLineEllipseFillTool : MapTool
{
  ...
  internal RedLineEllipseFillTool(Redliner redliner)
    : base(redliner.View)
  {
  ...
  public override void DoMouseDown()
  {
    ...
    if (this._redliner.BrushColor != Color.Empty)
      this._ellipse.Brush = (Brush) new SolidBrush(this._redliner.BrushColorAlpha);
