...
// Type: Intermech.Client.Core.ImageLibraryView
...
/// 
/// </summary>
internal class ImageLibraryView : ObjectsViewBase
{
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ImageLibraryView));
    ...
    this.Font = (Font) null;
    this.Name = nameof (ImageLibraryView);
    this.Tag = (object) "  ";
  ...
  public override ContentType ViewContentType
  {
    get
    {
      return MetaDataHelper.IsObjectTypeChildOf(this._nodeID.TypeID, Intermech.Client.Core.Thumbnail.Consts.ImageLibraryFolderTypeID) ? ContentType.Folders | ContentType.NonFolders : ContentType.Folders;
    }
  }
  ...
  public override int ImageIndex
  {
    get
    {
      if (this._imageIndex == -1 && ChildrenView._namedImageList != null)
