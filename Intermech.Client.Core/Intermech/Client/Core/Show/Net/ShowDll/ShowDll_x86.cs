...
// Type: Intermech.Client.Core.Show.Net.ShowDll.ShowDll_x86
...
/// <summary>вызовы ShowIPSx86.dll win x32</summary>
internal static class ShowDll_x86
{
  internal const string DllName = "ShowIPSx86.dll";
  ...
  [DllImport("ShowIPSx86.dll", EntryPoint = "CheckVersionNet")]
  ...
  [DllImport("ShowIPSx86.dll", EntryPoint = "CheckVersion")]
  ...
  [DllImport("ShowIPSx86.dll", EntryPoint = "Open_Dwg_Net", CharSet = CharSet.Ansi)]
  ...
  [DllImport("ShowIPSx86.dll", EntryPoint = "Open_DWG_Handle")]
  internal static extern void Open_Dwg_Handle_Import(
    byte[] fileDwgdata,
    int lenfileDwgdata,
    out short code);

  [DllImport("ShowIPSx86.dll", EntryPoint = "CheckVersionDWG", CharSet = CharSet.Ansi)]
  ...
  [DllImport("ShowIPSx86.dll", EntryPoint = "SaveDWGFile", CharSet = CharSet.Ansi)]
  internal static extern void SaveDWGFile_Import(string dwgFilePath);

  [DllImport("ShowIPSx86.dll", EntryPoint = "SetParameter", CharSet = CharSet.Ansi)]
