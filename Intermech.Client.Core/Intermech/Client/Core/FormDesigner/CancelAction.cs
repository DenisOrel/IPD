...
// Type: Intermech.Client.Core.FormDesigner.CancelAction
...
internal class CancelAction : IFormDesignerActionHandler
{
  /// <summary>
  /// 
  /// </summary>
  ...
  /// <param name="button"></param>
  /// <param name="form"></param>
  public void ButtonPressed(object button, object form) => this.Cancel(form);
}
