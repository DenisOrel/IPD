...
// Type: Intermech.Client.Core.FormDesigner.TabPages.Forms4RelationTypePage
...
/// 
/// </summary>
public class Forms4RelationTypePage : BaseTabPage
{
  private Forms4TypeForm _form;

  /// <summary>Конструктор.</summary>
  /// <param name="instGuid"></param>
  public Forms4RelationTypePage(Guid instGuid)
    : base(instGuid, LocalizationHolder.rm.GetString("Client.Core_190"))
  {
