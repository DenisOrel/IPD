...
// Type: Intermech.Client.Core.Forms.SetCheckLevelsForm
...
internal class SetCheckLevelsForm : 
  IpsBaseDialog,
  IComponent,
  IDisposable,
  IDropTarget,
  ...
  ICanBeReadOnly2
{
  ...
  public static SetCheckLevelsFormResult? Query(
    [CanBeNull] Form parentForm,
    [CanBeNull] System.IServiceProvider ownerServices,
    [CanBeNull] string contextName,
    int maxLevel)
  {
    using (SetCheckLevelsForm setCheckLevelsForm = new SetCheckLevelsForm(parentForm, ownerServices, contextName, maxLevel))
      return setCheckLevelsForm.ShowDialog() == DialogResult.OK ? new SetCheckLevelsFormResult?(new SetCheckLevelsFormResult(setCheckLevelsForm.Value)) : new SetCheckLevelsFormResult?();
  }

  public SetCheckLevelsForm()
  ...
  private void InitializeComponent()
  {
    ...
    this.label1.Text = "До какого уровня вложенности объектов установить отметки?";
    ...
    this.Name = "SetCheckLevelsForms";
    this.Text = "Простановка отметок";
