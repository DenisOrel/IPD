...
// Type: Intermech.Windows.Forms.IpsBaseForm
  ...
  ICanBeReadOnly2
{
  ...
  public IpsBaseForm([CanBeNull] string contextName)
    : this((System.IServiceProvider) null, contextName)
  {
  }

  public IpsBaseForm([CanBeNull] System.IServiceProvider ownerServices, [CanBeNull] string contextName = null)
    : base(ownerServices, contextName)
  {
    this.AddService<IpsBaseForm>(this);
  }

  protected override void Dispose(bool disposing)
  {
    if (disposing)
      this.RemoveService<IpsBaseForm>();
