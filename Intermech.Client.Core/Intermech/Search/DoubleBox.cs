...
// Type: Intermech.Search.DoubleBox
...
public sealed class DoubleBox : Box<double>
{
  /// <summary>Required designer variable.</summary>
  private IContainer components;

  public DoubleBox() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    this.Name = nameof (DoubleBox);
    this.Size = new Size(150, 94);
