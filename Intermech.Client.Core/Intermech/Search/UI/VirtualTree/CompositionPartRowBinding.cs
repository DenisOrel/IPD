...
// Type: Intermech.Search.UI.VirtualTree.CompositionPartRowBinding
...
public sealed class CompositionPartRowBinding : RowBindingBase
{
  public CompositionPartRowBinding()
  {
    this.ParentProperty = "Parent";
    this.Type = typeof (CompositionPart);
