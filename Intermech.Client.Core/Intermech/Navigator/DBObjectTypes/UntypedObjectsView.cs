...
// Type: Intermech.Navigator.DBObjectTypes.UntypedObjectsView
...
public class UntypedObjectsView : ObjectsViewBase
{
  public override ContentType ViewContentType => ContentType.NonFolders;

  public override string Caption => LocalizationHolder.rm.GetString("Client.Core_307");

  private void InitializeComponent()
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (UntypedObjectsView));
    ...
    this.Font = (Font) null;
    this.Name = nameof (UntypedObjectsView);
