...
// Type: Intermech.Navigator.Parts.ObjectApplicabilityByLinksPart
...
/// <summary>Часть узла с применяемостью объекта по ссылкам</summary>
public sealed class ObjectApplicabilityByLinksPart : ObjectsPart
{
  /// <summary>Конструктор</summary>
  /// <param name="objectVersionID">Идентификатор версии объекта</param>
  /// <param name="serviceProvider">Провайдер сервисов</param>
  /// <exception cref="T:System.ArgumentException"></exception>
  public ObjectApplicabilityByLinksPart(long objectVersionID, IServiceProvider serviceProvider)
  ...
  {
    return (INodeQuery) new ObjectApplicabilityByLinksQuery(this.ObjectVersionID, (INodeQuerySupport) this);
  }
}
