...
// Type: Intermech.Navigator.Conditions.AttributeConditionControls.LCLevelEditControl
...
internal sealed class LCLevelEditControl(
  ...
  bool firstValue) : ObjectEditControl(dataProvider, attributeID, (int[]) null, SelectionParameterTypes.sptLifecycleLevel, pValues, firstValue)
{
  ...
  {
    get => (IButtonDialog) new LCLevelButtonDialog(this.dataProvider, this.attributeID, this.Value);
  }
