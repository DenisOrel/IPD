...
// Type: Intermech.Navigator.LifeCycle.LifeCycleSchemesDescriptor
...
public class LifeCycleSchemesDescriptor : HiveDescriptor
{
  /// <summary>Заголовок</summary>
  public new static string Caption
  {
    [DebuggerStepThrough] get => LocalizationHolder.rm.GetString("Client.Core_1337");
  }

  /// <summary>Создает дескриптор</summary>
  public LifeCycleSchemesDescriptor()
    : base(Intermech.Navigator.Consts.CategoryLifeCycleSchemesNode, 0, LifeCycleSchemesDescriptor.Caption)
  {
  }
  ...
  protected LifeCycleSchemesDescriptor(PersistentState state)
    : base(Intermech.Navigator.Consts.CategoryLifeCycleSchemesNode, 0, LifeCycleSchemesDescriptor.Caption)
  {
  }
