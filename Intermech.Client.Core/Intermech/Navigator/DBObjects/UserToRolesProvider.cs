...
// Type: Intermech.Navigator.DBObjects.UserToRolesProvider
...
/// <summary>
///  Провайдер для редактора назначенных ролей пользователю
/// </summary>
internal class UserToRolesProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ...
    views.Add("UserToRolesView", new ViewInfo(0, 1095, typeof (UserToRolesView)));
    return views;
  }
}
