...
// Type: Intermech.Navigator.DBObjects.ProjectNameTransform
...
public class ProjectNameTransform : INodeColumnTransform
{
  /// <summary>Ссылка на кэш</summary>
  private IProjectNamesCache _namesCache = CacheManager.Cache("ProjectNamesCache") as IProjectNamesCache;
  ...
  {
    return CellValue.GetValue(sourceValue, column, (object) this._namesCache.GetProjectName(Convert.ToInt64(sourceValue)));
  }
}
