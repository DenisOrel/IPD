...
// Type: Intermech.Navigator.DBObjects.ObjectTypeNameTransform
...
/// <summary>
/// Преобразование идентификаторов типов объектов в их названия
/// </summary>
public class ObjectTypeNameTransform : INodeColumnTransform
{
  ...
  {
    return CellValue.GetValue(sourceValue, column, (object) MetaDataHelper.GetObjectTypeName(Convert.ToInt32(sourceValue)));
  }
}
