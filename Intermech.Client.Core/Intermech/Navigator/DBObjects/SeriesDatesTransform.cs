...
// Type: Intermech.Navigator.DBObjects.SeriesDatesTransform
...
/// <summary>
/// Преобразование информации о применяемостях в сериях/датах
/// </summary>
public class SeriesDatesTransform : INodeColumnTransform
{
  ...
  {
    SeriesDatesApplicabilityCollection applicabilityCollection = new SeriesDatesApplicabilityCollection(sourceValue);
    return CellValue.GetValue(sourceValue, column, (object) applicabilityCollection.DisplayString);
  }
}
