...
// Type: Intermech.Navigator.DBObjects.ObjectLevelIDTransform
...
/// <summary>
/// Преобразование идентификаторов уровней продвижения в их названия
/// </summary>
public class ObjectLevelIDTransform : INodeColumnTransform
{
  ...
  {
    return CellValue.GetValue(sourceValue, column, (object) MetaDataHelper.GetLCLevelName(Convert.ToInt32(sourceValue)));
  }
}
