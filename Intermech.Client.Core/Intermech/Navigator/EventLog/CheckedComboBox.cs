...
// Type: Intermech.Navigator.EventLog.CheckedComboBox
...
public class CheckedComboBox : ComboBox
{
  ...
  private void DoDropDown()
  {
    ...
    this.dropdown.Location = new Point(screen.X, screen.Y - this.dropdown.Size.Height);
  ...
  internal class Dropdown : Form
  {
    ...
    public void CloseDropdown(bool enactChanges)
    {
      ...
      if (enactChanges)
      {
        ...
        if (this.cclb.CheckedItems.Count == 0)
          this.cclb.SetItemChecked(0, true);
    ...
    {
      if (this.ccbParent.ItemCheck == null || this.ccbParent.CheckedItems.Count <= 1 && e.NewValue == CheckState.Unchecked)
        return;
