...
// Type: Intermech.TwainScanner.ReferenceCountedObject
...
/// <summary>Reference counted object base.</summary>
[ComVisible(false)]
public class ReferenceCountedObject
{
  public ReferenceCountedObject() => ExeCOMServer.Instance.Lock();

  ~ReferenceCountedObject() => ExeCOMServer.Instance.Unlock();
}
