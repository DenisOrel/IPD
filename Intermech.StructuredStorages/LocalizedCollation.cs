...
// Type: Intermech.Data.SQLite.LocalizedCollation
...
{
    [SQLiteFunction(FuncType = FunctionType.Collation, Name = "LOCALIZED")]
    internal sealed class LocalizedCollation : SQLiteFunctionEx
    {
      public override int Compare(string x, string y)
      {
        return string.Compare(x, y, CultureInfo.CurrentUICulture, CompareOptions.None);
      }
    }
}
