...
// Type: Intermech.ECO.Server.Dop_ObjCreator
...
internal class Dop_ObjCreator : IDBObjectCreator
{
  public IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new DopIzvObject((UserSession) uSession, objectParams);
  }
}
