...
// Type: Intermech.ECO.Server.CJ_ObjCreator
...
internal class CJ_ObjCreator : IDBObjectCreator
{
  public IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new ChangeJournalObject((UserSession) uSession, objectParams);
  }
}
