...
// Type: Intermech.ECO.Server.ECORootCreator
...
internal class ECORootCreator : IDBObjectCreator
{
  public IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new ECOObject((UserSession) uSession, objectParams);
  }
}
