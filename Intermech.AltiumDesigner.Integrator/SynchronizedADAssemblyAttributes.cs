...
// Type: Intermech.AltiumDesigner.Integrator.SynchronizedADAssemblyAttributes
...
internal class SynchronizedADAssemblyAttributes : SynchronizedArticleAttributes
{
  private readonly AttributeTable attrTable;

  public SynchronizedADAssemblyAttributes(SettingsService settingsService)
    : base((IIntegratorSettingsService) settingsService)
  {
    this.attrTable = new AttributeTable(settingsService, AttributesTableKind.AssemblyAttributes);
  }
