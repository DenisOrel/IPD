...
// Type: Intermech.AltiumDesigner.Integrator.UnionADCompositionRelation
...
internal sealed class UnionADCompositionRelation : UnionECADCompositionRelation
{
  private IIntegratorOutput _outputSvc;

  public UnionADCompositionRelation(
