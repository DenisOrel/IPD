...
// Type: Intermech.Bars.BlackRenderer
...
{
    public class BlackRenderer : OfficeRendererBase
    {
      ...
      {
        this.p = this.a(this._backgroundColor, BlackRenderer.InterpolateColors(A_0, SystemColors.Window, 0.7f), 0.05f);
        this.r = BlackRenderer.InterpolateColors(A_0, SystemColors.Window, 0.5f);
        this.q = BlackRenderer.InterpolateColors(A_0, SystemColors.Window, 0.85f);
        this.o = A_0;
      }
      ...
      private Color a(Color A_0, Color A_1, float A_2)
      {
        ...
        if ((double) A_1.GetBrightness() > (double) brightness - (double) A_2)
          A_1 = BlackRenderer.InterpolateColors(A_1, Color.Black, 0.14f);
        return A_1;
      }
      ...
      {
        this._backgroundColor = Color.FromArgb(45, 45, 48 /*0x30*/);
        this._highlightBorderColor = SystemColors.Highlight;
        this._menuBackgroundColor = BlackRenderer.InterpolateColors(SystemColors.Window, SystemColors.Control, 0.15f);
        this.CalculateDerivedColors();
      }

      protected virtual void CalculateDerivedColors()
      {
        this.__f = BlackRenderer.InterpolateColors(SystemColors.ControlDark, SystemColors.ControlDarkDark, 0.48f);
        this.__g = SystemColors.ControlDark;
        this.__h = BlackRenderer.InterpolateColors(SystemColors.ControlDarkDark, SystemColors.ControlText, 0.4f);
        this.i = BlackRenderer.InterpolateColors(SystemColors.ControlDark, SystemColors.Control, 0.39f);
        this.m = BlackRenderer.InterpolateColors(SystemColors.Window, SystemColors.Control, 0.8f);
        this.l = BlackRenderer.InterpolateColors(SystemColors.Control, Color.Black, 0.42f);
