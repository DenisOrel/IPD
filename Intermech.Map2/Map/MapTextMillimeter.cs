...
// Type: Intermech.Map.MapTextMillimeter
...
{
    [Serializable]
    public class MapTextMillimeter : MapObject
    {
      ...
      static MapTextMillimeter()
      {
        MapTextMillimeter.myDefaultFontName = "Microsoft Sans Serif";
        MapTextMillimeter.myDefaultFontSize = 6f;
        MapTextMillimeter.myLastFont = (Font) null;
        MapTextMillimeter.myEmptyChoices = ArrayList.FixedSize(new ArrayList());
        MapTextMillimeter.myEmptyBitmap = new Bitmap(10, 10);
      }

      public MapTextMillimeter()
      {
        this.myString = "";
        this.myFamilyName = MapTextMillimeter.myDefaultFontName;
        this.myFontSize = MapTextMillimeter.myDefaultFontSize;
        this.myAlignment = 2;
        ...
        this.myMinimum = 0;
        this.myMaximum = 100;
        this.myChoices = MapTextMillimeter.myEmptyChoices;
      ...
      protected float computeHeight(Graphics g, Font font, float maxw)
      {
        string str1 = this.Text;
        float lineHeight = this.getLineHeight(g, font);
        if (str1.Length == 0)
        {
          this.myNumLines = 1;
          return lineHeight;
      ...
      protected float computeWidth(Graphics g, Font font)
      {
      ...
      {
        MapTextMillimeter mapTextMillimeter = (MapTextMillimeter) base.CopyObject(env);
        if (mapTextMillimeter != null)
          mapTextMillimeter.myEditor = (MapControl) null;
        return (MapObject) mapTextMillimeter;
      }
      ...
      public override MapControl CreateEditor(MapView view)
      {
        ...
        {
          editor.ControlType = typeof (MapTextMillimeter.NumericUpDownControl);
        ...
        {
          editor.ControlType = typeof (MapTextMillimeter.ComboBoxControl);
          RectangleF bounds = this.Bounds;
          bounds.X -= 2f;
          bounds.Y -= 2f;
          bounds.Width += 4f;
          ...
          if (view != null)
          {
            ...
            using (Graphics graphics = view.CreateGraphics())
            {
              ...
              using (Font font2 = this.makeFont(font1.Name, size, font1.Style))
              {
                if (graphics != null)
                {
            ...
            float num = val1 + 10f * this.Font.Size;
            bounds.Width = num / view.DocScale;
          }
          editor.Bounds = bounds;
          return editor;
        }
        editor.ControlType = typeof (MapTextMillimeter.TextBoxControl);
        ...
        if (this.Multiline || this.Wrapping)
        {
          using (Graphics graphics = view.CreateGraphics())
          {
            ...
            bounds1.Height += this.getLineHeight(graphics, this.Font) * 2f;
          }
        }
        if (!this.Wrapping)
        {
      ...
      public override void DoBeginEdit(MapView view)
      {
        ...
        {
          MapObject.Trace("MapTextMillimeter DoBeginEdit: " + ex.ToString());
      ...
      {
        int index = str.IndexOfAny(MapTextMillimeter.myNewlineArray, start);
        if (index >= 0)
        {
      ...
      private float getLineHeight(Graphics g, Font font) => font.GetHeight(g);

      private StringFormat getStringFormat(MapView view)
      {
      ...
      internal bool isRightToLeft(MapView view)
      {
        return this.RightToLeftFromView && view != null ? view.RightToLeft == System.Windows.Forms.RightToLeft.Yes : this.RightToLeft;
      }

      protected virtual Font makeFont(string name, float size, FontStyle style)
      {
        byte gdiCharSet = (byte) this.GdiCharSet;
        return new Font(name, size, style, GraphicsUnit.Millimeter, gdiCharSet);
      }
      ...
      private void paintText(string str, Graphics g, MapView view, RectangleF rect, Brush textbrush)
      {
        if (str.Length == 0)
          return;
        Font font1 = this.Font;
        ...
        float lineHeight = this.getLineHeight(g, font1);
      ...
      {
        lock (MapTextMillimeter.myEmptyBitmap)
        {
          using (Graphics g = Graphics.FromImage((Image) MapTextMillimeter.myEmptyBitmap))
          {
      ...
      {
        lock (typeof (MapTextMillimeter))
        {
          if (MapTextMillimeter.myLastFont != null && MapTextMillimeter.myLastFont.Name == name && (double) MapTextMillimeter.myLastFont.Size == (double) size && MapTextMillimeter.myLastFont.Style == style)
            return MapTextMillimeter.myLastFont;
          MapTextMillimeter.myLastFont = this.makeFont(name, size, style);
          return MapTextMillimeter.myLastFont;
        }
      }
      ...
      {
        if (this.Initializing || (this.InternalTextFlags & 1073741824 /*0x40000000*/) != 0 || !this.AutoRescales)
          return;
      ...
      {
        if (this.Initializing || (this.InternalTextFlags & 1073741824 /*0x40000000*/) != 0 || !this.AutoResizes)
          return;
        this.InternalTextFlags |= 1073741824 /*0x40000000*/;
      ...
      {
        get => this.myChoices == null ? MapTextMillimeter.myEmptyChoices : this.myChoices;
        set
        {
          ArrayList oldVal = this.myChoices != null ? this.myChoices : MapTextMillimeter.myEmptyChoices;
          ArrayList newVal = value ?? MapTextMillimeter.myEmptyChoices;
          if (oldVal == newVal)
            return;
      ...
      [Description("The initial font face name for newly constructed MapTextMillimeter objects.")]
      public static string DefaultFontFamilyName
      {
        get => MapTextMillimeter.myDefaultFontName;
        set
        {
          if (value == null)
            return;
          MapTextMillimeter.myDefaultFontName = value;
        }
      }

      [Description("The initial font size for newly constructed MapTextMillimeter objects.")]
      public static float DefaultFontSize
      {
        get => MapTextMillimeter.myDefaultFontSize;
        set
        {
          if ((double) value <= 0.0)
            return;
          MapTextMillimeter.myDefaultFontSize = value;
        }
      }
      ...
      public virtual string FamilyName
      {
        ...
        set
        {
          string newVal = value ?? MapTextMillimeter.DefaultFontFamilyName;
      ...
      internal sealed class ComboBoxControl : ComboBox, IMapControlObject
      {
        ...
        private void AcceptText()
        {
          ...
          if (mapControl == null)
            return;
          if (mapControl.EditedObject is MapTextMillimeter editedObject)
        ...
        public MapControl MapControl
        {
          ...
          set
          {
            ...
            if (value == null || !(value.EditedObject is MapTextMillimeter editedObject))
              return;
          ...
          set
          {
            ...
            switch (editedObject.Alignment)
            {
              ...
              case 16 /*0x10*/:
                ...
                if (this.MapView != null)
                  size2 *= this.MapView.DocScale / 1.66f;
