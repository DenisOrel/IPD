...
{
    [Serializable]
    public class MapComment : MapGroup, IMapLabeledNode, IMapIdentifiablePart
    {
      ...
      protected override void CopyChildren(MapGroup newgroup, MapCopyDictionary env)
      {
        ...
        MapComment mapComment = (MapComment) newgroup;
        mapComment.myPartID = -1;
        mapComment.myBack = (MapObject) env[(object) this.myBack];
        mapComment.myLabel = (MapText) env[(object) this.myLabel];
      }
