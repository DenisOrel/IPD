...
// Type: Intermech.Map.MapRedEllipse
...
{
    /// <summary>эллипс для RedLines с пересчёт положения объектов относительно элемента в документе</summary>
    [Serializable]
    public class MapRedEllipse : MapShape, IMapRelativePosition, IMapTime, IMapToolTipText
    {
      ...
      private bool CheckOffsetThis()
      {
        ...
        SizeF offset = new SizeF(sizeF.Width - this._baseOffsetId.Width, sizeF.Height - this._baseOffsetId.Height);
      ...
      public override bool GetNearestIntersectionPoint(PointF p1, PointF p2, out PointF result)
      {
        ...
        return MapRedEllipse.NearestIntersectionOnEllipse(bounds, p1, p2, out result);
      }
