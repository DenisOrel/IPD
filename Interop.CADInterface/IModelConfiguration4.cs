...
// Type: Interop.CADInterface.IModelConfiguration4
...
[Guid("645104AF-7248-4687-B01C-B276D5B68E98")]
[ComImport]
public interface IModelConfiguration4 : IModelConfiguration3
{
  [DispId(1)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_DISPATCH)]
  IModelComponent5[] GetFullStructure();
}
