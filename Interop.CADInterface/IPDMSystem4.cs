...
// Type: Interop.CADInterface.IPDMSystem4
...
[Guid("7146AA71-D383-4099-9870-8D4F6DF4EAC0")]
[ComImport]
public interface IPDMSystem4 : IPDMSystem3
{
  [DispId(1)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IPDMDocument3 GetDocumentByFilePath([MarshalAs(UnmanagedType.BStr), In] string bstrFilePath);

  [DispId(22)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void BeginGroupOperation();
