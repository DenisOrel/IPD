...
// Type: Interop.CADInterface.ICADSystem6
...
[Guid("A312958A-72E3-4014-A438-66CC7040D8E6")]
[ComImport]
public interface ICADSystem6 : ICADSystem5
{
  [DispId(1)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR)]
  string[] GetExportFormats([In] ECADDocType iDocType);

  [DispId(24)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SetActiveMode([In] ECADSystemModeType ModeType);
}
