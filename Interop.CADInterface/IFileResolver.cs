...
// Type: Interop.CADInterface.IFileResolver
...
[Guid("B70C1C9E-F176-465F-A08E-3DCB5EDE37C2")]
[ComImport]
public interface IFileResolver
{
  ...
  string Resolve([MarshalAs(UnmanagedType.BStr), In] string bstrRelativePath);
}
