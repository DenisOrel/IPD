...
// Type: Interop.CADInterface.ICADSystem5
...
[Guid("3648998B-927F-46D2-8C08-8A8221972402")]
[ComImport]
public interface ICADSystem5 : ICADSystem4
{
  [DispId(1)]
  ...
  [DispId(22)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void GetDocumentWithReplaceArray(
    [MarshalAs(UnmanagedType.BStr), In] string bstrFullPath,
    [In] bool bOpenVisible,
