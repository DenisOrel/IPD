...
// Type: Interop.CADInterface.IPDMSystem9
...
[Guid("0AE259FE-E0B9-4CBA-A5C1-E32E4ECE5D5B")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface IPDMSystem9 : IPDMSystem8
{
  [DispId(1)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  new IPDMDocument5 GetDocumentByPersistentID([MarshalAs(UnmanagedType.BStr), In] string bstrID);

  [DispId(32 /*0x20*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  new IPDMArticle3 GetArticleByPersistentID([MarshalAs(UnmanagedType.BStr), In] string bstrID);

  [DispId(33)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void GetDocVersionInfo2(
    [MarshalAs(UnmanagedType.BStr), In] string DocFullPath,
  ...
  new PhysicalUnit[] GetUnits([In] EUnitsSubset eSubset);

  [DispId(35)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN)]
  object[] SelectObjects([In] ESelectObjectsType eType);
}
