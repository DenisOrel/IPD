...
// Type: Interop.CADInterface.IStructureModification4
...
[Guid("817BC760-CD74-466F-8657-2A03465B56C2")]
[ComImport]
public interface IStructureModification4 : IStructureModification3
{
  [DispId(1)]
  ...
  [DispId(6)]
  new int ActualQuantity { [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(7)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  new IModelConfiguration GetAssemblyConfiguration();

  [DispId(8)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_DISPATCH)]
  new IModelComponent[] GetComponents([MarshalAs(UnmanagedType.Interface), In] IModelConfiguration pConfiguration, [MarshalAs(UnmanagedType.Interface), In] IDrawingView pView);

  [DispId(9)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_DISPATCH)]
  new PositionNote[] GetNotes();

  [DispId(10)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void SetNotesNumber([In] int iNumber);

  [DispId(11)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  new PositionNote AddNote();

  [DispId(12)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void DeleteNote([MarshalAs(UnmanagedType.BStr), In] string bstrNoteGUID);

  [DispId(13)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Struct)]
  object GetQuantityFromModel();
}
