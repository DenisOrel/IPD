...
// Type: Interop.CADInterface.IModelConfiguration5
...
[Guid("916B9D79-CD86-4633-9A4F-81C3E37A3DD0")]
[ComImport]
public interface IModelConfiguration5 : IModelConfiguration4
{
  [DispId(1)]
  ...
  [DispId(24)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void GetPhysicalQuantity([In] EPhysicalQuantities eQuantityType, [MarshalAs(UnmanagedType.Interface), In, Out] ref PhysicalQuantity ppValue);
}
