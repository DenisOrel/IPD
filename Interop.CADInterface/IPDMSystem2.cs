...
// Type: Interop.CADInterface.IPDMSystem2
...
[Guid("C44638D2-1F3A-45EB-8C4F-3257E3E7E37C")]
[ComImport]
public interface IPDMSystem2 : IPDMSystem
{
  [DispId(1)]
  ...
  [DispId(13)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void CreateSpecification([MarshalAs(UnmanagedType.Interface), In] ICADDocument pCADDocument);

  [DispId(14)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string BeginUpdateStandardPart([MarshalAs(UnmanagedType.BStr), In] string bstrPartName, [MarshalAs(UnmanagedType.BStr), In] string bstrModelFileName);

  [DispId(15)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void EndUpdateStandardPart([MarshalAs(UnmanagedType.BStr), In] string bstrPartName, [MarshalAs(UnmanagedType.BStr), In] string bstrModelFileName);

  [DispId(16 /*0x10*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IPDMDocument2 GetDocumentByID([MarshalAs(UnmanagedType.BStr), In] string bstrID);

  [DispId(17)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IPDMArticle2 GetArticleByID([MarshalAs(UnmanagedType.BStr), In] string bstrID);

  [DispId(18)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN)]
  IParametersContainer[] GetSpecificationFromAVS([MarshalAs(UnmanagedType.Interface), In] ICADDocument pCADDocument);
}
