...
// Type: Interop.CADInterface.IPDMDocument5
...
[Guid("A0EADCFC-DEAA-4B1E-B874-7671FFD3388A")]
[ComImport]
public interface IPDMDocument5 : IPDMDocument4
{
  [DispId(1)]
  ...
  [DispId(30)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SelectVersion2(out long plSelectedVersion, [MarshalAs(UnmanagedType.BStr)] out string pbstrFullPath);

  [DispId(31 /*0x1F*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SetRefVersion2([MarshalAs(UnmanagedType.Interface), In] IPDMDocument4 pRefDoc, [In] long lVersion);

  [DispId(32 /*0x20*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string PrepareVersionForInsertingIntoAssembly2([In] long lVersion, [MarshalAs(UnmanagedType.BStr), In] string bstrAssemblyPath);

  [DispId(33)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR)]
  string[] GetAdditionalDrawings();
}
