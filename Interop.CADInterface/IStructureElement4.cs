...
// Type: Interop.CADInterface.IStructureElement4
...
[Guid("854197A9-BCE6-48AE-818B-E96817E38217")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface IStructureElement4 : IStructureElement3
{
  [DispId(1)]
  ...
  [DispId(13)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void UpdateFormat([MarshalAs(UnmanagedType.Interface)] AttributeLocalizer pLocalizer);

  [DispId(14)]
  new string GUID2 { [DispId(14), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }

  [DispId(15)]
  string PosDesignationGUID { [DispId(15), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(15), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }
}
