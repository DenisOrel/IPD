...
// Type: Interop.CADInterface.IPositionNote
...
[Guid("70B8C7FF-ADA2-4016-B236-D20951B35106")]
[ComImport]
public interface IPositionNote : IParametersContainer
{
  [DispId(1)]
  ...
  [DispId(5)]
  string NoteGUID { [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }
}
