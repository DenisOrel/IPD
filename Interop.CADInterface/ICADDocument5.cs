...
// Type: Interop.CADInterface.ICADDocument5
...
[Guid("0EEEFAD2-6B65-4029-8C08-AF3C54EEF949")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface ICADDocument5 : ICADDocument4
{
  [DispId(1)]
  ...
  [DispId(34)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SynchronizeSpecification([MarshalAs(UnmanagedType.Interface), In] StructureManager pStructureManager, [In] bool vbFromDocument);
}
