...
// Type: Interop.CADInterface.ICADSystem2
...
[Guid("3FAA9365-98EE-4FDB-B072-3D5851F11116")]
[ComImport]
public interface ICADSystem2 : ICADSystem
{
  [DispId(1)]
  ...
  [DispId(14)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void GetActiveDocument([MarshalAs(UnmanagedType.Interface)] out ICADDocument2 ppDocument);
  ...
  [DispId(16 /*0x10*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void GetDocument2([MarshalAs(UnmanagedType.BStr), In] string bstrFullPath, bool bOpenVisible, [MarshalAs(UnmanagedType.Interface)] out ICADDocument2 ppDocument);
  ...
  [DispId(18)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void SetWorkingFolder([MarshalAs(UnmanagedType.BStr), In] string bstrWorkingFolder);

  [DispId(19)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  EOpenStatus GetDocumentStatus([MarshalAs(UnmanagedType.BStr), In] string bstrFullPath);
}
