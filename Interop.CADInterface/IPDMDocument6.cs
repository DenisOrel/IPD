...
// Type: Interop.CADInterface.IPDMDocument6
...
[Guid("3EF3651F-0452-47ED-B933-19A71A6AF752")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface IPDMDocument6 : IPDMDocument5
{
  [DispId(1)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR)]
  string[] SelectFiles([MarshalAs(UnmanagedType.BStr), In] string bstrExtensionsFilter);

  [DispId(35)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void ExtendedSave([In] bool bSilentMode);
}
