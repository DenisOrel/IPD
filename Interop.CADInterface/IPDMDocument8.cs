...
// Type: Interop.CADInterface.IPDMDocument8
...
[Guid("BFFF5581-A429-4168-B4B7-540C61B90243")]
[ComImport]
public interface IPDMDocument8 : IPDMDocument7
{
  [DispId(1)]
  ...
  [DispId(36)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  new void SaveToDir([MarshalAs(UnmanagedType.BStr), In] string bstrDir, [In] bool bSaveRefs, [MarshalAs(UnmanagedType.BStr), In] string bstrExtensionFilter);
