...
// Type: Interop.CADInterface.ICADSystem3
...
[Guid("1204AAF0-AFB6-48E0-BB07-FC960187A98E")]
[ComImport]
public interface ICADSystem3 : ICADSystem2
{
  [DispId(1)]
  ...
  [DispId(20)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void GetActiveMode(out ECADSystemModeType pRetVal);
}
