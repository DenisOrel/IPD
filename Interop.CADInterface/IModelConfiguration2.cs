...
// Type: Interop.CADInterface.IModelConfiguration2
...
[Guid("72C0A409-8709-404B-8489-27994797ED38")]
[ComImport]
public interface IModelConfiguration2 : IModelConfiguration
{
  [DispId(1)]
  ...
  [DispId(18)]
  ModelMaterial Material { [DispId(18), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(18), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }

  [DispId(19)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_DISPATCH)]
  IModelBody[] GetBodies();

  [DispId(20)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  IModelComponent2 GetInplaceActiveComponent();
}
