...
// Type: Interop.CADInterface.IModelComponent2
...
[Guid("9C6F4516-BFD2-40E6-85EF-87DD69CFFAB2")]
[ComImport]
public interface IModelComponent2 : IModelComponent
{
  [DispId(1)]
  ...
  [DispId(13)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void Replace([MarshalAs(UnmanagedType.BStr), In] string bstrFullPath, [MarshalAs(UnmanagedType.BStr), In] string bstrConfigName);
