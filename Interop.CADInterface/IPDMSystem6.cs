...
// Type: Interop.CADInterface.IPDMSystem6
...
[Guid("78B9D818-0BAE-44EE-8AF2-B569A551ECDC")]
[ComImport]
public interface IPDMSystem6 : IPDMSystem5
{
  [DispId(1)]
  ...
  [DispId(28)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  bool SupportsFeature([In] EPDMSystemFeatures eFeature);
