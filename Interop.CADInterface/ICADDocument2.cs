...
// Type: Interop.CADInterface.ICADDocument2
...
[Guid("56069780-5277-4B75-B8AF-AD131A8648D8")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface ICADDocument2 : ICADDocument
{
  [DispId(1)]
  ...
  byte[] ReadCustomData([MarshalAs(UnmanagedType.BStr), In] string bstrBlockName);

  [DispId(25)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void WriteCustomData([MarshalAs(UnmanagedType.BStr), In] string bstrBlockName, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UI1), In] byte[] pData);

  [DispId(26)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void DeleteCustomData([MarshalAs(UnmanagedType.BStr), In] string bstrBlockName);
  ...
  [DispId(28)]
  bool IsModified { [DispId(28), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(29)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.BStr)]
  string MakePreview([In] EPreviewType eType);

  [DispId(30)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR)]
  string[] GetMiscellaneousReferences();

  [DispId(31 /*0x1F*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR)]
  string[] GetAllDependencies([In] bool bTopLevelOnly);
}
