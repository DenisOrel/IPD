...
// Type: Interop.CADInterface.IStructureElement
...
[Guid("AD1880D2-7FD3-4727-A362-22153EA16247")]
[ComImport]
public interface IStructureElement : IParametersContainer
{
  [DispId(1)]
  ...
  [DispId(6)]
  bool SameForAllConfigurations { [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(7)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  StructureModification GetCommonVariant();

  [DispId(8)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_DISPATCH)]
  StructureModification[] GetModifications();
  ...
  [DispId(10)]
  bool ExcludedFromSpec { [DispId(10), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(10), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(11)]
  bool IsVirtual { [DispId(11), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(12)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  StructureModification AddModification([MarshalAs(UnmanagedType.BStr), In] string bstrConfiguration, [MarshalAs(UnmanagedType.BStr), In] string bstrConfigDesignation);
}
